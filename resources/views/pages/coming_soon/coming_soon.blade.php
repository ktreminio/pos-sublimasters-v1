                ...
                <div class="bg-white my-30 content-center">
                    <div class="coming-soon text-center">
                        ...
                        <div class="coming-soon__body">
                            ...
                            <p class="subtitle">Lorem Ipsum is simply dummy text of the printing and typesetting
                            ...
                            <form class="form-inline d-flex justify-content-center my-n10 subscribe-bar">
                                ...
                                <button type="submit" class="btn btn-primary m-10 text-uppercase btn-lg px-20">
                                    Subscribe
                                </button>
                            </form>
                        </div>
