                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active"
                                    aria-current="page">{{ trans('menu.form-element') }}</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                   class="form-control ih-medium ip-light radius-xs b-light px-15"
                                                   id="a4" placeholder="One of Four Columns">
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                   class="form-control ih-medium ip-light radius-xs b-light px-15"
                                                   id="a5" placeholder="One of Four Columns">
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                   class="form-control ih-medium ip-light radius-xs b-light px-15"
                                                   id="a6" placeholder="One of Four Columns">
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                   class="form-control ih-medium ip-light radius-xs b-light px-15"
                                                   id="a7" placeholder="One of Four Columns">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                   class="form-control ih-medium ip-light radius-xs b-light px-15"
                                                   id="a8" placeholder="One of Two Columns">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                   class="form-control ih-medium ip-light radius-xs b-light px-15"
                                                   id="a9" placeholder="One of Two Columns">
                                        </div>
                                    </div>
                                </div>
                            </form>
                        ...
                        <div class="col-lg-12">
                            <div class="card card-default card-md mb-4">
                                ...
                                <div class="card-body">
                                    <form action="#">
                                        <div class="form-group">
                                            <label for="a12" class="il-gray fs-14 fw-500 align-center mb-10">Large
                                                Input</label>
                                            <input type="text"
                                        ...
                                        <div class="form-group">
                                            <label for="a13" class="il-gray fs-14 fw-500 align-center mb-10">Default
                                                Input</label>
                                            <input type="text"
                                                   class="form-control ih-medium ip-light radius-xs b-light px-15"
                                        ...
                                        <div class="form-group">
                                            <label for="a14" class="il-gray fs-14 fw-500 align-center mb-10">Small
                                                Input</label>
                                            <input type="text"
                                ...
                                <div class="card-body form-element-radioChecks">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div>
                                                <div class="radio-theme-default custom-radio disabled ">
                                                    <input class="radio" type="radio" name="radio-default2" value="0"
                                                           id="radio-3" checked="">
                                                    <label for="radio-3">
