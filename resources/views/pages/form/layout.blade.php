        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="breadcrumb-main">
                    <h4 class="text-capitalize breadcrumb-title">{{ trans('menu.form-layouts') }}</h4>
                    <div class="breadcrumb-action justify-content-center flex-wrap">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="#"><i class="las la-home"></i>Home</a></li>
                                <li class="breadcrumb-item active"
                                    aria-current="page">{{ trans('menu.form-layouts') }}</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                            ...
                            <form action="#">
                                ...
                                <div class="form-group row mb-25">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="email"
                                               class="form-control  ih-medium ip-gray radius-xs b-light px-15"
                                               id="inputEmail" placeholder="username@email.com">
                                    </div>
                                </div>
                                    ...
                                    <div class="col-sm-9">
                                        <div class="with-icon">
                                            ...
                                            <input type="text" class="form-control  ih-medium ip-gray radius-xs b-light"
                                                   id="inputNameIcon" placeholder="Duran Clayton">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group row mb-25">
                                    ...
                                    <div class="col-sm-9">
                                        <div class="with-icon">
                                            ...
                                            <input type="email"
                                                   ...
                                                   id="inputEmailIcon" placeholder="username@email.com">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group row mb-0">
                                    <div class="col-sm-3">
                                        <label for="inputPasswordIcon"
                                               class=" col-form-label color-dark fs-14 fw-500 align-center">Password</label>
                                    </div>
                                    <div class="col-sm-9">
                                        <div class="with-icon">
                    ...
                    <div class="card-body pb-md-30">
                        <div class="Vertical-form">
                            <form action="#">
                                ...
                                <div class="form-group">
                                    <label for="formGroupExampleInput2" class="color-dark fs-14 fw-500 align-center">Email
                                        Address</label>
                                    <input type="email" class="form-control ih-medium ip-gray radius-xs b-light px-15"
                                           id="formGroupExampleInput2" placeholder="username@email.com">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="layout-button mt-25">
                                    <button type="button"
                                            class="btn btn-default btn-squared border-normal bg-normal px-20 ">cancel
                                    </button>
                                    <button type="button" class="btn btn-primary btn-default btn-squared px-30">save
                                    </button>
                                </div>
                            </form>
                        </div>
                            ...
                            <form action="#">
                                <div class="form-group">
                                    ...
                                    <div class="with-icon">
                                        ...
                                        <input type="text" class="form-control ih-medium ip-gray radius-xs b-light"
                                               id="formGroupExampleInput4" placeholder="Duran Clayton">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="formGroupExampleInput5" class=" color-dark fs-14 fw-500 align-center">Email
                                        Address</label>
                                    <div class="with-icon">
                                        <span class="lar la-envelope"></span>
                                        <input type="email" class="form-control ih-medium ip-gray radius-xs b-light"
                                               id="formGroupExampleInput5" placeholder="username@email.com">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="with-icon">
                                        ...
                                        <input type="password" class="form-control ih-medium ip-gray radius-xs b-light"
