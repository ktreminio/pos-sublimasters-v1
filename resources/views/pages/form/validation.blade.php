                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active"
                                    aria-current="page">{{ trans('menu.form-validation') }}</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                                ...
                                <div class="row mx-n15">
                                    <div class="col-md-4 mb-20 px-15">
                                        <label for="validationDefault01"
                                            ...
                                            name</label>
                                        <input type="text" class="form-control ih-medium ip-light radius-xs b-light"
                                               id="validationDefault01" placeholder="Mark" required>
                                    </div>
                                    <div class="col-md-4 mb-20 px-15">
                                        <label for="validationDefault02"
                                            ...
                                            name</label>
                                        <input type="text" class="form-control  ih-medium ip-light radius-xs b-light"
                                               id="validationDefault02" placeholder="Clayton" required>
                                    </div>
                                    <div class="col-md-4 mb-20 px-15">
                                        <label for="validationDefault012"
                                               class="il-gray fs-14 fw-500 align-center mb-10">Username</label>
                                        <input type="text" class="form-control  ih-medium ip-light radius-xs b-light"
                                               id="validationDefault012" placeholder="Username" required>
                                    </div>
                                </div>
                                <div class="row mx-n15">
                                    <div class="col-md-6 mb-20 px-15">
                                        <label for="validationDefault03"
                                               class="il-gray fs-14 fw-500 align-center mb-10">City</label>
                                        <input type="text" class="form-control  ih-medium ip-light radius-xs b-light"
                                               id="validationDefault03" placeholder="City" required>
                                    </div>
                                    <div class="col-md-3 mb-20 px-15">
                                        <label for="validationDefault04"
                                               class="il-gray fs-14 fw-500 align-center mb-10">State</label>
                                        <select class="custom-select form-control select-arrow-none ih-medium  radius-xs b-light shadow-none color-light  fs-14"
                                    ...
                                    <div class="col-md-3 mb-20 px-15">
                                        <label for="validationDefault05"
                                               class="il-gray fs-14 fw-500 align-center mb-10">Zip</label>
                                        <input type="text" class="form-control  ih-medium ip-light radius-xs b-light"
                            ...
                            <form class="was-validated">
                                <div class="row mx-n15">
                                    <div class="col-md-4 mb-3 px-15">
                                        ...
                                        <input type="text"
                                               ...
                                               id="validationServer01" placeholder="Mark" required>
                                    ...
                                    <div class="col-md-4 mb-3 px-15">
                                        ...
                                        <input type="text"
                                               class="form-control is-invalid ih-medium ip-light radius-xs b-light"
                                               id="validationServer02" placeholder="Clayton" required>
                                        <div class="valid-feedback">
                                            Looks good!
                                        </div>
                                    </div>
                                    <div class="col-md-4 mb-3 px-15">
                                        ...
                                        <input type="text"
                                               class="form-control is-invalid ih-medium ip-light radius-xs b-light"
                                               id="validationServer12" placeholder="Username" required>
                                        <div class="valid-feedback">
                                            Looks good!
                                        </div>
                                    </div>
                                ...
                                <div class="row mx-n15">
                                    <div class="col-md-6 mb-3 px-15">
                                        <label for="validationServer033"
                                               class="il-gray fs-14 fw-500 align-center mb-10">City</label>
                                        <input type="text"
                                               class="form-control is-valid ih-medium ip-light radius-xs b-light"
                                               id="validationServer033" aria-describedby="validationServer033Feedback"
                                    ...
                                    <div class="col-md-3 mb-3 px-15">
                                        ...
                                        <select class="custom-select is-valid form-control select-arrow-none ih-medium  radius-xs b-light shadow-none color-light  fs-14"
