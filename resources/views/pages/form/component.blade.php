                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active"
                                    aria-current="page">{{ trans('menu.form-component') }}</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                                        ...
                                        <div class="form-group row mb-n25">
                                            ...
                                            <div class="col-md-6 mb-25">
                                                <div class="with-icon">
                                                    ...
                                                    <input type="text"
                                                           class="form-control  ih-medium ip-lightradius-xs b-light"
                                                           id="inputNameIcon3" placeholder="Location">
                                                </div>
                                            </div>
                                            <div class="col-md-6 mb-25">
                                                <div class="with-icon">
                                            ...
                                            <div class="col-md-6 mb-25">
                                                <div class="with-icon">
                                                    ...
                                                    <input type="text"
                                                           class="form-control  ih-medium ip-lightradius-xs b-light"
                                                           id="inputNameIcon5" placeholder="Payment Method">
                                                </div>
                                            </div>
                                            <div class="col-md-6 mb-25">
                                                <div class="with-icon">
                                                    ...
                                                    <input type="text"
                                                           class="form-control  ih-medium ip-lightradius-xs b-light"
                                                           id="inputNameIcon6" placeholder="Phone Number">
                                                </div>
                                            </div>
                                        </div>
                                    </form>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group form-group-calender mb-20">
                                                <label for="datepicker8"
                                                       class="il-gray fs-14 fw-500 align-center mb-10">Date</label>
                                                    ...
                                                    <div id="pageContentArea" class="pageSection">
                                                        <form>
                                                            ...
                                                            <input type="text" id="txtDateRange" name="txtDateRange"
                                                                   ...
                                                                   placeholder="01/10/2021 - 01/15/2021"
                                ...
                                <div class="card-body py-md-30">
                                    <div class="dm-tag-wrap">
                                        <div class="tag-box">
                                            ...
                                            <span class="dm-tag tag-light">Tag 3 <a href="#" class="tag-closable"><i
                                                            class="la la-times"></i></a></span>


                                            <span class="dm-tag tag-light">Prevent Default <a href="#"
                                                                                              class="tag-closable"><i
                                                            class="la la-times"></i></a></span>
