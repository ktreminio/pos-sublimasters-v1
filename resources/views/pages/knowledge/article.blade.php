                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active"
                                        aria-current="page">{{ trans('menu.knowledge-single-article') }}</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                                ...
                                <form class="kb__header-search-form">
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control ui-autocomplete-input"
                                               placeholder="Search anything" name="s" autocomplete="off">
                                ...
                                <div class="knowledgebase-breadcrumb">
                                    <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item active" aria-current="page">Switch between
                                                accounts
                                            </li>
                                        </ol>
                                    </nav>
                                                            ...
                                                            <div class="d-flex flex-wrap">
                                                                <div id="headingOne">
                                                                    <div role="button" data-bs-toggle="collapse"
                                                                         ...
                                                                         aria-expanded="false"
                                                                         class="knowledgebase__list-collapsed">
                                                                ...
                                                                <div id="collapseOne"
                                                                    ...
                                                                    <div class="nav flex-column nav-pills"
                                                                        ...
                                                                        <a class="nav-link" id="v-pills-messages-tab"
                                                                           ...
                                                                           aria-selected="false">Stop getting emails
                                                                            from
                                                                            lorem</a>
                                                                        <a class="nav-link" id="v-pills-settings-tab"
                                                                           data-bs-toggle="pill"
                                                                           href="#v-pills-settings" role="tab"
                                                                           aria-selected="false">Threads to organize
                                                                            discussions</a>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div>
                                                                <div id="headingOne2">
                                                                    <div role="button" data-bs-toggle="collapse"
                                                                         ...
                                                                         aria-expanded="false"
                                                                         class="collapsed knowledgebase__list-collapsed">
                                                                        <div class="changelog__accordingArrow">
                                                                            <img class="svg"
                                                                                 src="{{ asset('assets/img/svg/chevron-right.svg') }}"
                                                                                 alt="chevron-right.svg">
                                                                ...
                                                                <div id="collapseOne2"
                                                                     class="collapse collapse-adv__area"
                                                                                        ...
                                                                                        <div id="collapseOne3"
                                                                                            ...
                                                                                            <div class="nav flex-column nav-pills"
                                                                                                ...
                                                                                                <a class="nav-link"
                                                                                                   ...
                                                                                                   role="tab"
                                                                                                   aria-selected="false">Installing
                                                                                                    vendor
                                                                                                    marketplace
                                                                                                    lorem vendor
                                                                                                    marketplace
                                                ...
                                                <div class="knowledgebase-adv__content">
                                                    ...
                                                    <article>
                                                        ...
                                                        <p>Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed
                                                            ...
                                                            takimata
                                                            sanctus est Lorem ipsum dolor sit amet….</p>
                                                        <img src="{{ asset('assets/img/nopath.png') }}" alt="img"
                                                             class="w-100">
                                                    </article>
                                                    ...
                                                    <article id="accordion-post1">
                                                        <div id="article1">
                                                            <div role="button"
                                                                 class="d-flex flex-wrap justify-content-between knowledgebase-adv__collapse collapsed "
                                                                 data-bs-toggle="collapse"
                                                                 data-bs-target="#article1area" aria-expanded="false">
                                                                <h3>Measuring
                                                                    elevation
                                                                </h3>
                                                                <div class="changelog__accordingArrow">
                                                        ...
                                                        <div id="article1area" class="collapse"
                                                             aria-labelledby="article1" data-parent="#accordion-post1">
                                                    ...
                                                    <article id="accordion-post2">
                                                        <div id="article2">
                                                            <div role="button"
                                                                 class="d-flex flex-wrap justify-content-between knowledgebase-adv__collapse collapsed "
                                                                 data-bs-toggle="collapse"
                                                                 data-bs-target="#article2area" aria-expanded="false">
                                                        ...
                                                        <div id="article2area" class="collapse"
                                                             aria-labelledby="article2" data-parent="#accordion-post2">
                                                            <p>Lorem ipsum dolor sit amet, consetetur sadipscing elitr,
                                                                sed
                                                                diam
                                                                nonumy eirmod tempor invidunt ut labore et dolore magna
                                                            ...
                                                            <div class="mx-n20 my-n10 content-center flex-wrap">
                                                                ...
                                                                <div class="mx-20 my-10">
                                                                    <div class="button-group">
                                                                        <button class="btn btn-sm btn-squared btn-outline-success ">
                                                                            <img src="{{ asset('assets/img/svg/smile.svg') }}"
                                                                                 alt="smile" class="svg"> yes
                                                                        </button>
                                                                        <button class="btn btn-sm btn-squared btn-outline-warning ">
                                                                            <img src="{{ asset('assets/img/svg/frown.svg') }}"
                                                                                 alt="frown" class="svg"> No
                                                                        </button>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div class="knowledgebase-help-request d-flex align-items-center justify-content-between">
                                                        ...
                                                        <div class="knowledgebase__share d-flex align-items-center">
                                                            ...
                                                            <ul>
                                                                ...
                                                                <li><a href="#"><i class="lab la-pinterest"></i></a>
                                                                </li>
                                                    ...
                                                    <div class="post-pagination d-flex justify-content-between">
                                                        <div class="prev-post">
                                                            ...
                                                            <p><a href="#" class="title">Stop getting emails from
                                                                    lorem</a>
                                                            </p>
                                                        </div>
                                                        <div class="next-post">
                                                    ...
                                                    <div class="related-article card">
                                                        <div class="card-body">
                                                            ...
                                                            <ul>
                                                                ...
                                                                <li><i class="las la-file-invoice"></i>Stop getting
                                                                    emails
                                                                    from lorem
                                                                </li>
                                                            </ul>
                                                        ...
                                                        <form class="comment_form_wrapper row">
                                                            ...
                                                            <div class="col-md-12">
                                                                <div class="form-group">
                                                                    ...
                                                                    <textarea class="form-control cr-form-control"
