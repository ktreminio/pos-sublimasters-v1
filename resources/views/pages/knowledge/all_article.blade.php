                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active"
                                        aria-current="page">{{ trans('menu.knowledge-all-article') }}</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-4 col-sm-5 mt-xl-0 mt-20">
                                    <div class="knowledgebase__list">
                                        <ul>
                                            <li>
                                                <a href="knowledgebase-3.html">Log in and out of plugins view your
                                                    success and other stats</a>
                                            </li>
                                            <li>
                                            ...
                                            <li>
                                                <div class="accordion" id="accordionExample5">
                                                    <div>
                                                        ...
                                                        <div id="collapseOne" class="collapse collapse-area"
                                                             aria-labelledby="headingOne"
                                                             data-parent="#accordionExample5">
                                                            <div class="knowledgebase__list">
                                                                <ul>
                                                                    <li>
                                                                        <a href="knowledgebase-3.html">Log in and out of
                                                                            Plugins</a>
                                                                    </li>
                                                                    <li>
                                                                        <a href="knowledgebase-3.html">Switch between
                                                                            accounts</a>
                                                                    </li>
                                                                    <li>
                                                                        <a href="knowledgebase-3.html">Change your
                                                                            email</a>
                                                                    </li>
                                                                    <li>
                                                                        <a href="knowledgebase-3.html">Reactivate your
                                                                            account</a>
                                                                    </li>
                                                                </ul>
                                                            </div>
                                            ...
                                            <li>
                                                <div class="accordion" id="accordionExample6">
                                                    <div>
                                                        ...
                                                        <div id="collapsetwo" class="collapse collapse-area"
                                            ...
                                            <li>
                                                <div class="accordion" id="accordionExample7">
                                                    <div>
                                                        ...
                                                        <div id="collapsethree" class="collapse collapse-area"
