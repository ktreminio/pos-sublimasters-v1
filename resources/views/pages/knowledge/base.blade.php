                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active"
                                        aria-current="page">{{ trans('menu.knowledge-base') }}</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                    ...
                    <div class="cus-8 col-md-10 ">
                        <ul class="nav nav-tabs knowledgebase__nav" id="knowledgebase" role="tablist">
                            <li class="nav-item" role="presentation">
                                <a class="nav-link active" id="plugins-tab" data-bs-toggle="pill" href="#plugins"
                                   role="tab" aria-controls="plugins" aria-selected="true">Plugins</a>
                            </li>
                            <li class="nav-item" role="presentation">
                                <a class="nav-link" id="themes-tab" data-bs-toggle="pill" href="#themes" role="tab"
                                   aria-controls="themes" aria-selected="false">Themes</a>
                            </li>
                            <li class="nav-item" role="presentation">
                                <a class="nav-link" id="extensions-tab" data-bs-toggle="pill" href="#extensions"
                                   role="tab" aria-controls="extensions" aria-selected="false">Extensions</a>
                            </li>
                        </ul>
                    </div>
                    <div class="cus-8 col-md-10">
                                    ...
                                    <div class="col-xl-4 col-md-6">
                                        <div class="knowledgebase__list">
                                            ...
                                            <div class="knowledgebase__more">
                                                <a href="knowledgebase-2.html">see more <i
