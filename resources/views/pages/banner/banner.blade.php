            ...
            <div class="row">
                ...
                <div class="col-xxl-3 col-sm-6 ">
                    <div class="card banner-feature">
                        <div class="card-body">
                            ...
                            <button class="banner-feature__btn btn btn-outline-primary btn-sm px-20 radius-xs fs-14"
                                    type="button">Start
                            </button>
                        </div>
                    </div>
                    ...
                    <div class="card banner-feature banner-feature--3">
                        ...
                        <div class="d-flex justify-content-center">
                            <div class="card-body">
                                ...
                                <button class="banner-feature__btn btn color-primary btn-md px-20 bg-white radius-xs fs-15 mt-35"
                ...
                <div class="col-xxl-4 col-sm-6  mb-md-50 mb-30">
                    <div class="card banner-feature banner-feature--6"
                         style="background-image:url({{ asset('assets/img/rectangle381.png') }});">
                        <div class="d-flex justify-content-center">
                            <div class="card-body">
                                <img src="{{ asset('assets/img/sale.png') }}" alt="img">
                                <h3 class="banner-feature__heading color-danger">Up to 50 OFF</h3>
                                <button class="banner-feature__btn btn btn-outline-danger  btn-md px-20 radius-xs fs-15"
                                        type="button">buy now
                                </button>
                            </div>
                        </div>
                        ...
                        <div class="d-flex justify-content-center">
                            <div class="card-body">
                                ...
                                <div class="div">
                                    ...
                                    <button class="banner-feature__btn btn btn btn-outline-primary btn-md px-20 radius-xs fs-15"
                                            type="button">Subscribe Now
                                    </button>
                                </div>
                            </div>
                        </div>
                                        ...
                                        <div class="d-flex w-100">
                                            <div class="card-body">
                                                <div class="banner-feature__shape mb-30 content-center">
                                                    <img src="{{ asset('assets/img/svg/group3488.svg') }}" alt="img"
                                                         class="svg">
                                                </div>
                                                <div class="pb-md-0 pb-30">
                                                    <h2 class="banner-feature__heading color-white">Achievements</h2>
                                                    <p class="banner-feature__para ">Lorem ipsum dolor sit amet,
                                                        consetetur
                                                        sadipscing elitr.
                                                    </p>
                                                </div>
                    ...
                    <div class="card banner-feature--12 d-flex">
                        <div class="d-flex flex-sm-nowrap flex-wrap align-items-center text-center">
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex justify-content-center">
                                    <button class="banner-feature__btn btn btn btn-primary btn-md px-20 radius-xs fs-15 mt-30"
                                            type="button">Learn More
                                    </button>
                                </div>
                            </div>
                    ...
                    <div class="card banner-feature--13 d-flex">
                        <div class="d-flex align-items-center flex-sm-nowrap flex-wrap text-sm-start text-center">
                            <div class="card-body">
                                ...
                                <p class="banner-feature__para ">Lorem ipsum dolor amet, consetetur sadipscing elitr sed
                                    diam
                                </p>
