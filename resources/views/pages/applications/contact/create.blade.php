                ...
                <div class="contact-breadcrumb">
                    ...
                    <div class="breadcrumb-main add-contact justify-content-sm-between ">
                        ...
                        <div class="action-btn">
                            ...
                            <!-- Modal -->
                            <div class="modal fade add-contact__2 show" id="add-contact" role="dialog" tabindex="-1"
                    ...
                    <div class="card-body text-center pt-30 px-25 pb-0">
                        ...
                        <div class="contact-profile-card text-center">
                            <div class="cp-img d-flex justify-content-center">
                                <img class="cp-img__main" src="{{ asset('assets/img/tm9.png') }}"
                                     alt="ninjadash Contact">
                            </div>
                            <div class="cp-info">
            ...
            <div class="col-xl-3 mb-25">
                <div class="card contact-card">
                    <div class="card-body text-center pt-30 px-25 pb-0">
                        ...
                        <div class="contact-profile-card text-center">
                            <div class="cp-img d-flex justify-content-center">
                                <img class="cp-img__main" src="{{ asset('assets/img/tm10.png') }}"
                                     alt="ninjadash Contact">
                            </div>
                            <div class="cp-info">
            ...
            <div class="col-xl-3 mb-25">
                <div class="card contact-card">
                    <div class="card-body text-center pt-30 px-25 pb-0">
                        ...
                        <div class="contact-profile-card text-center">
                            <div class="cp-img d-flex justify-content-center">
                                <img class="cp-img__main" src="{{ asset('assets/img/tm11.png') }}"
                                     alt="ninjadash Contact">
                            </div>
                            <div class="cp-info">
            ...
            <div class="col-xl-3 mb-25">
                <div class="card contact-card">
                    <div class="card-body text-center pt-30 px-25 pb-0">
                        ...
                        <div class="contact-profile-card text-center">
                            <div class="cp-img d-flex justify-content-center">
                                <img class="cp-img__main" src="{{ asset('assets/img/tm12.png') }}"
                                     alt="ninjadash Contact">
                            </div>
                            <div class="cp-info">
            ...
            <div class="col-xl-3 mb-25">
                <div class="card contact-card">
                    <div class="card-body text-center pt-30 px-25 pb-0">
                        ...
                        <div class="contact-profile-card text-center">
                            <div class="cp-img d-flex justify-content-center">
                                <img class="cp-img__main" src="{{ asset('assets/img/tm13.png') }}"
                                     alt="ninjadash Contact">
                            </div>
                            <div class="cp-info">
                                <h6 class="cp-info__title">Natasha Gamble</h6>
            ...
            <div class="col-xl-3 mb-25">
                <div class="card contact-card">
                    <div class="card-body text-center pt-30 px-25 pb-0">
                        ...
                        <div class="contact-profile-card text-center">
                            <div class="cp-img d-flex justify-content-center">
                                <img class="cp-img__main" src="{{ asset('assets/img/tm14.png') }}"
                                     alt="ninjadash Contact">
                            </div>
                            <div class="cp-info">
                                <h6 class="cp-info__title">Natasha Gamble</h6>
            ...
            <div class="col-xl-3 mb-25">
                <div class="card contact-card">
                    <div class="card-body text-center pt-30 px-25 pb-0">
                        ...
                        <div class="contact-profile-card text-center">
                            <div class="cp-img d-flex justify-content-center">
                                <img class="cp-img__main" src="{{ asset('assets/img/tm6.png') }}"
                                     alt="ninjadash Contact">
                            </div>
                            <div class="cp-info">
                                <h6 class="cp-info__title">Natasha Gamble</h6>
            ...
            <div class="col-xl-3 mb-25">
                <div class="card contact-card">
                    <div class="card-body text-center pt-30 px-25 pb-0">
                        ...
                        <div class="contact-profile-card text-center">
                            <div class="cp-img d-flex justify-content-center">
                                <img class="cp-img__main" src="{{ asset('assets/img/tm5.png') }}"
                                     alt="ninjadash Contact">
                            </div>
                            <div class="cp-info">
                                <h6 class="cp-info__title">Natasha Gamble</h6>
