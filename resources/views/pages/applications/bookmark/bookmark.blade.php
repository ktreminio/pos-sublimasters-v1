                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active"
                                    aria-current="page">{{ trans('menu.bookmark-menu-title') }}</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                                            ...
                                            <li class="nav-item" role="presentation">
                                                <a class="nav-link active" id="pills-home-tab" data-bs-toggle="pill"
                                                   href="#pills-home" role="tab" aria-selected="true"><img
                                                            src="{{ asset('assets/img/svg/folder.svg') }}" alt="folder"
                                                            class="svg"> Designs</a>
                                            </li>
                                            <li class="nav-item" role="presentation">
                                                    ...
                                                    <div class="card bookmark bookmark--grid">
                                                        <div class="bookmark__image">
                                                            ...
                                                            <a href="#"><img class="card-img-top img-fluid"
                                                                             src="{{ asset('assets/img/bookmark.png') }}"
                                                                             alt="digital-chair"></a>
                                                        </div>
                                                        <div class="card-body px-15 py-20">
                                                            ...
                                                            <div class="bookmark__button d-flex mt-15 flex-wrap">
                                                                <button class="btn btn-primary btn-sm btn-squared border-0 "
                                                                        data-bs-toggle="modal"
                                                                        data-bs-target="#taskModal2">Edit
                                                                </button>
                                                ...
                                                <div class="cus-xl-3 col-lg-6 col-md-12 col-sm-6 col-12 mb-30">
                                                    ...
                                                    <div class="card bookmark bookmark--grid">
                                                        <div class="bookmark__image">
                                                            ...
                                                            <a href="#"><img class="card-img-top img-fluid"
                                                                             src="{{ asset('assets/img/bookmark2.png') }}"
                                                                             alt="digital-chair"></a>
                                                        </div>
                                                        <div class="card-body px-15 py-20">
                                                            <div class="bookmark__body text-capitalize">
                                                ...
                                                <div class="cus-xl-3 col-lg-6 col-md-12 col-sm-6 col-12 mb-30">
                                                    ...
                                                    <div class="card bookmark bookmark--grid">
                                                        <div class="bookmark__image">
                                                            ...
                                                            <a href="#"><img class="card-img-top img-fluid"
                                                                             src="{{ asset('assets/img/bookmark3.png') }}"
                                                                             alt="digital-chair"></a>
                                                        </div>
                                                        <div class="card-body px-15 py-20">
                                                            <div class="bookmark__body text-capitalize">
                                                ...
                                                <div class="cus-xl-3 col-lg-6 col-md-12 col-sm-6 col-12 mb-30">
                                                    ...
                                                    <div class="card bookmark bookmark--grid">
                                                        <div class="bookmark__image">
                                                            ...
                                                            <a href="#"><img class="card-img-top img-fluid"
                                                                             src="{{ asset('assets/img/bookmark4.png') }}"
                                                                             alt="digital-chair"></a>
                                                        </div>
                                                        <div class="card-body px-15 py-20">
                                                            <div class="bookmark__body text-capitalize">
                                                ...
                                                <div class="row mx-n1">
                                                    ...
                                                    <div class="cus-xl-3 col-lg-6 col-md-12 col-sm-6 col-12 mb-30 px-10">
                                                        ...
                                                        <div class="card bookmark bookmark--grid">
                                                            ...
                                                            <div class="card-body px-15 py-20">
                                                                <div class="bookmark__body text-capitalize">
                                                                    <h6 class="card-title">Dashboard Design
                                                                        Structure</h6>
                                                                    <a href="#">https://themeforest.net/ninjadash
                                                                        react-admin</a>
                                                                </div>
