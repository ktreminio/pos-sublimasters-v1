                ...
                <div class="breadcrumb-main application-ui mb-30">
                    ...
                    <div class="d-flex text-capitalize">
                        <button type="button"
                            ...
                            <img src="{{ asset('assets/img/svg/edit-3.svg') }}" alt="edit-3" class="svg">edit
                        </button>
                        <button type="button"
                                class="breadcrumb-remove border-0 color-danger content-center bg-white fs-12 fw-500 ms-10 radius-md">
                            <img src="{{ asset('assets/img/svg/trash-2.svg') }}" alt="trash-2" class="svg">remove
                        </button>
                    </div>
                </div>
            </div>
                                    ...
                                    <div class="project-task table-responsive table-responsive--dynamic">
                                        ...
                                        <div class="task-list-btn px-25 my-10">
                                            <button class="text-primary">
                                                <img src="{{ asset('assets/img/svg/plus.svg') }}" alt="plus"
                                                     class="svg">Add
                                                New
                                                Task
                                            </button>
                                                    ...
                                                    <li class="">
                                                        <div
                                                            ...
                                                            <div class="d-flex">
                                                                ...
                                                                <div>
                                                                    <a href="#">
                                                                        <p class="fw-500 fs-14 text-dark mb-0">Mike
                                                                            Greene
