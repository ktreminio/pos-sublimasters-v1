                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active"
                                        aria-current="page">{{ trans('menu.ecommerce-product-add') }}</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                        ...
                        <div class="col-xxl-7 col-lg-10">
                            <div class="mx-sm-30 mx-20 ">
                                                ...
                                                <div class="form-group quantity-appearance">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <span class="input-group-text" id="basic-addon1">
                                                            <img class="svg"
                                                                 src="{{ asset('assets/img/svg/dollar-sign.svg') }}"
                                                                 alt="">
                                                        </span>
                                                        </div>
                                                        <div class="pt_Quantity">
                                                            <input type="number" class="form-control" min="0" max="100"
                                                                   step="1" value="0" data-inc="1">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group quantity-appearance">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <span class="input-group-text" id="basic-addon2">
                                                            <img class="svg"
                                                                 src="{{ asset('assets/img/svg/percent.svg') }}" alt="">
                                                        </span>
                                                        </div>
                                                        <div class="pt_Quantity">
                                                            <input type="number" class="form-control" min="0" max="100"
                                ...
                                <div class="card add-product p-sm-30 p-20 ">
                                    <div class="card-body p-0">
                                        <div class="card-header">
                                            <h6 class="fw-500">@lang('pages.products.image')</h6>
                                        </div>
                                        <div class="add-product__body-img px-sm-40 px-20">
                                            ...
                                            <div class="upload-product-media d-flex justify-content-between align-items-center mt-25">
                                                <div class="upload-media-area d-flex">
                                                    <img src="{{ asset('assets/img/food-restaurant-media.png') }}"
                                                         alt="img">
