                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active"
                                        aria-current="page">{{ trans('menu.ecommerce-cart') }}</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                            ...
                            <table id="cart" class="table table-borderless table-hover">
                                    ...
                                    <td class="Product-cart-title">
                                        <div class="media  align-items-center">
                                            <img class="me-3 wh-80 align-self-center radius-xl"
                                                 src="{{ asset('assets/img/cart1.png') }}"
                                ...
                                <tr>
                                    <td class="Product-cart-title">
                                        <div class="media  align-items-center">
                                            <img class="me-3 wh-80 align-self-center radius-xl"
                                                 src="{{ asset('assets/img/cart2.png') }}"
                                                 alt="Generic placeholder image">
                                            <div class="media-body">
                                                <h5 class="mt-0">Fiber base chair</h5>
                                                <div class="d-flex">
                                ...
                                <tr>
                                    <td class="Product-cart-title">
                                        <div class="media  align-items-center">
                                            <img class="me-3 wh-80 align-self-center radius-xl"
                                                 src="{{ asset('assets/img/cart3.png') }}"
                                                 alt="Generic placeholder image">
                                            <div class="media-body">
                                                <h5 class="mt-0">Fiber base chair</h5>
                                                <div class="d-flex">
                                ...
                                <tr>
                                    <td colspan="2">
                                        <div class="product-cart__cupon">
                                            <input type="text" class="form-control  col-xl-4 col-md-6 "
                                                   placeholder="Coupon code"/>
                                            <a href="#" class="btn btn-primary col-xl-3 col-lg-4 space-nowrap">Apply
                                                Coupon</a>
                                        </div>
                                    </td>
                                </tr>
                ...
                <div class="cus-xl-3 col-md-8  ">
                    <div class="card order-summery p-sm-25 p-15 order-summery--width mt-lg-0 mt-20">
                        ...
                        <div class="card-body px-sm-25 px-20">
                            ...
                            <a href="checkout.html" class="checkout btn-secondary content-center w-100 btn-lg mt-20">
                                procdces to
