                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active"
                                        aria-current="page">{{ trans('menu.ecommerce-products') }}</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                            ...
                            <form action="/" class="d-flex align-items-center">
                                <div class="job-search">
                                    ...
                                    <input class="form-control border-0 box-shadow-none" type="search"
                                           placeholder="Products" aria-label="Search">
                                </div>
                                ...
                                <div class="card border-0 shadow-none multi-collapse mt-10 collapse show"
                                    ...
                                    <div class="product-category limit-list-item">
                                        <ul>
                                            <li>
                                                <div class="w-100">
                                                    <span class="fs-14 color-gray">Accessories<span
                                                                class="item-numbers">25</span></span>
                                                </div>
                                            </li>
                                            <li>
                                                <div class="w-100">
                                            ...
                                            <li>
                                                <div class="w-100">
                                                    <span class="fs-14 color-gray">Bags<span
                                                                class="item-numbers">78</span></span>
                                                </div>
                                            </li>
                                            <li>
                                                <div class="w-100">
                                            ...
                                            <li>
                                                <div class="w-100">
                                                    <span class="fs-14 color-gray">Entertainment<span
                                                                class="item-numbers">35</span></span>
                                                </div>
                                            </li>
                                            <li>
                                                <div class="w-100">
                                            ...
                                            <li>
                                                <div class="w-100">
                                                    <span class="fs-14 color-gray">Mobile phone<span
                                                                class="item-numbers">92</span></span>
                                                </div>
                                            </li>
                                        </ul>
                                    </div>
                                ...
                                <div class="project-icon-selected content-center mt-lg-0 mt-25">
                                    <div class="listing-social-link pb-lg-0 pb-xs-2">
                                        <div class="icon-list-social d-flex">
                                            <a class="icon-list-social__link rounded-circle icon-list-social__style justify-content-center ms-xl-50 me-15"
                                               href="{{ route('ecommerce.products',app()->getLocale()) }}">
                                                <img class="svg" src="{{ asset('assets/img/svg/grid.svg') }}"
                                                     alt="grid"></a>
                                            <a class="icon-list-social__link rounded-circle icon-list-social__style justify-content-center active "
                                               href="{{ route('ecommerce.product_list',app()->getLocale()) }}">
                                                <img class="svg" src="{{ asset('assets/img/svg/list.svg') }}"
                                                     alt="list"></a>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <button type="button" class="content-center">
                            ...
                            <span>778</span> Reviews</span>
                                                ...
                                                <div class="product-item__button d-xl-block d-flex flex-wrap">
                                                    ...
                                                    <button class="btn btn-default btn-squared color-light btn-outline-light ms-lg-0 ms-0 me-2 mb-lg-10">
                                                        <img src="{{ asset('assets/img/svg/shopping-bag.svg') }}"
                                                             alt="shopping-bag" class="svg">
                                                        Add To Cart
                                                    </button>


                                                    <button class="btn btn-primary btn-default btn-squared border-0 ms-0">
                                                        buy now
                                                    </button>
