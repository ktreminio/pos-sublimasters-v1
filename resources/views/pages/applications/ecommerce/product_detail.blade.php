                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active"
                                        aria-current="page">{{ trans('menu.ecommerce-product-details') }}</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                                        ...
                                        <div class="carousel-inner">
                                            <div class="carousel-item active">
                                                <img class="img-fluid d-flex bg-opacity-primary "
                                                     src="{{ asset('assets/img/furniture') }}.jpg" alt="Card image cap"
                                                     title="">
                                            </div>
                                            <div class="carousel-item">
                                                <img class="img-fluid d-flex bg-opacity-primary"
                                                     src="{{ asset('assets/img/furniture2') }}.jpg" alt="Card image cap"
                                                     title="">
                                            </div>
                                            <div class="carousel-item">
                                                <img class="img-fluid d-flex bg-opacity-primary"
                                                     src="{{ asset('assets/img/furniture3') }}.jpg" alt="Card image cap"
                                                     title="">
                                            </div>
                                        </div>
                                    </div>
                                                ...
                                                <a href="#" class="thumbnail active"
                                                   ...
                                                   aria-current="true" aria-label="Slide 1">
                                                    <img class="img-fluid d-flex"
                                                         src="{{ asset('assets/img/furniture.jpg') }}" alt="">
                                                </a>
                                            </li>
                                            <li>
                                                <a href="#" class="thumbnail " data-bs-target="#carouselExampleCaptions"
                                                   data-bs-slide-to="1" aria-label="Slide 2">
                                                    <img class="img-fluid d-flex"
                                                         src="{{ asset('assets/img/furniture2.jpg') }}" alt="">
                                                </a>
                                            </li>
                                            <li>
                                                <a href="#" class="thumbnail " data-bs-target="#carouselExampleCaptions"
                                                   data-bs-slide-to="2" aria-label="Slide 3">
                                                    <img class="img-fluid d-flex"
                                                         src="{{ asset('assets/img/furniture3.jpg') }}" alt="">
                                                </a>
                                            </li>
                                        </ul>
                                    </div>
                                        ...
                                        <div class="product-item__button mt-lg-30 mt-sm-25 mt-20 d-flex flex-wrap">
                                            <div class=" d-flex flex-wrap product-item__action align-items-center">
                                                ...
                                                <div class="like-icon me-15 my-sm-0 my-3 ">
                                                    <button type="button">
                                                        <img class="svg" src="{{ asset('assets/img/svg/share-2.svg') }}"
                                                             alt="share-2">
                                                    </button>
                                                </div>
                                            </div>
