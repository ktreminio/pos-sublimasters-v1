                                        ...
                                        <ul class="nav px-1 " id="ap-tab" role="tablist">
                                            ...
                                            <li class="nav-item">
                                                <a class="nav-link" id="draft-tab" data-bs-toggle="pill" href="#draft"
                                                   role="tab" aria-controls="draft" aria-selected="false">price</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                        ...
                        <div class="tab-pane fade show active" id="ap-overview" role="tabpanel"
                            ...
                            <button type="button" class="content-center">
                                <i class="lar la-heart icon"></i>
                                                    ...
                                                    <a href="#"><img class="card-img-top img-fluid"
                                                                     src="{{ asset('assets/img/digital-chair.png') }}"
                                                                     alt="digital-chair"></a>
                                                </div>
                            ...
                            <button type="button" class="content-center">
                                <i class="lar la-heart icon"></i>
                                                    ...
                                                    <a href="#"><img class="card-img-top img-fluid"
                                                                     src="{{ asset('assets/img/glass-cup.png') }}"
                                                                     alt="digital-chair"></a>
                                                </div>
                                                <div class="card-body px-20 pb-25 pt-25">
                                                    <div class="product-item__body text-capitalize">
                            ...
                            <button type="button" class="content-center">
                                <i class="lar la-heart icon"></i>
                                                    ...
                                                    <a href="#"><img class="card-img-top img-fluid"
                                                                     src="{{ asset('assets/img/chair2.png') }}"
                                                                     alt="digital-chair"></a>
                                                </div>
                                                <div class="card-body px-20 pb-25 pt-25">
                                                    <div class="product-item__body text-capitalize">
                            ...
                            <button type="button" class="content-center">
                                <i class="lar la-heart icon"></i>
                                                    ...
                                                    <a href="#"><img class="card-img-top img-fluid"
                                                                     src="{{ asset('assets/img/chair.png') }}"
                                                                     alt="digital-chair"></a>
                                                </div>
                                                <div class="card-body px-20 pb-25 pt-25">
                                                    <div class="product-item__body text-capitalize">
                            ...
                            <button type="button" class="content-center">
                                <i class="lar la-heart icon"></i>
                                                    ...
                                                    <a href="#"><img class="card-img-top img-fluid"
                                                                     src="{{ asset('assets/img/plate.png') }}"
                                                                     alt="digital-chair"></a>
                                                </div>
                                                <div class="card-body px-20 pb-25 pt-25">
                                                    <div class="product-item__body text-capitalize">
                            ...
                            <button type="button" class="content-center">
                                <i class="lar la-heart icon"></i>
                                                    ...
                                                    <a href="#"><img class="card-img-top img-fluid"
                                                                     src="{{ asset('assets/img/chair3.png') }}"
                                                                     alt="digital-chair"></a>
                                                </div>
                                                <div class="card-body px-20 pb-25 pt-25">
                                                    <div class="product-item__body text-capitalize">
                            ...
                            <button type="button" class="content-center">
                                <i class="lar la-heart icon"></i>
                                                    ...
                                                    <a href="#"><img class="card-img-top img-fluid"
                                                                     src="{{ asset('assets/img/coffe-glass.png') }}"
                                                                     alt="digital-chair"></a>
                                                </div>
                                                <div class="card-body px-20 pb-25 pt-25">
                                                    <div class="product-item__body text-capitalize">
                            ...
                            <button type="button" class="content-center">
                                <i class="lar la-heart icon"></i>
                                                    ...
                                                    <a href="#"><img class="card-img-top img-fluid"
                                                                     src="{{ asset('assets/img/boss-chair.png') }}"
                                                                     alt="digital-chair"></a>
                                                </div>
                                                <div class="card-body px-20 pb-25 pt-25">
                                                    <div class="product-item__body text-capitalize">
                            ...
                            <button type="button" class="content-center">
                                <i class="lar la-heart icon"></i>
                                                    ...
                                                    <a href="#"><img class="card-img-top img-fluid"
                                                                     src="{{ asset('assets/img/only-juss.png') }}"
                                                                     alt="digital-chair"></a>
                                                </div>
                                                <div class="card-body px-20 pb-25 pt-25">
                                                    <div class="product-item__body text-capitalize">
                            ...
                            <button type="button" class="content-center">
                                <i class="lar la-heart icon"></i>
                                                    ...
                                                    <a href="#"><img class="card-img-top img-fluid"
                                                                     src="{{ asset('assets/img/flip-chair.png') }}"
                                                                     alt="digital-chair"></a>
                                                </div>
                                                <div class="card-body px-20 pb-25 pt-25">
                                                    <div class="product-item__body text-capitalize">
