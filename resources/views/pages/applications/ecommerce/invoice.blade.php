                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active"
                                        aria-current="page">{{ trans('menu.ecommerce-invoices') }}</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                    ...
                    <div class="payment-invoice__body">
                        <div class="payment-invoice-address d-flex justify-content-sm-between">
                            ...
                            <div class="payment-invoice-address__area">
                                <address>Admin Company<br> 795 Folsom Ave, Suite 600<br> San Francisco, CA 94107,
                                    USA<br>
                                    Reg.
                                    number : 245000003513
                                </address>
                        ...
                        <div class="payment-invoice-table">
                            ...
                            <div class="payment-invoice__btn mt-xxl-50 pt-xxl-30">
                                <button type="button"
                                    ...
                                    <img src="{{ asset('assets/img/svg/printer.svg') }}" alt="printer" class="svg">print
                                </button>
                                <button type="button" class="btn border rounded-pill bg-normal text-gray px-25">
                                    <img src="{{ asset('assets/img/svg/send.svg') }}" alt="send" class="svg">invoice
                                </button>
                                <button type="button" class="btn-primary btn rounded-pill px-25 text-white download">
                                    <img src="{{ asset('assets/img/svg/upload.svg') }}" alt="upload" class="svg">download
                                </button>
                            </div>
