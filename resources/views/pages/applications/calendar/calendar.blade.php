                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active"
                                        aria-current="page">{{ trans('menu.calendar-menu-title') }}</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                ...
                <div class="col-xxl-3 col-xl-5 col-md-6 col-sm-8">
                    <div class="dm-calendar-left">
                        <button class="btn btn-primary btn-lg btn-create-event" data-bs-toggle="modal"
                            ...
                            <img class="svg" src="{{ asset('assets/img/svg/plus.svg') }}" alt="">Create New Event
                        </button>
                        ...
                        <form action="#">
                            <div class="e-form-row d-flex">
                                ...
                                <div class="e-form-row__right">
                                    <input type="text" name="e-title" placeholder="Weekly report meeting"
                            ...
                            <div class="e-form-row d-flex">
                                ...
                                <div class="e-form-row__right">
                                    <div class="radio-horizontal-list d-flex flex-wrap">
                                        ...
                                        <div class="radio-theme-default custom-radio ">
                                            <input class="radio" type="radio" name="radio-e-type" value="02"
                                                   id="radio-2">
                                            <label for="radio-2">
                                        ...
                                        <div class="radio-theme-default custom-radio ">
                                            <input class="radio" type="radio" name="radio-e-type" value="03"
                                                   id="radio-3">
                                            <label for="radio-3">
