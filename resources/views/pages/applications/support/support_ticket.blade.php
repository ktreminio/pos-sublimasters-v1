                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active"
                                        aria-current="page">{{ trans('menu.support-ticket') }}</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                            ...
                            <div class=" ap-po-details-content d-flex flex-wrap justify-content-between">
                                ...
                                <div class="ap-po-details__icon-area">
                                    <div class="svg-icon order-bg-opacity-secondary">
                                        <img class="svg" src="{{ asset('assets/img/svg/ticket-green1.svg') }}"
                                             alt="img">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class=" ap-po-details-content d-flex flex-wrap justify-content-between">
                                ...
                                <div class="ap-po-details__icon-area">
                                    <div class="svg-icon order-bg-opacity-warning">
                                        <img class="svg" src="{{ asset('assets/img/svg/clock-ticket1.svg') }}"
                                             alt="img">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class=" ap-po-details-content d-flex flex-wrap justify-content-between">
                                ...
                                <div class="ap-po-details__icon-area">
                                    <div class="svg-icon order-bg-opacity-success">
                                        <img class="svg" src="{{ asset('assets/img/svg/check-circle1.svg') }}"
                                             alt="img">
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="support-ticket-system">
                        ...
                        <div class="breadcrumb-main breadcrumb-main--ticket justify-content-sm-between ">
                            ...
                            <div class="action-btn">
                                ...
                                <!-- Modal -->
                                <div class="modal fade ticket_modal" id="ticket_modal" role="dialog" tabindex="-1"
                                     aria-hidden="true">
