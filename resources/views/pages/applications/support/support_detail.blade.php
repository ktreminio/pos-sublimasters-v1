    ...
    <div class="support-details mt-xl-20">
        <div class="container-fluid">
            <div class="row">
                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="#"><i
                                                    class="las la-home"></i>{{ trans('menu.support-menu-title') }}</a>
                                    </li>
                                    <li class="breadcrumb-item"><a href="#">Apps</a></li>
                                    <li class="breadcrumb-item active"
                                        aria-current="page">{{ trans('page_title.ticket_detail') }}</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                ...
                <div class="col-lg-12">
                    <div class="back-page">
                        <a href="support-ticket.html"><img src="{{ asset('assets/img/svg/arrow-left.svg') }}"
                        ...
                        <div class="ticket-file-attach__wrapper">
                            <div class="ticket-file-attach__items">
                                ...
                                <div class="ticket-file-attach__items_download">
                                    <a href="#">
                                        <img src="{{ asset('assets/img/svg/download.svg') }}" alt="download"
                                             class="svg">
                                    </a>
                                </div>
                            </div>
                                            ...
                                            <div class="ticket-users-list-body-title">
                                                ...
                                                <div class="text-limit" data-maxlength="10">
                                                    <p class="mb-0">All the Lorem Ipsum generators on the Internet tend
                                                        There are have a many variations of passages.</p>
                                                </div>
                                            </div>
                                            <div class="last-chat-time unread">
                                                <small>1 hour ago</small>
                                    ...
                                    <div class="ticket-user-list-item__wrapper">
                                        ...
                                        <div class="ticket-users-list-body">
                                            <div class="ticket-users-list-body-title">
                                                <h6>Meyri Carles</h6>
                                                <div class="text-limit" data-maxlength="10">
                                                    <p class="mb-0"><span>Lorem ipsum dolor us was they amet</span>...
                                                    </p>
                                                </div>
                                            </div>
                                            <div class="last-chat-time unread">
