    ...
    <div class="container-fluid">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active"
                                    aria-current="page">{{ trans('menu.kanban-menu-title') }}</li>
                            </ol>
                        </nav>
                    </div>
                </div>
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="modal fade kanban-modal__card kanban__modal" id="exampleModal" tabindex="-1"
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body kanban-modal__body">
                                <div class="kanban-modal__form ">
                                    <div class="mb-30">
                                        <label for="exampleFormControlTextarea1111"
                                               class="form-label">Description</label>
                                        <textarea class="form-control" id="exampleFormControlTextarea1111" rows="3"
                                                  placeholder="Add a more detailed description…"></textarea>
                                    </div>
                                    <button class="btn btn-primary btn-sm btn-squared  rounded"><img
                                                src="{{ asset('assets/img/svg/check-square.svg') }}" alt="check-square"
                                                class="svg"> Add Checklist
                                    </button>
                                </div>
                                ...
                                <div class="kanban-modal__research mt-30">
                                    <h6>Research </h6>
                                    <button class="btn btn-primary btn-sm btn-squared btn-transparent-primary ">delete
                                    </button>
                                </div>
                        ...
                        <div class="list kanban-list draggable" draggable="true">
                            ...
                            <ul class="kanban-items list-items  drag-drop ">
                                ...
                                <li class="d-flex justify-content-between align-items-center ">
                                    <div class="lists-items-title" data-bs-toggle="modal" data-bs-target="#exampleModal"
                                         data-whatever="@mdo72">
                                        File Manager Design
                                    </div>
                                        ...
                                        <div class="popup-content">
                                            <div class="mb-10 popup-textarea">
                                                <textarea class="form-control" rows="3"
                                                          placeholder="Edit title..."></textarea>
                                            </div>
                                            <div class="d-flex align-items-center popup-button">
                                                <button class="save-title-changes btn btn-primary btn-sm btn-squared rounded"
                                                        type="submit">Submit
                                                </button>
                                            </div>
                            ...
                            <button class="add-card-btn"><img src="{{ asset('assets/img/svg/plus.svg') }}" alt="plus"
                                                              class="svg"> Add a
                                card
                            </button>
                        ...
                        <div class="kanban-list list draggable" draggable="true">
                            <div class="list__add-card">
                                <div class="kanban-board__add-card">
                                    <button class="shadow-none border-0"><img
                                                src="{{ asset('assets/img/svg/plus.svg') }}" alt="plus" class="svg">
                                        Add
                                        column
                                    </button>
                                </div>
