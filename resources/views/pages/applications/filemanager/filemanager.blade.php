                                            ...
                                            <div class="card border-0 shadow-none">
                                                <div class="card-body px-15 pt-30">
                                                    ...
                                                    <div class="modal fade fileM-Modal-overlay" id="staticBackdrop1"
                                                         ...
                                                         tabindex="-1" aria-labelledby="staticBackdrop1Label"
                                                         aria-hidden="true">
                                                            ...
                                                            <div class="modal-content">
                                                                <div class="modal-header">
                                                                    ...
                                                                    <button type="button" class="close"
                                                                        ...
                                                                        <img class="svg"
                                                                             src="{{ asset('assets/img/svg/x.svg') }}"
                                                                             alt="x">
                                                                    </button>
                                                                </div>
                                                    ...
                                                    <div class="modal fade fileM-Modal-overlay" id="staticBackdrop2"
                                                         data-bs-backdrop="static" data-bs-keyboard="false"
                                                         tabindex="-1" aria-labelledby="staticBackdrop2Label"
                                                         aria-hidden="true">
                                                        <div class="modal-dialog modal-dialog-centered">
                                                            <div class="modal-content">
                                                                <div class="modal-header">
                                                    ...
                                                    <div class="modal fade fileM-Modal-overlay" id="staticBackdrop3"
                                                         data-bs-backdrop="static" data-bs-keyboard="false"
                                                         tabindex="-1" aria-labelledby="staticBackdrop3Label"
                                                         aria-hidden="true">
                                                        <div class="modal-dialog modal-dialog-centered">
                                                            <div class="modal-content">
                                                                <div class="modal-header">
                                                    ...
                                                    <div class="fileM-types">
                                                        <div class="sidebar__menu-group">
                                                            <ul class="sidebar_nav">
                                                                ...
                                                                <li class="has-child">
                                                                    <a href="#" class="">
                                                                        <img src="{{ asset('assets/img/svg/file.svg') }}"
                                                                             alt="file" class="svg nav-icon">
                                                                ...
                                                                <div class="icon-list-social d-flex">
                                                                    <a class="icon-list-social__link rounded-circle icon-list-social__style justify-content-center ms-xl-20 me-20  active"
                                                                       href="{{ route('filemanager',app()->getLocale()) }}">
                                                                        <img src="{{ asset('assets/img/svg/grid.svg') }}"
                                                                             alt="grid" class="svg"></a>
                                                                    <a class="icon-list-social__link rounded-circle icon-list-social__style justify-content-center "
                                                                       href="{{ route('filemanager_list',app()->getLocale()) }}">
                                                                        <img src="{{ asset('assets/img/svg/list.svg') }}"
                                                                             alt="list" class="svg"></a>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                                                ...
                                                                                <div class="fileM-action__right ">
                                                                                    <div class="dropdown dropleft position-absolute">
                                                                                        ...
                                                                                        <div class="dropdown-menu">
                                                                                            ...
                                                                                            <a class="dropdown-item"
                                                                                               href="#">
                                                                                                <img src="{{ asset('assets/img/svg/link-2.svg') }}"
                                                                                                     alt="link-2"
                                                                                                     class="svg">
                                                                                                Copy
                                                                                            </a>
                                                            ...
                                                            <div class="fileM-single mb-25">
                                                                <div class="fileM-card ">
                                                                    <div class="card border-0">
                                                                        <div class="card-body pb-40 pt-45">
                                                                            <div class="fileM-img">
                                                                                <img class="wh-50" src="img/zip.png"
                                                                                     alt="">
                                                                            </div>
                                                                            <p class="fileM-excerpt">
                                                                                Main-admin-design.zip </p>
