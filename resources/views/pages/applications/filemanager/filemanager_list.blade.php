                                ...
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active"
                                            aria-current="page">{{ trans('menu.filemanager-menu-title') }}</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                                        ...
                                        <div class="fileM-sidebar">
                                            <div class="card border-0 shadow-none">
                                                <div class="card-body px-15 pt-30">
                                                        ...
                                                        <div class="fileM-action__right">
                                                            <div class="dropdown dropleft content-center d-flex">
                                                                <a href="#"
                                                                   ...
                                                                   aria-expanded="false">
                                                                    <img class="svg"
                                                                         src="{{ asset('assets/img/svg/plus.svg') }}"
                                                                         alt="">
                                                                    Add Files</a>
                                                                <div class="dropdown-menu">
                                                                    <a class="dropdown-item" href="#"
                                                                       data-bs-toggle="modal"
                                                                       data-bs-target="#staticBackdrop1"><img
                                                                                src="{{ asset('assets/img/svg/folder.svg') }}"
                                                                                alt="folder" class="svg">Create
                                                                        folder</a>
                                                                    <a class="dropdown-item" href="#"
                                                                       data-bs-toggle="modal"
                                                                       data-bs-target="#staticBackdrop2"><img
                                                                                src="{{ asset('assets/img/svg/folder.svg') }}"
                                                                                alt="folder" class="svg">File Upload
                                                                    </a>
                                                                    <a class="dropdown-item" href="#"
                                                                       data-bs-toggle="modal"
                                                                       data-bs-target="#staticBackdrop3"><img
                                                                                src="{{ asset('assets/img/svg/folder.svg') }}"
                                                                                alt="folder" class="svg">Folder
                                                                        Upload</a>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <!-- Modal -->
                                                    <div class="modal fade fileM-Modal-overlay" id="staticBackdrop1"
                                                            ...
                                                            <div class="modal-content">
                                                                <div class="modal-header">
                                                                    <h6 class="modal-title fw-500"
                                                                        id="staticBackdrop1Label">Create File</h6>
                                                                    <button type="button"
                                                    ...
                                                    <!-- Modal -->
                                                    <div class="modal fade fileM-Modal-overlay" id="staticBackdrop2"
                                                         data-backdrop="static" data-keyboard="false" tabindex="-1"
                                                        ...
                                                        <div class="modal-dialog modal-dialog-centered">
                                                            <div class="modal-content">
                                                                <div class="modal-header">
                                                                    <h6 class="modal-title fw-500"
                                                                        id="staticBackdrop2Label">File Upload File</h6>
                                                                    <button type="button"
                                                                            class="close shadow-none border-0 bg-transparent "
                                                                            data-bs-dismiss="modal" aria-label="Close">
                                                                        <span aria-hidden="true"
                                                    ...
                                                    <!-- Modal -->
                                                    <div class="modal fade fileM-Modal-overlay" id="staticBackdrop3"
                                                         data-backdrop="static" data-keyboard="false" tabindex="-1"
                                                        ...
                                                        <div class="modal-dialog modal-dialog-centered">
                                                            <div class="modal-content">
                                                                <div class="modal-header">
                                                                    <h6 class="modal-title fw-500"
                                                                        id="staticBackdrop3Label">Folder Upload</h6>
                                                                    <button type="button"
                                                                            class="close shadow-none border-0 bg-transparent "
                                                                            data-bs-dismiss="modal" aria-label="Close">
                                                                        <span aria-hidden="true"
                                                                ...
                                                                <li class="has-child">
                                                                    <a href="#" class="">
                                                                        <img class="svg nav-icon"
                                                                             src="{{ asset('assets/img/svg/file.svg') }}"
                                                                             alt="file">
                                                                                ...
                                                                                <li>
                                                                                    <a class=" active"
                                                                                       ...
                                                                                       aria-selected="true"><img
                                                                                                src="{{ asset('assets/img/svg/folder.svg') }}"
                                                                                                alt="folder"
                                                                                                class="svg nav-icon">Prototypes</a>
                                                                                </li>
                                                                                <li>
                                                                                ...
                                                                                <li>
                                                                                    <a id="pills-contact-tab"
                                                                                       ...
                                                                                       aria-selected="false"><img
                                                                                                src="{{ asset('assets/img/svg/folder.svg') }}"
                                                                                                alt="folder"
                                                                                                class="svg nav-icon">Illustrations</a>
                                                                                </li>
                                                                            </ul>
                                                                        </li>
                                                                        <li>
                                            ...
                                            <div class="fileM-top-search">
                                                <form action="/" class="d-flex align-items-center">
                                                    <img src="{{ asset('assets/img/svg/search.svg') }}" alt="search"
                                                         class="svg">
                                                    <input class="form-control px-10 border-0 box-shadow-none"
                                                ...
                                                <div class="project-icon-selected">
                                                    <div class="listing-social-link pb-lg-0 pb-xs-2">
                                                        <div class="icon-list-social d-flex">
                                                            <a class="icon-list-social__link rounded-circle icon-list-social__style justify-content-center ms-xl-20 me-20  "
                                                               href="{{ route('filemanager',app()->getLocale()) }}">
                                                                <img class="svg"
                                                                     src="{{ asset('assets/img/svg/grid.svg') }}"
                                                                     alt="grid"></a>
                                                            <a class="icon-list-social__link rounded-circle icon-list-social__style justify-content-center  active"
                                                               href="{{ route('filemanager_list',app()->getLocale()) }}">
                                                                <img class="svg"
                                                    ...
                                                    <div class="fileM-card ">
                                                        <div class="card border-0">
                                                            <div class="card-body pb-40 pt-45">
                                                                <div class="fileM-img">
                                                                    <img class="wh-50"
                                                                         src="{{ asset('assets/img/zip.png') }}" alt="">
                                                                </div>
                                                                    ...
                                                                    <div class="fileM-action__right ">
                                                                        <div class="dropdown dropleft position-absolute">
                                                                            <button class="btn-link border-0 bg-transparent p-0"
                                                                                    ...
                                                                                    aria-expanded="false">
                                                                                <img class="svg"
                                                                                     src="{{ asset('assets/img/svg/more-vertical.svg') }}"
                                                                                     alt="more-vertical">
                                                                            </button>
                                                                            <div class="dropdown-menu">
                                                                                <a class="dropdown-item" href="#"><img
                                                                                            src="{{ asset('assets/img/svg/download.svg') }}"
                                                                                            alt="download" class="svg">Download</a>
                                                                                <a class="dropdown-item" href="#"><img
                                                                                            src="{{ asset('assets/img/svg/link-2.svg') }}"
                                                                                            alt="link-2" class="svg">Copy</a>
                                                                                <a class="dropdown-item" href="#"><img
                                                                                            class="svg"
                                                    ...
                                                    <div class="fileM-card ">
                                                        <div class="card border-0">
                                                            <div class="card-body pb-40 pt-45">
                                                                <div class="fileM-img">
                                                                    <img class="wh-50"
                                                                         src="{{ asset('assets/img/psd.png') }}" alt="">
                                                                </div>
                                                    ...
                                                    <table class="table mb-0">
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <div class="files-area__left d-flex align-items-center">
                                                                    <div class="files-area__img">
                                                                        <img src="{{ asset('assets/img/zip.png') }}"
                                                                             alt="img" class="wh-40">
                                                                    </div>
                                                                    <div class="files-area__title">
                                                                        <p class="mb-0 fs-14 fw-500 color-dark text-capitalize">
                                                            ...
                                                            <td>
                                                                ...
                                                                <ul class="d-flex user-group-people__parent align-content-center">
                                                                    ...
                                                                    <li>
                                                                        <a href="#"><img class="rounded-circle wh-34"
                                                                                         src="{{ asset('assets/img/tm6.png') }}"
                                                                                         alt="author"></a>
                                                                    </li>
                                                                    <li class="d-flex align-items-center ms-1"><span
                                                                                class="fs-12 color-light fw-500"><i
                                                                                    class="las la-plus fs-10"></i>5 more</span>
                                                                    </li>
                                                                </ul>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <div class="files-area__left d-flex align-items-center">
                                                                    <div class="files-area__img">
                                                                        <img src="{{ asset('assets/img/psd.png') }}"
                                                                             alt="img" class="wh-40">
                                                                    </div>
                                                                    <div class="files-area__title">
                                                                        <p class="mb-0 fs-14 fw-500 color-dark text-capitalize">
