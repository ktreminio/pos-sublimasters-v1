            ...
            <div class="col-lg-12">
                <div class="shop-breadcrumb">
                    <div class="breadcrumb-main">
                        <h4 class="text-capitalize breadcrumb-title">{{ trans('page_title.job_search_list') }}</h4>
                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active"
                                        aria-current="page">{{ trans('page_title.job_search_list') }}</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                        ...
                        <div class="category_sidebar">
                            ...
                            <aside class="product-sidebar-widget mb-30">
                                <div class="widget_title" data-bs-toggle="collapse"
                                     data-bs-target="#multiCollapseExample1" role="button" aria-expanded="true">
                                    <h6>job type</h6>
                                </div>
                                ...
                                <div class="card border-0 shadow-none multi-collapse mt-10 collapse show"
                                    ...
                                    <div class="product-brands">
                                        <ul>
                                            ...
                                            <li>
                                                <div class="checkbox-theme-default custom-checkbox ">
                                                    <input class="checkbox" type="checkbox" id="check-22">
                                                    <label for="check-22">
                                                    <span class="checkbox-text">
                                                        Yearly
                                                        <span class="item-numbers">42</span>
