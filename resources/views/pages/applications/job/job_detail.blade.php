                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active"
                                        aria-current="page">{{ trans('page_title.job_detail') }}</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                    ...
                    <div class="job-details-card">
                        <div class="job-details-card__top flex-wrap">
                            <div class="job-item__image">
                                <a href="#">
                                    <img class="job-item__image-img img-fluid" src="{{ asset('assets/img/stats.png') }}"
                                         alt="digital-chair">
                                </a>
                        ...
                        <div class="job-details-card__middle">
                            ...
                            <p>There are have a many variations of passages of Lorem Ipsum available, but the randomised
                                ...
                                repeat predefined chunks as necessary, making which don't
                                first true generator on the Internet.</p>
                            <h4>Requirements</h4>
                            <ul>
                                <li>At least 3+ years of working experience in PHP/WordPress.</li>
                                <li>Solid PHP knowledge and a good understanding of advanced PSP concepts eg. OOP,
                                    Namespace, Taits ,etc
                                </li>
                                <li>HTMl/CSS</li>
                                ...
                                <li>Solid understanding of WordPress core features eg. action/hooks,restAPI,post
                                    type,taxonomies,post meta, database stuctures,etc.
                                </li>
                                <li>Good understanding of PHP/WordPress coding standard</li>
                                <li>Must be able to write quality code following the coding standards and best
                                    practice.
                                </li>
