                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="#"><i
                                                    class="uil uil-estate"></i>{{ trans('menu.job-menu-title') }}</a>
                                    </li>
                                    <li class="breadcrumb-item active"
                                        aria-current="page">{{ trans('page_title.job_search') }}</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                            ...
                            <form action="/" class="d-flex align-items-center">
                                <div class="job-search">
                                    ...
                                    <input class="form-control border-0 box-shadow-none" type="search"
                                           placeholder="Job title, skills, or company" aria-label="Search">
                                </div>
                        ...
                        <div class="category_sidebar">
                            <aside class="product-sidebar-widget mb-30">
                                <div class="widget_title nocollapse">
                                    <h6>Distance</h6>
                                    <p class="mb-0 widget_title__distence">Within 30 miles of <strong>New York,
                                            NY</strong>
                                    </p>
                                </div>
                            ...
                            <aside class="product-sidebar-widget mb-30">
                                <div class="widget_title" data-bs-toggle="collapse" href="#multiCollapseExample1"
                                     role="button" aria-expanded="true" aria-controls="multiCollapseExample1">
                                    <h6>job type</h6>
                                </div>
                            ...
                            <aside class="product-sidebar-widget mb-30">
                                <div class="widget_title" data-bs-toggle="collapse" href="#multiCollapseExample2"
                                     role="button" aria-expanded="true" aria-controls="multiCollapseExample2">
                                    <h6>Industry</h6>
                                </div>
                                <div class="card border-0 shadow-none multi-collapse mt-10 collapse show"
                            ...
                            <aside class="product-sidebar-widget mb-30">
                                <div class="widget_title" data-bs-toggle="collapse" href="#multiCollapseExample3"
                                     role="button" aria-expanded="true" aria-controls="multiCollapseExample3">
                                    <h6>Salary</h6>
                                </div>
                                <div class="card border-0 shadow-none multi-collapse mt-10 collapse show"
                            ...
                            <aside class="product-sidebar-widget">
                                <div class="widget_title" data-bs-toggle="collapse" href="#multiCollapseExample4"
                                     role="button" aria-expanded="true" aria-controls="multiCollapseExample4">
                                    <h6>Date Posted</h6>
                                </div>
                                <div class="card border-0 shadow-none multi-collapse mt-10 collapse show"
                                ...
                                <div class="project-icon-selected content-center mt-lg-0 mt-25">
                                    <div class="listing-social-link pb-lg-0 pb-xs-2">
                                        <div class="icon-list-social d-flex">
                                            <a class="icon-list-social__link rounded-circle icon-list-social__style justify-content-center active ms-xl-50  me-15"
                                               href="jobSearch.html">
                                            ...
                                            <a class="icon-list-social__link rounded-circle icon-list-social__style justify-content-center  "
                                               href="jobDetails.html">
                                                <img src="{{ asset('assets/img/svg/list.svg') }}" alt="list"
                                                     class="svg"></a>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="card-body p-0  d-flex align-items-sm-center align-items-start  flex-sm-row flex-column">
                                            <div class="job-item__body text-capitalize">
                                                <div class="job-item__image d-flex align-items-center">
                                                    <a href="#"><img class="job-item__image-img img-fluid"
                                                                     src="{{ asset('assets/img/stats.png') }}"
                                                                     alt="digital-chair"></a>
                                            ...
                                            <div class="job-item__button d-flex flex-wrap my-sm-0 my-10">
                                                <button class="btn btn-default btn-squared btn-outline-none px-20">View
                                                    details
                                                </button>
                                            </div>
                                        </div>
                                    ...
                                    <div class="job-item px-25 pt-30 pb-25">
                                        <div class="card-body p-0  d-flex align-items-sm-center align-items-start  flex-sm-row flex-column">
                                            <div class="job-item__body text-capitalize">
                                                <div class="job-item__image d-flex align-items-center">
                                                    <a href="#"><img class="job-item__image-img img-fluid"
                                                                     src="{{ asset('assets/img/chrome.png') }}"
                                                                     alt="digital-chair"></a>
                                                    <div class="job-item__title">
                                                        <a href="">
                                    ...
                                    <div class="job-item px-25 pt-30 pb-25">
                                        <div class="card-body p-0  d-flex align-items-sm-center align-items-start  flex-sm-row flex-column">
                                            <div class="job-item__body text-capitalize">
                                                <div class="job-item__image d-flex align-items-center">
                                                    <a href="#"><img class="job-item__image-img img-fluid"
                                                                     src="{{ asset('assets/img/firefox.png') }}"
                                                                     alt="digital-chair"></a>
                                                    <div class="job-item__title">
                                                        <a href="jobDetails.html">
