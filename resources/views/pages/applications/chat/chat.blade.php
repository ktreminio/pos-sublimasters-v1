                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active"
                                    aria-current="page">{{ trans('page_title.chat') }}</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                            ...
                            <ul class="nav ap-tab-main border-bottom text-capitalize" id="ueberTab" role="tablist">
                                <li class="nav-item me-0">
                                    <a class="nav-link active" id="first-tab" data-bs-target="#panel_b_first"
                                       data-secondary="#panel_a_first" data-bs-toggle="tab" href="#first" role="tab"
                                ...
                                <li class="nav-item me-0">
                                    <a class="nav-link group-notification" id="second-tab"
                                       ...
                                       data-bs-toggle="tab" href="#second" role="tab" aria-controls="second-tab"
                                       aria-selected="false">
                                        group chat
                                ...
                                <li class="nav-item me-0">
                                    <a class="nav-link" id="third-tab" data-bs-target="#panel_b_thrid"
                                       data-secondary="#panel_a_third" data-bs-toggle="tab" href="#third" role="tab"
                                       aria-controls="third-tab" aria-selected="false">all
                                        contact</a>
                                </li>
                            </ul>
                        </div>
                                ...
                                <div class="tab-pane fade show active" id="panel_a_first" role="tabpanel"
                                    ...
                                    <ul class="user-list">
                                        <li class="user-list-item">
                                            <div class="user-list-item__wrapper">
                                                <div class="avatar avatar-circle ms-0">
                                                    <img src="{{ asset('assets/img/ellipse1.png') }}"
                                                ...
                                                <div class="users-list-body">
                                                    <div class="users-list-body-title">
                                                        ...
                                                        <div class="text-limit" data-maxlength="10">
                                                            <p class="mb-0"><span>Lorem ipsum dolor us was they amet fdsfdsf sdf dsf dsf dsf dsf dsf d</span>...
                                                            </p>
                                                        </div>
                                                    </div>
                                        ...
                                        <li class="user-list-item">
                                            <div class="user-list-item__wrapper">
                                                <div class="avatar avatar-circle ms-0">
                                                    <img src="{{ asset('assets/img/ellipse2.png') }}"
                                                         class="rounded-circle wh-46 d-flex bg-opacity-primary"
                                                         alt="image">
                                                    <div class="badge-direction-bottom">
                                                ...
                                                <div class="users-list-body">
                                                    <div class="users-list-body-title">
                                                        ...
                                                        <div class="text-limit" data-maxlength="10">
                                                            <p class="mb-0">
                                                                <span>Lorem ipsum dolor us was they amet</span>...</p>
                                                        </div>
                                                    </div>
                                                    <div class="last-chat-time unread">
                                                        <small>14:45 pm</small>
                                        ...
                                        <li class="user-list-item">
                                            <div class="user-list-item__wrapper">
                                                <div class="avatar avatar-circle ms-0">
                                                    <img src="{{ asset('assets/img/ellipse3.png') }}"
                                                         class="rounded-circle wh-46 d-flex bg-opacity-primary"
                                                         alt="image">
                                                    <div class="badge-direction-bottom">
                                                        <span class="chat-badge-dot avatar-online"></span>
                                        ...
                                        <li class="user-list-item">
                                            <div class="user-list-item__wrapper">
                                                <div class="avatar avatar-circle ms-0">
                                                    <img src="{{ asset('assets/img/ellipse4.png') }}"
                                                         class="rounded-circle wh-46 d-flex bg-opacity-primary"
                                                         alt="image">
                                                    <div class="badge-direction-bottom">
                                                        <span class="chat-badge-dot avatar-offline"></span>
                                        ...
                                        <li class="user-list-item">
                                            <div class="user-list-item__wrapper">
                                                <div class="avatar avatar-circle ms-0">
                                                    <img src="{{ asset('assets/img/ellipse5.png') }}"
                                                         class="rounded-circle wh-46 d-flex bg-opacity-primary"
                                                         alt="image">
                                                    <div class="badge-direction-bottom">
                                                        <span class="chat-badge-dot avatar-online"></span>
                                        ...
                                        <li class="user-list-item">
                                            <div class="user-list-item__wrapper">
                                                <div class="avatar avatar-circle ms-0">
                                                    <img src="{{ asset('assets/img/ellipse6.png') }}"
                                                         class="rounded-circle wh-46 d-flex bg-opacity-primary"
                                                         alt="image">
                                                    <div class="badge-direction-bottom">
                                                        <span class="chat-badge-dot avatar-online"></span>
                                        ...
                                        <li class="user-list-item">
                                            <div class="user-list-item__wrapper">
                                                <div class="avatar avatar-circle ms-0">
                                                    <img src="{{ asset('assets/img/ellipse7.png') }}"
                                                         class="rounded-circle wh-46 d-flex bg-opacity-primary"
                                                         alt="image">
                                                    <div class="badge-direction-bottom">
                                                        <span class="chat-badge-dot avatar-online"></span>
                                        ...
                                        <li class="user-list-item">
                                            <div class="user-list-item__wrapper">
                                                <div class="avatar avatar-circle ms-0">
                                                    <img src="{{ asset('assets/img/ellipse8.png') }}"
                                                         class="rounded-circle wh-46 d-flex bg-opacity-primary"
                                                         alt="image">
                                                    <div class="badge-direction-bottom">
                                                        <span class="chat-badge-dot avatar-offline"></span>
                                        ...
                                        <li class="user-list-item">
                                            <div class="user-list-item__wrapper">
                                                <div class="avatar avatar-circle ms-0">
                                                    <img src="{{ asset('assets/img/ellipse9.png') }}"
                                                         class="rounded-circle wh-46 d-flex bg-opacity-primary"
                                                         alt="image">
                                                    <div class="badge-direction-bottom">
                                                        <span class="chat-badge-dot avatar-online"></span>
                                ...
                                <div class="tab-pane fade" id="panel_a_second" role="tabpanel"
                                    ...
                                    <ul class="user-list">
                                        <li>
                                            <div class="user-button-top">
                                                <button type="button"
                                                    ...
                                                    <img src="{{ asset('assets/img/svg/edit.svg') }}" alt="edit"
                                                         class="svg">
                                                    create a new group
                                                </button>
                                            </div>
                                        ...
                                        <li class="user-list-item">
                                            <div class="user-list-item__wrapper">
                                                <div class="avatar avatar-circle ms-0">
                                                    <img src="{{ asset('assets/img/ellipse10.png') }}"
                                                         class="rounded-circle wh-46 d-flex bg-opacity-primary"
                                                         alt="image">
                                                    <div class="badge-direction-bottom">
                                                        <span class="chat-badge-dot avatar-offline"></span>
                                        ...
                                        <li class="user-list-item">
                                            <div class="user-list-item__wrapper">
                                                <div class="avatar avatar-circle ms-0">
                                                    <img src="{{ asset('assets/img/ellipse11.png') }}"
                                                         class="rounded-circle wh-46 d-flex bg-opacity-primary"
                                                         alt="image">
                                                    <div class="badge-direction-bottom">
                                                        <span class="chat-badge-dot avatar-online"></span>
                                        ...
                                        <li class="user-list-item">
                                            <div class="user-list-item__wrapper">
                                                <div class="avatar avatar-circle ms-0">
                                                    <img src="{{ asset('assets/img/ellipse12.png') }}"
                                                         class="rounded-circle wh-46 d-flex bg-opacity-primary"
                                                         alt="image">
                                                    <div class="badge-direction-bottom">
                                                        <span class="chat-badge-dot avatar-online"></span>
                                        ...
                                        <li class="user-list-item">
                                            <div class="user-list-item__wrapper">
                                                <div class="avatar avatar-circle ms-0">
                                                    <img src="{{ asset('assets/img/ellipse13.png') }}"
                                                         class="rounded-circle wh-46 d-flex bg-opacity-primary"
                                                         alt="image">
                                                    <div class="badge-direction-bottom">
                                                        <span class="chat-badge-dot avatar-online"></span>
                                        ...
                                        <li class="user-list-item">
                                            <div class="user-list-item__wrapper">
                                                <div class="avatar avatar-circle ms-0">
                                                    <img src="{{ asset('assets/img/ellipse15.png') }}"
                                                         class="rounded-circle wh-46 d-flex bg-opacity-primary"
                                                         alt="image">
                                                    <div class="badge-direction-bottom">
                                                        <span class="chat-badge-dot avatar-online"></span>
                                            ...
                                            <div class="user-button-top">
                                                <button type="button"
                                                    ...
                                                    <img src="{{ asset('assets/img/svg/user-plus.svg') }}"
                                                         alt="user-plus" class="svg">Add New Contact
                                                </button>
                                            </div>
                                        </li>
                                        <li class="user-list-item">
                                ...
                                <li class="nav-item list-inline-item me-0">
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right">
                                            ...
                                            <a class="dropdown-item align-items-center d-flex" href="#">
                                                <img src="{{ asset('assets/img/svg/trash-2.svg') }}" alt="trash-2"
                                                     class="svg">
                                                <span>Delete conversation</span>
                                            </a>
                                            <a class="dropdown-item align-items-center d-flex" href="#">
                                                <img src="{{ asset('assets/img/svg/x-octagon.svg') }}" alt="x-octagon"
                                                     class="svg">
                                    ...
                                    <div class="media ">
                                        <div class="chat-text-box__photo ">
                                            <img src="{{ asset('assets/img/author/1.jpg') }}"
                                                 class="align-self-start me-15 wh-46" alt="img">
                                        </div>
                                                                ...
                                                                <div class="dropdown  dropdown-click ">
                                                                    <button class="btn-link border-0 bg-transparent p-0"
                                                                        ...
                                                                        <img src="{{ asset('assets/img/svg/smile.svg') }}"
                                                                             alt="smile" class="svg"></button>
                                                                    <div class="dropdown-default dropdown-bottomRight dropdown-menu-right dropdown-menu">
                                                                        <ul class="emotions__parent d-flex">
                                                                            <li>
                                                                                <a class="" href="#">
                                                                                    <img src="{{ asset('assets/img/svg/cool.png') }}"
                                                                                         alt="emotions">
                                                                                </a>
                                                                            </li>
                                                                            <li><a class="" href="#">
                                                                                    <img src="{{ asset('assets/img/svg/happy2.png') }}"
                                                                                         alt="emotions">
                                                                                </a></li>
                                                                            <li><a class="" href="#">
                                                                                    <img src="{{ asset('assets/img/svg/happy.png') }}"
                                                                                         alt="emotions">
                                                                                </a></li>
                                                                            <li><a class="" href="#">
                                                                                    <img src="{{ asset('assets/img/svg/shocked.png') }}"
                                                                                         alt="emotions">
                                                                                </a></li>
                                                                            <li><a class="" href="#">
                                                                                    <img src="{{ asset('assets/img/svg/like.png') }}"
                                                                                         alt="emotions">
                                                                                </a></li>
                                                                            <li><a class="" href="#">
                                                                                    <img src="{{ asset('assets/img/svg/heart.png') }}"
                                                                                         alt="emotions">
                                                                                </a></li>
                                                                        </ul>
                                                                    </div>
                                        ...
                                        <div class="media-body">
                                            <div class="chat-text-box__content">
                                                ...
                                                <div class="seen-chat d-flex align-items-center  justify-content-end mb-2 mt-10">
                                                    ...
                                                    <img src="{{ asset('assets/img/author/1.jpg') }}" alt="img"
                                ...
                                <div class="pt-0 outline-0 pb-0 pe-0 ps-0 rounded-0 position-relative d-flex align-items-center"
                                    ...
                                    <div class="d-flex justify-content-between align-items-center w-100 flex-wrap">
                                        <div class=" flex-1 d-flex align-items-center chat-type-text__write ms-0">
                                            <a href="#"><img class="svg" src="{{ asset('assets/img/svg/smile.svg') }}"
                                                             alt="smile"></a>
                                        ...
                                        <div class="chat-type-text__btn">
                                            <button type="button"
                                                ...
                                                <img class="svg" src="{{ asset('assets/img/svg/image.svg') }}"
                                                     alt="image"></button>
                                            <button type="button"
                                                    class="border-0 btn-deep color-light wh-50 p-10 rounded-circle">
                                                <img class="svg" src="{{ asset('assets/img/svg/paperclip.svg') }}"
                                                     alt="paperclip"></button>
                                            <button type="button"
                                                    class="border-0 btn-primary wh-50 p-10 rounded-circle">
                                                <img class="svg" src="{{ asset('assets/img/svg/send.svg') }}"
                                                     alt="send"></button>
                                        </div>
                                    </div>
                                </div>
                                            ...
                                            <div class="chat-text-box__content">
                                                ...
                                                <div class="seen-chat seen-chat-group  d-flex align-items-center  justify-content-end mb-2 mt-10">
                                                    <ul class="d-flex">
                                                        ...
                                                        <li>
                                                            <img src="{{ asset('assets/img/author/2.jpg') }}" alt="img"
                                                                 class="wh-20 rounded-circle">
                                                        </li>
                                                        <li>
                                                            <img src="{{ asset('assets/img/author/3.jpg') }}" alt="img"
                                                                 class="wh-20 rounded-circle">
                                                        </li>
                                                        <li>
                                                            <img src="{{ asset('assets/img/author/4.jpg') }}" alt="img"
                                                                 class="wh-20 rounded-circle">
                                                        </li>
                                                        <li>
                                                            <img src="{{ asset('assets/img/author/1.jpg') }}" alt="img"
                            ...
                            <div class="chat-type-text">
                                <div class="pt-0 outline-0 pb-0 pe-0 ps-0 rounded-0 position-relative d-flex align-items-center"
                                    ...
                                    <div class="d-flex justify-content-between align-items-center w-100 flex-wrap">
                                        <div class=" flex-1 d-flex align-items-center chat-type-text__write ms-0">
                                            <a href="#">
                                                <img src="{{ asset('assets/img/svg/smile.svg') }}" alt="smile"
                                                     class="svg">
                                            </a>
                                        ...
                                        <div class="chat-type-text__btn">
                                            <button type="button"
                                                    class="border-0 btn-deep color-light wh-50 p-10 rounded-circle">
                                                <img src="{{ asset('assets/img/svg/image.svg') }}" alt="image"
                                                     class="svg"></button>
                                            <button type="button"
                                                    class="border-0 btn-deep color-light wh-50 p-10 rounded-circle">
                                                <img src="{{ asset('assets/img/svg/paperclip.svg') }}" alt="paperclip"
                                                     class="svg"></button>
                                            <button type="button"
                                                    class="border-0 btn-primary wh-50 p-10 rounded-circle">
                                                <img src="{{ asset('assets/img/svg/send.svg') }}" alt="send"
                                                     class="svg"></button>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="chat-type-text">
                                <div class="pt-0 outline-0 pb-0 pe-0 ps-0 rounded-0 position-relative d-flex align-items-center"
                                    ...
                                    <div class="d-flex justify-content-between align-items-center w-100 flex-wrap">
                                        <div class=" flex-1 d-flex align-items-center chat-type-text__write ms-0">
                                            <a href="#">
                                                <img class="svg" src="{{ asset('assets/img/svg/smile.svg') }}"
                                                     alt="smile"></a>
                                            <input class="form-control border-0 bg-transparent box-shadow-none"
                                                   placeholder="Type your message...">
                                        </div>
