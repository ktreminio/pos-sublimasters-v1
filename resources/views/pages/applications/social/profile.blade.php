                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active"
                                        aria-current="page">{{ trans('menu.social-profile') }}</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                                ...
                                <div class="account-profile">
                                    ...
                                    <div class="ap-button button-group d-flex justify-content-center flex-wrap">
                                        <button type="button"
                                            ...
                                            <img class="svg" src="{{ asset('assets/img/svg/mail.svg') }}" alt="mail">message
                                        </button>
                                                ...
                                                <div class="card-body p-0 px-25">
                                                    <div class="d-flex flex-column">
                                                        <div class="border-0  flex-1 position-relative">
                                                            <div class="pt-20 outline-0 pb-2 pe-0 ps-0 rounded-0 position-relative border-bottom"
                                                                ...
                                                                <span class="ap-profile-image bg-opacity-secondary rounded-circle d-block position-absolute"
                                                                      style="background-image:url({{ asset('assets/img/ap-author.png') }}); background-size: cover;"></span>
                                                        ...
                                                        <div class="ap-post-attach d-flex flex-row align-items-center flex-wrap flex-shrink-0">
                                                            ...
                                                            <button class="btn btn-primary btn-default btn-squared ms-auto ap-post-attach__btn">
                                                                public post
                                                            </button>
                                                    ...
                                                    <div class="d-flex flex-row pb-20 border-top-0 border-left-0 border-right-0 ap-post-content__title align-items-center ">
                                                        <div class="d-inline-block align-middle me-15">
                                                            <span class="profile-image bg-opacity-secondary rounded-circle d-block avatar avatar-md m-0"
                                                                  style="background-image:url('{{ asset('assets/img/author/1.jpg') }}'); background-size: cover;"></span>
                                                        </div>
                                                ...
                                                <div class="card-body border-top border-bottom py-0 ap-main-post__reaction">
                                                    <div class="d-flex align-items-center demo-h-spacing ap-post-content__feedback">
                                                        <a href="#" class="d-inline-flex align-items-center">
                                                            <img class="svg"
                                                                 src="{{ asset('assets/img/svg/thumbs-up.svg') }}"
                                                                 alt="thumbs-up">274
                                                        </a>
                                                        <a href="#" class="d-inline-flex align-items-center">
                                                            <img class="svg"
                                                                 src="{{ asset('assets/img/svg/message-square.svg') }}"
                                                                 alt="message-square">56</a>
                                                        <a href="#" class="d-inline-flex align-items-center">
                                                            <img class="svg"
                                                                 src="{{ asset('assets/img/svg/share-2.svg') }}"
                                                                 alt="share-2"> share
                                                        </a>
                                                    </div>
                                                </div>
                                                            ...
                                                            <div class="d-flex justify-content-between align-items-center w-100">
                                                                <div class=" flex-1 d-flex align-items-center me-10 ap-post-content-comment__write">
                                                                    ...
                                                                    <div class="d-flex">
                                                                        ...
                                                                        <a href="#">
                                                                            <img class="svg"
                                                                                 src="{{ asset('assets/img/svg/paperclip.svg') }}"
                                                                                 alt="paperclip"></a>
                                                                    </div>
                                                                </div>
                                                                <button type="button"
                                                                    ...
                                                                    <img class="svg"
                                                                         src="{{ asset('assets/img/svg/send.svg') }}"
                                                                         alt="send"></button>
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="card mb-25">
                                                ...
                                                <div class="card-body pb-0 px-sm-25 ap-main-post__header">
                                                    <div class="d-flex flex-row pb-20 border-top-0 border-left-0 border-right-0 ap-post-content__title align-items-center ">
                                                        <div class="d-inline-block align-middle me-15">
                                                            <span class=" profile-image bg-opacity-secondary rounded-circle d-block avatar avatar-md m-0"
                                                                  style="background-image:url('{{ asset('assets/img/author/2.jpg') }}'); background-size: cover;"></span>
                                                        </div>
                                                        <h6 class="mb-0 flex-1 text-dark">
                                                            Alexendra Dhadio
                                                            <small class="m-0 d-block">
                                            ...
                                            <div class="card mb-25">
                                                ...
                                                <div class="card-body pb-0 px-sm-25 ap-main-post__header">
                                                    <div class="d-flex flex-row pb-3 border-top-0 border-left-0 border-right-0 ap-post-content__title align-items-center ">
                                                        <div class="d-inline-block align-middle me-15">
                                                            <span class=" profile-image bg-opacity-secondary rounded-circle d-block avatar avatar-md m-0"
                                                                  style="background-image:url('{{ asset('assets/img/author/4.jpg') }}'); background-size: cover;"></span>
                                                        </div>
                                    ...
                                    <div class="col-xxl-4">
                                      ...
                                      UI Designer
                                                        ...
                                                        <div>
                                                            ...
                                                            <button class="btn btn-default btn-squared color-light btn-outline-light friends-follow">
                                                                follow
                                                            </button>
                                      ...
                                      UI director
                                                    ...
                                                    <div class="ffw d-flex justify-content-between">
                                                        <div class="d-flex flex-wrap">
                                                            <div class="me-3 ffw__imgWrapper">
                                                                <span class=" profile-image bg-opacity-secondary rounded-circle d-block ap-profile-image "
                                                                      style="background-image:url('{{ asset('assets/img/author/3.jpg') }}'); background-size: cover;"></span>
                                                            </div>
                                                            <div class="ffw__title">
                                                                <a href="#" class="text-dark fw-500">
                                                                    <h6>Tuhin Molla</h6>
                            ...
                            <div class="ap-post-content">
                                <div class="row">
                                    ...
                                    <span class="ffp__icon color-warning bg-opacity-warning">
                                      <img class="svg" src="{{ asset('assets/img/svg/message-square.svg') }}"
