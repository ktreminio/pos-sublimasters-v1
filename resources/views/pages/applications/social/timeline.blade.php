            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="breadcrumb-main">
                        <h4 class="text-capitalize breadcrumb-title">{{ trans('menu.social-timeline') }}</h4>
                        <div class="breadcrumb-action justify-content-center flex-wrap">
                            <div class="action-btn">
                                <div class="form-group mb-0">
                                    <div class="input-container icon-left position-relative">
                                    <span class="input-icon icon-left">
                                        <img src="{{ asset('assets/img/svg/calendar.svg') }}" alt="calendar"
                                             class="svg">
                                    </span>
                                        ...
                                        <img src="{{ asset('assets/img/svg/chevron-down.svg') }}" alt="chevron-down"
                                             class="svg">
                                    </span>
                                    </div>
                                </div>
                            ...
                            <div class="dropdown action-btn">
                                <button class="btn btn-sm btn-default btn-white dropdown-toggle" type="button"
                                        id="dropdownMenu3" data-bs-toggle="dropdown" aria-haspopup="true"
                                        aria-expanded="false">
                                ...
                                <div class="account-profile">
                                    ...
                                    <div class="ap-button button-group d-flex justify-content-center flex-wrap">
                                        <button type="button"
                                            ...
                                            <img src="{{ asset('assets/img/svg/mail.svg') }}" alt="mail" class="svg">message
                                        </button>
                                        <button class="btn btn-primary btn-default btn-squared text-capitalize  px-25">
                                            <img src="{{ asset('assets/img/svg/user-plus.svg') }}" alt="user-plus"
                                                 class="svg">
                                            follow
                                        </button>
                                    </div>
                            ...
                            <div class="user-info border-bottom">
                                ...
                                <div class="card-body pt-md-1 pt-0">
                                    <div class="user-content-info">
                                        ...
                                        <p class="user-content-info__item">
                                            <img src="{{ asset('assets/img/svg/phone.svg') }}" alt="phone" class="svg">+44
                                            (0161) 347
                                            8854
                                        </p>
                    ...
                    <div class="ap-tab ap-tab-header">
                        ...
                        <div class="ap-tab-wrapper">
                            <ul class="nav px-25 ap-tab-main" id="ap-tab" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link" id="ap-overview-tab" data-bs-toggle="pill" href="#ap-overview"
                                       role="tab" aria-controls="ap-overview" aria-selected="false">Overview</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link active" id="timeline-tab" data-bs-toggle="pill" href="#timeline"
                                    ...
                                    <div class="col-lg-12">
                                        <div class="card">
                                            <div class="card-header text-capitalize px-md-25 px-3">
                                                ...
                                                <div class="dropdown">
                                                    <a href="#" role="button" id="statistics1" data-bs-toggle="dropdown"
                                                ...
                                                <div class="card-body p-0 px-25">
                                                    <div class="d-flex flex-column">
                                                        ...
                                                        <div class="ap-post-attach d-flex flex-row align-items-center flex-wrap flex-shrink-0">
                                                            ...
                                                            <button class="btn btn-primary btn-default btn-squared ml-auto ap-post-attach__btn">
                                                                public post
                                                            </button>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="ap-main-post">
                                            <div class="card mb-25">
                                                <div class="card-body pb-0 px-25 ap-main-post__header">
                                                    <div class="d-flex flex-row pb-20 border-top-0 border-left-0 border-right-0 ap-post-content__title align-items-center ">
                                                        ...
                                                        <div class="dropdown  dropdown-click ">
                                                            <button class="btn-link border-0 bg-transparent p-0"
                                                                    ...
                                                                    aria-expanded="false">
                                                                <img class="svg"
                                                                     src="{{ asset('assets/img/svg/more-horizontal.svg') }}"
                                                                     alt="more-horizontal">
                                                            </button>
                                                    ...
                                                    <div class="mb-15">
                                                        <img src="{{ asset('assets/img/post-image.png') }}"
                                                             alt="post image" class="ap-post-attach__headImg w-100">
                                                    </div>
                                                ...
                                                <div class="card-body border-top border-bottom py-0 ap-main-post__reaction">
                                                    <div class="d-flex align-items-center demo-h-spacing ap-post-content__feedback">
                                                        <a href="#" class="d-inline-flex align-items-center">
                                                            <img src="{{ asset('assets/img/svg/thumbs-up.svg') }}"
                                                                 alt="thumbs-up" class="svg">274
                                                        </a>
                                                        <a href="#" class="d-inline-flex align-items-center">
                                                            <img src="{{ asset('assets/img/svg/message-square.svg') }}"
                                                                 alt="message-square" class="svg">56</a>
                                                        <a href="#" class="d-inline-flex align-items-center">
                                                            <img src="{{ asset('assets/img/svg/share-2.svg') }}"
                                                                 alt="share-2" class="svg"> share
                                                        </a>
                                                    </div>
                                                </div>
                                                <div class="card-body px-25 py-20 ap-main-post__footer">
                                                    <div class="ap-post-content-comment">
                                                        <div class="pt-0 outline-0 pb-0 pe-0 ps-0 rounded-0 position-relative d-flex align-items-center"
                                                             tabindex="-1">
                                                            <span class="rounded-circle d-block position-absolute wh-36"
                                                                  style="background-image:url('/img/ap-author.png'); background-size: cover;"></span>
                                                            <div class="d-flex justify-content-between align-items-center w-100">
                                                                <div class=" flex-1 d-flex align-items-center me-10 ap-post-content-comment__write">
                                                                    <input class="form-control border-0 p-0 bg-transparent pe-sm-0 pe-20"
                                                                    ...
                                                                    <div class="d-flex">
                                                                        ...
                                                                        <a href="#">
                                                                            <img src="{{ asset('assets/img/svg/image.svg') }}"
                                                                                 alt="image" class="svg"></a>
                                                                        <a href="#">
                                                                ...
                                                                <button type="button"
                                                                    ...
                                                                    <img src="{{ asset('assets/img/svg/send.svg') }}"
                                                                         alt="send" class="svg"></button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="card mb-25">
                                                ...
                                                <div class="card-body border-top border-bottom py-0 ap-main-post__reaction">
                                                    <div class="d-flex align-items-center demo-h-spacing ap-post-content__feedback">
                                                        <a href="#" class="d-inline-flex align-items-center">
                                                            <img src="{{ asset('assets/img/svg/thumbs-up.svg') }}"
                                                                 alt="thumbs-up" class="svg">
                                                            274
                                                        </a>
                                                        <a href="#" class="d-inline-flex align-items-center">
                                                            <img src="{{ asset('assets/img/svg/message-square.svg') }}"
                                                                 alt="message-square" class="svg">
                                                            56
                                                        </a>
                                                        <a href="#" class="d-inline-flex align-items-center">
                                                            <img src="{{ asset('assets/img/svg/share-2.svg') }}"
                                        ...
                                        <div class="ap-main-post">
                                            <div class="card mb-25">
                                                    ...
                                                    <div class="mb-3 ap-post-gallery">
                                                        <div class="ap-post-gallery-top">
                                                            <div class="ap-post-gallery__item">
                                                                <a href="{{ asset('assets/img/506.png') }}"><img
                                                                            src="{{ asset('assets/img/506.png') }}"
                                                                            alt="gallery" class="w-100 img-fluid"></a>
                                                            </div>
                                                            <div class="ap-post-gallery__item">
                                                                <a href="{{ asset('assets/img/907.png') }}"><img
                                                                            src="{{ asset('assets/img/907.png') }}"
                                                                            alt="gallery" class="w-100 img-fluid"></a>
                                                            </div>
                                                        </div>
                                                        <div class="ap-post-gallery-bottom">
                                                            <div class="ap-post-gallery__item">
                                                                <a href="{{ asset('assets/img/brightland_3744.png') }}"><img
                                                                            src="{{ asset('assets/img/brightland_3744.png') }}"
                                                                            alt="gallery" class="w-100 img-fluid"></a>
                                                            </div>
                                                            <div class="ap-post-gallery__item">
                                                                <a href="{{ asset('assets/img/room.png') }}"><img
                                                                            src="{{ asset('assets/img/room.png') }}"
                                                                            alt="gallery" class="w-100 img-fluid"></a>
                                                            </div>
                                                            <div class="ap-post-gallery__item">
                                                                <a href="{{ asset('assets/img/165.png') }}"
                                                                   class="ap-post-gallery-overlay">
                                                                    <img src="{{ asset('assets/img/165.png') }}"
                                                                         alt="gallery" class="w-100 img-fluid">
                                                ...
                                                <div class="card-body pt-20 ap-main-post__comment">
                                                    ...
                                                    <a class="view-more-comment color-primary fs-13 fw-500" href="#">View
                                                        53
                                                        more
                                                        comments</a>
                                                </div>
                                                    ...
                                                    <div class="ffw d-flex justify-content-between">
                                                        <div class="d-flex flex-wrap">
                                                            <div class="me-3 ffw__imgWrapper">
                                                                <span class=" profile-image bg-opacity-secondary rounded-circle d-block ap-profile-image "
                                                                      style="background-image:url('img/author/4.jpg'); background-size: cover;"></span>
                                                            </div>
                                                        ...
                                                        <div>
                                                            <button class="btn btn-default btn-squared btn-outline-light friends-follow">
                                                                follow
                                                            </button>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="card global-shadow mb-25">
                                            <div class="photo-gallery-widget">
                                                <div class="card-header justify-content-between d-flex flex-wrap px-md-25 px-3">
                                                    <h6>photos</h6>
                                                    <a class="color-primary fs-13 fw-500 mt-lg-0 mt-1" href="#">see
                                                        all</a>
                                                </div>
                                                <div class="card-body">
                                                    <div class="wig">
                                                ...
                                                <div class="card-body">
                                                    <div class="wig">
                                                        <div class="wig__item wig-overlay">
                                                            <img src="{{ asset('assets/img/juice-2.png') }}"
                                                                 alt="gallery">
                                                            <div class="wig-overlay__content">
                                                                <a class="wig-overlay__iconWrapper popup-youtube"
                                                                   href="https://www.youtube.com/watch?v=i9E_Blai8vk">
                                                                    <img class="svg"
                                                                         src="{{ asset('assets/img/svg/play.svg') }}"
                                                                         alt="img">
                                                                </a>
                                                            </div>
                                                        </div>
                                                        <div class="wig__item wig-overlay">
                                                            <img src="{{ asset('assets/img/cup-card.png') }}"
                                                                 alt="gallery">
                                                            <div class="wig-overlay__content">
                                                                <a class="wig-overlay__iconWrapper popup-youtube"
                                                                   href="https://www.youtube.com/watch?v=i9E_Blai8vk">
                                                        ...
                                                        <div class="wig__item wig-overlay">
                                                            <img src="{{ asset('assets/img/round-box.png') }}"
                                                                 alt="gallery">
                                                            <div class="wig-overlay__content">
                                                                <a class="wig-overlay__iconWrapper popup-youtube"
                                                                   href="https://www.youtube.com/watch?v=i9E_Blai8vk">
                                                        ...
                                                        <div class="wig__item wig-overlay">
                                                            <img src="{{ asset('assets/img/glass.png') }}"
                                                                 alt="gallery">
                                                            <div class="wig-overlay__content">
                                                                <a class="wig-overlay__iconWrapper popup-youtube"
                                                                   href="https://www.youtube.com/watch?v=i9E_Blai8vk">
                                                        ...
                                                        <div class="wig__item wig-overlay">
                                                            <img src="{{ asset('assets/img/bottles.png') }}"
                                                                 alt="gallery">
                                                            <div class="wig-overlay__content">
                                                                <a class="wig-overlay__iconWrapper popup-youtube"
                                                                   href="https://www.youtube.com/watch?v=i9E_Blai8vk">
                                                    ...
                                                    <div class="ffp d-flex ffp--hover justify-content-between  align-items-center w-100">
                                                        <div class="d-flex">
                                                            ...
                                                            <span class="ffp__icon color-primary bg-opacity-primary">
                                                                <img src="{{ asset('assets/img/svg/inbox.svg') }}"
                                                                     alt="inbox" class="svg"></span>
                                                                <span class=" profile-image bg-opacity-secondary rounded-circle d-block avatar avatar-md m-0 "
                                                                      style="background-image:url('img/author/4.jpg'); background-size: cover;"></span>
                                                            </div>
                                                            <div class="ffp__title">
                                                                <a href="#" class="text-dark fw-500">
                                                                    <h6>
                                                                        <span class="color-primary">James</span> sent
                                                                        you a
                                                                        message
                                                                    </h6>
                                                                </a>
                                                    ...
                                                    <div class="ffp d-flex ffp--hover justify-content-between  align-items-center w-100">
                                                        <div class="d-flex">
                                                            ...
                                                            <span class="ffp__icon color-success bg-opacity-success">
                                                                <img src="{{ asset('assets/img/svg/log-in.svg') }}"
                                                                     alt="log-in" class="svg"></span>
                                                                <span class=" profile-image bg-opacity-secondary rounded-circle d-block avatar avatar-md m-0 "
                                                                      style="background-image:url('img/author/4.jpg'); background-size: cover;"></span>
                                                            </div>
                                                            <div class="ffp__title">
                                                    ...
                                                    <div class="ffp d-flex ffp--hover justify-content-between  align-items-center w-100">
                                                        <div class="d-flex">
                                                            ...
                                                            <span class="ffp__icon color-info bg-opacity-info">
                                                                <img src="{{ asset('assets/img/svg/at-sign.svg') }}"
                                                                     alt="at-sign" class="svg"></span>
                                                                <span class=" profile-image bg-opacity-secondary rounded-circle d-block avatar avatar-md m-0 "
                                                                      style="background-image:url('img/author/2.jpg'); background-size: cover;"></span>
                                                            </div>
                                                            <div class="ffp__title">
                                                                <a href="#" class="text-dark fw-500">
                                                                    <h6>
                                                                        <span class="color-primary">James </span>Send
                                                                        you a
                                                                        message
                                                                    </h6>
                                                                </a>
                                                    ...
                                                    <div class="ffp d-flex ffp--hover justify-content-between  align-items-center w-100">
                                                        <div class="d-flex align">
                                                            ...
                                                            <span class="ffp__icon color-danger bg-opacity-danger">
                                                                <img src="{{ asset('assets/img/svg/heart.svg') }}"
                                                                     alt="heart" class="svg"></span>
                                                                <span class=" profile-image bg-opacity-secondary rounded-circle d-block avatar avatar-md m-0 "
                                                                      style="background-image:url('img/author/3.jpg'); background-size: cover;"></span>
                                                            </div>
                                                            <div class="ffp__title">
                                                    ...
                                                    <div class="ffp d-flex ffp--hover justify-content-between  align-items-center w-100">
                                                        <div class="d-flex">
                                                            ...
                                                            <span class="ffp__icon color-warning bg-opacity-warning">
                                                                <img src="{{ asset('assets/img/svg/message-square.svg') }}"
                                                                     alt="message-square" class="svg"></span>
                                                                <span class=" profile-image bg-opacity-secondary rounded-circle d-block avatar avatar-md m-0 "
                                                                      style="background-image:url('img/author/4.jpg'); background-size: cover;"></span>
                                                            </div>
                                                            <div class="ffp__title">
                                                    ...
                                                    <div class="ffp d-flex ffp--hover justify-content-between  align-items-center w-100">
                                                        <div class="d-flex">
                                                            ...
                                                            <div class="ffp__title">
                                                                <a href="#" class="text-dark fw-500">
                                                                    <h6>
                                                                        <span class="color-primary">Shreyu Neu</span>
                                                                        sent
                                                                        you a
                                                                        message
                                                                    </h6>
