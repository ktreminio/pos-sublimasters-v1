                                ...
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active"
                                            aria-current="page">{{ trans('menu.task-menu-title') }}</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                                                ...
                                                <ul class="nav  mb-3" id="pills-tab" role="tablist">
                                                    ...
                                                    <li class="nav-item" role="presentation">
                                                        <a class="nav-link" id="pills-deleted-tab" data-bs-toggle="pill"
                                                           href="#pills-deleted" role="tab" aria-selected="false"><img
                                                                    class="svg"
                                                                ...
                                                                <div class="dropdown dropdown-click">
                                                                    ...
                                                                    <div class="dropdown-default dropdown-menu">
                                                                        <a class="dropdown-item" href="#"
                                                                           ...
                                                                           data-bs-target="#taskModal2"><img
                                                                                    src="{{ asset('assets/img/svg/edit.svg') }}"
                                                                                    alt="svg" class="svg"> edit</a>
                    ...
                    <form action="/">
                        <div class="form-group mb-20 mt-20">
                            <input type="text" class="form-control" placeholder="Edit Title"
                                   value="Dashboard design stucture">
                        </div>
                        <div class="form-group mb-15">
                            <textarea class="form-control" placeholder="Add description"></textarea>
                        </div>
