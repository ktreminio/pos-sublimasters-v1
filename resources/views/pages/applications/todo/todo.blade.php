                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active"
                                        aria-current="page">{{ trans('menu.todo-menu-title') }}</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                ...
                <div class="card mb-25">
                    ...
                    <div class="card-body px-0 pt-15 pb-25">
                        ...
                        <div class="add-task-action">
                            <button type="submit" class="btn btn-primary btn-transparent-primary btn-lg"
                                    data-bs-toggle="modal" data-bs-target="#add-todo-modal">
                                <img class="svg" src="{{ asset('assets/img/svg/plus.svg') }}" alt=""> Add New Task
                            </button>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="add-todo-form">
                        <form action="/">
                            <div class="form-group">
                                <input type="text" class="form-control form-control-lg" name="todo-text"
