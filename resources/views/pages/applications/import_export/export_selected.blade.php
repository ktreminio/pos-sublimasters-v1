                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active"
                                        aria-current="page">{{ trans('menu.ie-export-selected') }}</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                        ...
                        <div class="project-top-wrapper d-flex justify-content-between flex-wrap mb-25 mt-n10 px-sm-30 px-20 ">
                            <div class="content-center mt-10">
                                <div class="button-group m-0 mt-xl-0 mt-sm-10 order-button-group ">
                                    <button type="button" class="btn-primary btn radius-md" data-bs-toggle="modal"
                                            data-bs-target="#staticBackdrop5">Export Selected
                                    </button>

                                    <!-- Modal -->
                                    <div class="modal fade fileM-Modal-overlay modal--selected" id="staticBackdrop5"
                                         data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
                                         aria-labelledby="staticBackdrop5Label" aria-hidden="true">
                                        <div class="modal-dialog modal-dialog-centered">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h6 class="modal-title fw-500" id="staticBackdrop5Label">Export
                                                        File</h6>
                                                    <button type="button"
