                            ...
                            <li class="nav-item">
                                <a class="nav-link" id="v-pills-profile-tab" data-bs-toggle="pill"
                                   href="#v-pills-profile" role="tab" aria-selected="false">
                                    <img src="{{ asset('assets/img/svg/briefcase.svg') }}" alt="briefcase" class="svg">work
                                    info</a>
                            </li>
                            <li class="nav-item">
                                            ...
                                            <div class="ap-img pro_img_wrapper">
                                                ...
                                                <label for="file-upload">
                                                    <img class="ap-img__main rounded-circle wh-120 bg-lighter d-flex"
                                                         src="{{ asset('assets/img/author/profile.png') }}"
                                                         alt="profile">
                                        ...
                                        <div class="edit-profile__body">
                                            <form>
                                                ...
                                                <div class="button-group d-flex pt-20 justify-content-md-end justify-content-start">
                                                    ...
                                                    <button class="btn btn-light btn-default btn-squared fw-400 text-capitalize radius-md">
                                                        cancel
                                                    </button>
                                            ...
                                            <form>
                                                <div class=" mb-30">
                                                    ...
                                                    <div class="input-group flex-nowrap">
                                                        ...
                                                        <span class="input-group-text bg-facebook border-facebook text-white wh-44 radius-xs justify-content-center"
                                                              id="addon-wrapping1">
                                                ...
                                                <div class=" mb-30">
                                                    ...
                                                    <div class="input-group flex-nowrap">
                                                        <div class="input-group-prepend">
                                                        <span class="input-group-text bg-twitter border-twitter text-white wh-44 radius-xs justify-content-center"
                                                              id="addon-wrapping2">
                                                ...
                                                <div class=" mb-30">
                                                    ...
                                                    <div class="input-group flex-nowrap">
                                                        <div class="input-group-prepend">
                                                        <span class="input-group-text bg-ruby border-ruby text-white wh-44 radius-xs justify-content-center"
                                                              id="addon-wrapping3">
                                                ...
                                                <div class=" mb-30">
                                                    ...
                                                    <div class="input-group flex-nowrap">
                                                        <div class="input-group-prepend">
                                                        <span class="input-group-text bg-instagram border-instagram text-white wh-44 radius-xs justify-content-center"
                                                              id="addon-wrapping4">
                                                ...
                                                <div class=" mb-30">
                                                    ...
                                                    <div class="input-group flex-nowrap">
                                                        <div class="input-group-prepend">
                                                        <span class="input-group-text bg-dark border-dark  text-white wh-44 radius-xs justify-content-center"
                                                              id="addon-wrapping5">
