        ...
        <div class="user-card2">
            <div class="row">
                <div class="cos-xl-2 col-lg-4 mb-30 col-sm-6">
                    <div class="card profile-card-3">
                        <div class="background-block">
                            <img src="{{ asset('assets/img/cover.png') }}" alt="profile-sample1"
                        ...
                        <div class="card-content mt-n25">
                            <div class="card-content__body mt-n40 pt-0">
                                <div class="profile-thumb-block position-relative d-flex justify-content-center">
                                    <img src="{{ asset('assets/img/author/profile.png') }}" alt="profile-image"
                                ...
                                <div class="ap-button account-profile-cards__button button-group d-flex justify-content-center flex-wrap m-n1">
                                    <button type="button"
                                        ...
                                        <img src="{{ asset('assets/img/svg/message-square.svg') }}" alt="message-square"
                                             class="svg"> chat
                                    </button>
                                    <button type="button"
                ...
                <div class="cos-xl-2 col-lg-4 mb-30 col-sm-6">
                    <div class="card profile-card-3">
                        <div class="background-block">
                            <img src="{{ asset('assets/img/cover2.png') }}" alt="profile-sample1"
                                 class="background bg-opacity-success">
                        </div>
                        <div class="card-content mt-n25">
                            <div class="card-content__body mt-n40 pt-0">
                ...
                <div class="cos-xl-2 col-lg-4 mb-30 col-sm-6">
                    <div class="card profile-card-3">
                        <div class="background-block">
                            <img src="{{ asset('assets/img/cover3.png') }}" alt="profile-sample1"
                                 class="background bg-opacity-success">
                        </div>
                        <div class="card-content mt-n25">
                            <div class="card-content__body mt-n40 pt-0">
                ...
                <div class="cos-xl-2 col-lg-4 mb-30 col-sm-6">
                    <div class="card profile-card-3">
                        <div class="background-block">
                            <img src="{{ asset('assets/img/cover6.png') }}" alt="profile-sample1"
                                 class="background bg-opacity-success">
                        </div>
                        <div class="card-content mt-n25">
                            <div class="card-content__body mt-n40 pt-0">
                ...
                <div class="cos-xl-2 col-lg-4 mb-30 col-sm-6">
                    <div class="card profile-card-3">
                        <div class="background-block">
                            <img src="{{ asset('assets/img/cover5.png') }}" alt="profile-sample1"
                                 class="background bg-opacity-success">
                        </div>
                        <div class="card-content mt-n25">
                            <div class="card-content__body mt-n40 pt-0">
