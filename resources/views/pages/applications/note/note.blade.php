                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active"
                                        aria-current="page">{{ trans('menu.note-menu-title') }}</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                                    ...
                                    <div class="card-body px-15 pt-30">
                                        <div class="px-3">
                                            <a href="#" class="btn btn-primary btn-default btn-rounded btn-block"
                                               data-bs-toggle="modal" data-bs-target="#noteModal"> <img
                                                        src="{{ asset('assets/img/svg/plus.svg') }}" alt="plus"
                                                        class="svg">
                                                Add Note</a>
                                        </div>
                                        <div class="note-types">
                                            <ul class="list-unstyled">
                                                <li><a href="#" class="active"><img class="svg"
                                                                                    ...
                                                                                    alt="edit"> All</a></li>
                                                <li><a href="#"><img src="{{ asset('assets/img/svg/star.svg') }}"
                                                                     alt="star" class="svg"> Favorite</a></li>
                                            </ul>
                                        </div>

                                        <div class="note-labels">
                                            <p><img src="{{ asset('assets/img/svg/tag.svg') }}" alt="tag" class="svg">
                                                Labels</p>
                                            <ul class="list-unstyled">
                                ...
                                <div class="note-grid">
                                    <div class="note-single">
                                        ...
                                        <div class="note-card note-important">
                                            <div class="card border-0">
                                                <div class="card-body">
                                                    <h4 class="note-title">Landing Page Design <span
                                                                class="note-status"></span></h4>
                                                    <p class="note-excerpt">Lorem Ipsum is simply dummy text of the
                                                        printing</p>
                                                    <div class="note-action">
                                                        <div class="note-action__left">
                                                            <a href="#" class=""><img
                                                                        src="{{ asset('assets/img/svg/star.svg') }}"
                                                        ...
                                                        <div class="note-action__right">
                                                            <div class="label-dropdown dropdown dropdown-hover">
                                                                <a class="btn-link" href="#"><img class="svg"
                                    ...
                                    <div class="note-single">
                                        ...
                                        <div class="note-card note-social">
                                            <div class="card border-0">
                                                <div class="card-body">
                                                    <h4 class="note-title">Socail Human Being <span
                                                                class="note-status"></span></h4>
                                                    <p class="note-excerpt">Lorem Ipsum is simply dummy text of the
                                                        printing</p>
                                                    <div class="note-action">
                                    ...
                                    <div class="note-single">
                                        ...
                                        <div class="note-card note-personal">
                                            <div class="card border-0">
                                                <div class="card-body">
                                                    <h4 class="note-title">Landing Page Development <span
                                                                class="note-status"></span></h4>
                                                    <p class="note-excerpt">Lorem Ipsum is simply dummy text of the
                                                        printing</p>
                                                    <div class="note-action">
                                    ...
                                    <div class="note-single">
                                        ...
                                        <div class="note-card note-default">
                                            <div class="card border-0">
                                                <div class="card-body">
                                                    <h4 class="note-title">Shop Page Design <span
                                                                class="note-status"></span></h4>
                                                    <p class="note-excerpt">Lorem Ipsum is simply dummy text of the
                                                        printing</p>
                                                    <div class="note-action">
                                    ...
                                    <div class="note-single">
                                        ...
                                        <div class="note-card note-work">
                                            <div class="card border-0">
                                                <div class="card-body">
                                                    <h4 class="note-title">Plugin Development <span
                                                                class="note-status"></span></h4>
                                                    <p class="note-excerpt">Lorem Ipsum is simply dummy text of the
                                                        printing</p>
                                                    <div class="note-action">
                                    ...
                                    <div class="note-single">
                                        ...
                                        <div class="note-card note-default">
                                            <div class="card border-0">
                                                <div class="card-body">
                                                    <h4 class="note-title">Theme Development <span
                                                                class="note-status"></span></h4>
                                                    <p class="note-excerpt">Lorem Ipsum is simply dummy text of the
                                                        printing</p>
                                                    <div class="note-action">
                                    ...
                                    <div class="note-single">
                                        ...
                                        <div class="note-card note-important">
                                            <div class="card border-0">
                                                <div class="card-body">
                                                    <h4 class="note-title">Improve Writing Skill <span
                                                                class="note-status"></span></h4>
                                                    <p class="note-excerpt">Lorem Ipsum is simply dummy text of the
                                                        printing</p>
                                                    <div class="note-action">
                                    ...
                                    <div class="note-single">
                                        ...
                                        <div class="note-card note-social">
                                            <div class="card border-0">
                                                <div class="card-body">
                                                    <h4 class="note-title">Keep Social Distance <span
                                                                class="note-status"></span></h4>
                                                    <p class="note-excerpt">Lorem Ipsum is simply dummy text of the
                                                        printing</p>
                                                    <div class="note-action">
