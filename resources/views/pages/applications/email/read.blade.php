                                ...
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="#"><i
                                                        class="las la-home"></i>{{ trans('menu.email-menu-title') }}</a>
                                        </li>
                                        <li class="breadcrumb-item active"
                                            aria-current="page">{{ trans('page_title.read_email') }}</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                                    ...
                                    <div class="card-body">
                                        <div class="d-flex align-content-center content-center px-15">
                                            <a href="#" class="btn-compose btn btn-md btn-primary btn-shadow-primary"
                                               data-trigger="compose"> <img src="{{ asset('assets/img/svg/plus.svg') }}"
                                                                            alt="plus" class="svg"> Compose</a>
                                        </div>
                                        <ul class="mail-list">
                                            <li><a class="active" href="#"><img
                                                            src="{{ asset('assets/img/svg/inbox.svg') }}" alt="inbox"
                                                            class="svg">Inbox <span
                                                            class="badge badge-primary badge-transparent">5</span></a>
                                            </li>
                                            <li><a href="#"><img src="{{ asset('assets/img/svg/star.svg') }}" alt="star"
                                                                 class="svg">Started</a></li>
                                            <li><a href="#"><img src="{{ asset('assets/img/svg/send.svg') }}" alt="send"
                                                                 class="svg">Send</a></li>
                                            <li><a href="#"><i class="uil uil-edit"></i>Draft <span
                                                            class="badge badge-primary badge-transparent">12</span></a>
                                            </li>
                                            <li><a href="#"><img src="{{ asset('assets/img/svg/alert-octagon.svg') }}"
                                                                 alt="alert-octagon" class="svg">Spam</a></li>
                                            <li><a href="#"><img src="{{ asset('assets/img/svg/trash-2.svg') }}"
                                                                 alt="trash-2" class="svg">Trash</a></li>
                                        </ul>
                                        <span class="mail-list-title mt-35">Lable</span>
                                        <ul class="mail-list mt-0">
                                            <li><a href="#"><img src="{{ asset('assets/img/svg/list.svg') }}" alt="list"
                                                                 class="svg">Personal</a></li>
                                            <li><a href="#"><img src="{{ asset('assets/img/svg/list.svg') }}" alt="list"
                                                                 class="svg">Social</a></li>
                                            <li><a href="#"><img src="{{ asset('assets/img/svg/list.svg') }}" alt="list"
                                                                 class="svg">Promotion</a></li>
                                        </ul>
                                        <div class="btn-add-label" data-trigger="label">
                                            <span class="cursor-true"><img src="{{ asset('assets/img/svg/plus.svg') }}"
                                                                           alt="plus" class="svg">Add New Label</span>
                                            <div class="add-lebel-from">
                                                <form action="#">
                                                    ...
                                                    <div class="label-action d-flex button-group">
                                                        <button class="btn btn-primary btn-sm btn-squared">Add Label
                                                        </button>
                                                        <button class="btn btn-white btn-sm btn-squared label-close"
                                                                data-trigger="label">Cancel
                                                        </button>
                                                    </div>
                                                </form>
                                            </div>
                                        ...
                                        <div class="mailbox-top d-flex justify-content-between align-items-center">
                                            <div class="mailbox-top__left">
                                                <ul class="mailbox-top__actions d-flex align-items-center">
                                                    ...
                                                    <li>
                                                        <a class="icon-action active" href="" data-bs-toggle="tooltip"
                                                           data-bs-placement="bottom" title="Archive">
                                                            <img src="{{ asset('assets/img/svg/archive.svg') }}"
                                                                 alt="archive" class="svg"></a>
                                                    </li>
                                                    <li>
                                                        <a class="icon-action" href="" data-bs-toggle="tooltip"
                                                           data-bs-placement="bottom" title="Info">
                                                            <img src="{{ asset('assets/img/svg/alert-octagon.svg') }}"
                                                                 alt="alert-octagon" class="svg  nav-icon">
                                                        </a>
                                                    </li>
                                                    <li>
                                                        <a class="icon-action" href="" data-bs-toggle="tooltip"
                                                           data-bs-placement="bottom" title="Delete">
                                                            <img src="{{ asset('assets/img/svg/trash-2.svg') }}"
                                                                 alt="trash-2" class="svg nav-icon"></a>
                                                    </li>
                                                    <li>
                                                        <a class="icon-action" href="" data-bs-toggle="tooltip"
                                                           data-bs-placement="bottom" title="Read">
                                                            <img src="{{ asset('assets/img/svg/book-open.svg') }}"
                                                                 alt="book-open" class="svg nav-icon">
                                                        </a>
                                                    </li>
                                                    <li>
                                                        <a class="icon-action" href="" data-bs-toggle="tooltip"
                                                           data-bs-placement="bottom" title="Folder">
                                                            <img src="{{ asset('assets/img/svg/folder.svg') }}"
                                                                 alt="folder" class="svg nav-icon">
                                                        </a>
                                                    </li>
                                                </ul>
                                            </div>
                                            <div class="mailbox-top__right d-flex align-items-center">
                                                <div class="mailbox-top__extra d-flex align-items-center">
                                                    ...
                                                    <a class="icon-action" href="#">
                                                        <img src="{{ asset('assets/img/svg/sliders.svg') }}"
                                                             alt="sliders" class="svg"></a>
                                                    <div class="dropdown">
                                                        <a href="#" class="ellipsis-more" role="button"
                                                           id="ellipsis-more" data-bs-toggle="dropdown"
                                                           aria-haspopup="true" aria-expanded="true">
                                                            <img src="{{ asset('assets/img/svg/more-vertical.svg') }}"
                                                                 alt="more-vertical" class="svg">
                                                        </a>
                                        ...
                                        <div class="mail-read-content">
                                                    ...
                                                    <div class="mail-details__action d-flex">
                                                        <a href="#" class="icon-action">
                                                            <div class="double-icon d-flex flex-column">
                                                                <img src="{{ asset('assets/img/svg/chevron-up.svg') }}"
                                                                     alt="chevron-up" class="svg">
                                                                <img src="{{ asset('assets/img/svg/chevron-down.svg') }}"
                                                                     alt="chevron-down" class="svg">
                                                            </div>
                                                        </a>
                                                        <a href="#" class="icon-action">
                                                            <img src="{{ asset('assets/img/svg/printer.svg') }}"
                                                                 alt="printer" class="svg">
                                                        </a>
                                                    </div>
                                                </div>
                                                <div class="mail-details__content mdc media">
                                                    <div class="mdc__left">
                                                        <img src="{{ asset('assets/img/author/3.jpg') }}"
                                                             alt="mail author">
                                                    </div>
                                                    <div class="mdc__right media-body">
                                                        <div class="mdc__head d-flex justify-content-between">
                                                            ...
                                                            <div class="mdc__excerpt">
                                                                <img src="{{ asset('assets/img/svg/paperclip.svg') }}"
                                                                     alt="paperclip" class="svg">
                                                                <span class="date-meta">Jan 2, 2020, 5:22 PM</span>
                                                                <a href="#">
                                                                    <img src="{{ asset('assets/img/svg/star.svg') }}"
                                                                         alt="star" class="svg"></a>
                                                                <a href="#">
                                                                    <img src="{{ asset('assets/img/svg/corner-up-left.svg') }}"
                                                                         alt="corner-up-left" class="svg"></a>
                                                                <a href="#" class="dropdownMenu">
                                                                    <img src="{{ asset('assets/img/svg/more-vertical.svg') }}"
                                                                         alt="more-vertical" class="svg"></a>
                                                            </div>
                                                        </div>
                                                        <div class="mdc__body">
                                                            <h6>Hello Adam,</h6>
                                                        ...
                                                        <div class="mdc__footer">
                                                            <div class="mail-attatched d-flex">
                                                                <div class="mail-attatched__item">
                                                                    <figure class="mb-0">
                                                                        <div class="mail-attatched__image mb-3">
                                                                            <img src="{{ asset('assets/img/mail/1.png') }}"
                                                                                 alt="attatched Image">
                                                                            <div class="mail-attatched__hover">
                                                                                <a href="#" class="btn-mail">
                                                                                    <img src="{{ asset('assets/img/svg/download.svg') }}"
                                                                                         alt="download" class="svg"></a>
                                                                                <a href="#" class="btn-mail">
                                                                                    <img src="{{ asset('assets/img/svg/share-2.svg') }}"
                                                                                         alt="share-2" class="svg">
                                                                                </a>
                                                                            </div>
                                                                        </div>
                                                                        <figcaption>
                                                                ...
                                                                <div class="mail-attatched__item">
                                                                    <figure class="mb-0">
                                                                        <div class="mail-attatched__image mb-3">
                                                                            <img src="{{ asset('assets/img/mail/2.png') }}"
                                                                                 alt="attatched Image">
                                                                            <div class="mail-attatched__hover">
                                                                                <a href="#" class="btn-mail">
                                                                                    <img src="{{ asset('assets/img/svg/download.svg') }}"
                                                                ...
                                                                <div class="mail-attatched__item">
                                                                    <figure class="mb-0">
                                                                        <div class="mail-attatched__image mb-3">
                                                                            <img src="{{ asset('assets/img/mail/3.png') }}"
                                                                                 alt="attatched Image">
                                                                            <div class="mail-attatched__hover">
                                                                                <a href="#" class="btn-mail">
                                                                                    <img src="{{ asset('assets/img/svg/download.svg') }}"
                                                                ...
                                                                <div class="mail-attatched__item">
                                                                    <figure class="mb-0">
                                                                        <div class="mail-attatched__image mb-3">
                                                                            <img src="{{ asset('assets/img/mail/4.png') }}"
                                                                                 alt="attatched Image">
                                                                            <div class="mail-attatched__hover">
                                                                                <a href="#" class="btn-mail">
                                                                                    <img src="{{ asset('assets/img/svg/download.svg') }}"
                                            ...
                                            <div class="mail-reply">
                                                ...
                                                <div class="mail-reply__action d-flex">
                                                    <a href="#" class="btn btn-outline-lighten btn-md"><img
                                                                src="{{ asset('assets/img/svg/corner-up-left.svg') }}"
                                                                alt="corner-up-left" class="svg">Reply</a>
                                                    <a href="#" class="btn btn-outline-lighten btn-md"><img
                                                                src="{{ asset('assets/img/svg/corner-up-right.svg') }}"
                                                                alt="corner-up-right" class="svg">Forword</a>
                                                </div>
                                                <div class="mail-reply-box media">
                                                    <figure>
                                                        <img src="{{ asset('assets/img/reply-1.png') }}"
                                                             alt="Reply Author">
                                                    </figure>
                                                            ...
                                                            <form action="#">
                                                                ...
                                                                <div class="reply-form__action d-flex justify-content-between align-items-center">
                                                                    <div class="reply-form__left d-flex align-items-center">
                                                                        <button class="btn btn-md btn-primary btn-send">
                                                                            Send
                                                                        </button>
                                                                        <a href="#">
                                                                            <img src="{{ asset('assets/img/svg/paperclip.svg') }}"
                                                                                 alt="paperclip" class="svg"></a>
                                                                        <a href="#">
                                                                            <img src="{{ asset('assets/img/svg/smile.svg') }}"
                                                                                 alt="smile" class="svg"></a>
                                                                    </div>
                                            ...
                                            <form action="#">
                                                <div class="dm-mailCompose__header d-flex justify-content-between align-items-center">
                                                    ...
                                                    <div class="dm-mailCompose__action">
                                                        <a href="#">
                                                            <img src="{{ asset('assets/img/svg/maximize-2.svg') }}"
                                                                 alt="maximize-2" class="svg">
                                                        </a>
