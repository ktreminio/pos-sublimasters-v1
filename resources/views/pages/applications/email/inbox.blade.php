                                ...
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active"
                                            aria-current="page">{{ trans('page_title.inbox') }}</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                            ...
                            <div class="dm-mail-sidebar show mb-30">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <ul class="mail-list">
                                            <li><a class="active" href="#"><img class="svg"
                                                                                src="{{ asset('assets/img/svg/inbox.svg') }}"
                                                                                alt="inbox">Inbox <span
                                            ...
                                            <li><a href="#"><img class="svg"
                                                                 ...
                                                                 alt="send">Send</a></li>
                                            <li><a href="#"><img class="svg edit"
                                                                 src="{{ asset('assets/img/svg/edit.svg') }}"
                                                                 alt="edit">Draft<span
                                                ...
                                                <ul class="mailbox-top__actions d-flex align-items-center">
                                                    <li class="mail-selection checkbox-theme-default custom-checkbox">
                                                        ...
                                                        <label for="mail-select">
                                                            <img class="svg nav-icon"
                                                                 src="{{ asset('assets/img/svg/chevron-down.svg') }}"
                                                                 alt="chevron-down">
                                                        </label>
                                                    ...
                                                    <li>
                                                        <a class="icon-action" href="" data-bs-toggle="tooltip"
                                                           data-bs-placement="bottom" title="Archive">
                                                            <img class="svg nav-icon"
                                                                 src="{{ asset('assets/img/svg/archive.svg') }}"
                                                                 alt="archive"></a>
                                                    </li>
                                                    ...
                                                    <li>
                                                        <a class="icon-action" href="" data-bs-toggle="tooltip"
                                                           data-bs-placement="bottom" title="Info">
                                                            <img class="svg nav-icon"
                                                                 src="{{ asset('assets/img/svg/alert-octagon.svg') }}"
                                                                 alt="alert-octagon">
                                                        </a>
                                                    </li>
                                                    <li>
                                                    ...
                                                    <li>
                                                        <a class="icon-action" href="" data-bs-toggle="tooltip"
                                                           data-bs-placement="bottom" title="Read">
                                                            <img class="svg"
                                                                 src="{{ asset('assets/img/svg/book-open.svg') }}"
                                                                 alt="">
                                                        </a>
                                                    </li>
                                                    <li>
                                        ...
                                        <div class="mailbox-list__content">
                                            <div class="mailbox-list__single d-flex justify-content-between ">
                                                <div class="mail-authorBox d-flex">
                                                    ...
                                                    <img src="{{ asset('assets/img/author/e1.png') }}"
                                                         alt="admin author">
                                                ...
                                                <div class="dm-mailCompose__footer d-flex justify-content-between align-items-center">
                                                    ...
                                                    <div class="footer-right">
                                                        <a href="#" class="btn-remove">
                                                            <img class="svg"
                                                                 src="{{ asset('assets/img/svg/trash-2.svg') }}" alt=""></a>
                                                    </div>
                                                </div>
                                            </form>
                                        </div>
