                                ...
                                <div class="card-body">
                                    <div class="dm-button-list d-flex flex-wrap">
                                        ...
                                        <button class="btn btn-primary btn-default btn-squared "><img
                                                    src="{{ asset('assets/img/svg/layers.svg') }}" alt="layers"
                                                    class="svg">
                                            Default
                                        </button>
                                        ...
                                        <button class="btn btn-default btn-squared color-primary btn-outline-primary ">
                                            <img
                                                    src="{{ asset('assets/img/svg/layers.svg') }}" alt="layers"
                                                    class="svg">
                                            Default
                                    ...
                                    <div class="dm-button-block">
                                        ...
                                        <div class="button-inline-list my-n2">
                                            ...
                                            <div class="btn-group dm-button-group btn-group-normal my-2" role="group">
                                                <button type="button"
                                                        class="btn  btn-xs active btn-outline-light">Today
                                                </button>
                                                <button type="button" class="btn  btn-xs btn-outline-light">Week
                                                </button>
                                                <button type="button" class="btn  btn-xs btn-outline-light">Month
                                                </button>
                                                <button type="button" class="btn  btn-xs btn-outline-light">Year
                                                </button>
                                            ...
                                            <div class="btn-group dm-button-group btn-group-normal my-2" role="group">
                                                <button type="button" class="btn  btn-xs btn-outline-light">Cancel
                                                </button>
                                            ...
                                            <div class="btn-group dm-button-group btn-group-solid my-2" role="group">
                                                <button type="button" class="btn  btn-xs btn-outline-light">Left
                                                </button>
                                                <button type="button" class="btn  btn-xs btn-outline-light">Middle
                                                </button>
                                                <button type="button" class="btn  btn-xs btn-outline-light">Right
                                                </button>
                            ...
                            <div class="card card-default card-md mb-4">
                                ...
                                <div class="card-body">
                                    <div class="dm-button-list d-flex flex-wrap">
                                        ...
                                        <button
                                                class="btn btn-default btn-squared color-secondary btn-outline-secondary ">
                                            Secondary
                                        </button>


                                        <button
                                                class="btn btn-default btn-squared color-success btn-outline-success ">
                                            Success
                                        </button>
                                        ...
                                        <button
                                                class="btn btn-default btn-squared color-warning btn-outline-warning ">
                                            Wraning
                                        </button>


                                        <button class="btn btn-default btn-squared color-danger btn-outline-danger ">
                                            Danger
                                        </button>
                                        ...
                                        <button class="btn btn-default btn-squared color-dashed btn-outline-dashed ">
                                            Dashed
                                        </button>
                            ...
                            <div class="card card-default card-md mb-4">
                                ...
                                <div class="card-body">
                                    <div class="dm-button-list d-flex flex-wrap">
                                        ...
                                        <button
                                                class="btn btn-secondary btn-default btn-squared btn-shadow-secondary ">
                                            Secondary
                                        </button>
                            ...
                            <div class="card card-default card-md mb-4">
                                ...
                                <div class="card-body">
                                    <div class="dm-button-list d-flex flex-wrap">
                                        ...
                                        <button
                                                class="btn btn-default btn-rounded color-primary btn-outline-primary ">
                                            Primary
                                        </button>


                                        <button
                                                class="btn btn-default btn-rounded color-secondary btn-outline-secondary ">
                                            Secondary
                                        </button>


                                        <button
                                                class="btn btn-default btn-rounded color-success btn-outline-success ">
                                            Success
                                        </button>
                                        ...
                                        <button
                                                class="btn btn-default btn-rounded color-warning btn-outline-warning ">
                                            Wraning
                                        </button>


                                        <button class="btn btn-default btn-rounded color-danger btn-outline-danger ">
                                            Danger
                                        </button>
                                        ...
                                        <button class="btn btn-default btn-rounded color-dashed btn-outline-dashed ">
                                            Dashed
                                        </button>
                            ...
                            <div class="card card-default card-md mb-4">
                                ...
                                <div class="card-body">
                                    <div class="dm-button-list d-flex flex-wrap">
                                        ...
                                        <button
                                                class="btn btn-primary btn-default btn-rounded btn-transparent-primary ">
                                            <img
                                                    src="{{ asset('assets/img/svg/layers.svg') }}" alt="layers"
                                                    class="svg">
                                            Default
                                        ...
                                        <button class="btn btn-default btn-rounded color-primary btn-outline-primary ">
                                            <img
                                                    src="{{ asset('assets/img/svg/layers.svg') }}" alt="layers"
                                                    class="svg">
                                            Default
                            ...
                            <div class="card card-default card-md mb-4">
                                ...
                                <div class="card-body">
                                    <div class="dm-button-list d-flex flex-wrap align-items-end mb-1">
                                        ...
                                        <button class="btn btn-primary btn-default btn-squared " disabled>
                                            Primary(Disabled)
                                        </button>
                                    ...
                                    <div class="dm-button-list d-flex flex-wrap align-items-end">
                                        ...
                                        <button class="btn btn-default btn-squared color-light btn-outline-light ">
                                            Default
                                        </button>
