                    ...
                    <div class="breadcrumb-main">
                        ...
                        <div class="breadcrumb-action justify-content-center flex-wrap">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="#"><i class="las la-home"></i>UI elements</a>
                                    </li>
                                    <li class="breadcrumb-item active"
                                        aria-current="page">{{ trans('menu.ui-alert') }}</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class=" alert alert-warning  alert-dismissible fade show " role="alert">
                                        ...
                                        <div class="alert-content">
                                            ...
                                            <p>Warning Text Warning Text Warning TextW arning Text Warning Text Warning
                                                TextWarning Text</p>
                        ...
                        <div class="col-12">
                            <div class="card card-default card-md mb-4">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="text-capitalize alert alert-info  alert-dismissible fade show "
                                         role="alert">
