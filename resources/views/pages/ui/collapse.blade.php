                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active"
                                        aria-current="page">{{ trans('menu.ui-collapse') }}</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                            ...
                            <div class="dm-collapse">
                                ...
                                <div class="dm-collapse-item">
                                    <div class="dm-collapse-item__header active">
                                        <a href="#" class="item-link" data-bs-toggle="collapse"
                                           data-bs-target="#collapse-body-1" aria-expanded="true">
                                    ...
                                    <div id="collapse-body-1" class="collapse dm-collapse-item__body show">
                                        <div class="collapse-body-text">
                                            <p>
                                                ...
                                                faithfulness, it can be found as a
                                ...
                                <div class="dm-collapse-item">
                                    <div class="dm-collapse-item__header">
                                        <a href="#" class="item-link" data-bs-toggle="collapse"
                                           data-bs-target="#collapse-body-2" aria-expanded="false">
                                ...
                                <div class="dm-collapse-item">
                                    <div class="dm-collapse-item__header">
                                        <a href="#" class="item-link" data-bs-toggle="collapse"
                                           data-bs-target="#collapse-body-3" aria-expanded="false">
                        ...
                        <div class="card-body">
                            ...
                            <div class="dm-collapse ">
                                ...
                                <div class="dm-collapse-item">
                                    <div class="dm-collapse-item__header">
                                        <a href="#" class="item-link" data-bs-toggle="collapse"
                                           data-bs-target="#collapse-body-n-1" aria-expanded="true">
                                    ...
                                    <div id="collapse-body-n-1" class="collapse dm-collapse-item__body  show">
                                        <div class="callapse-nested-block">
                                            <div class="dm-collapse-item">
                                                <div class="dm-collapse-item__header">
                                                    <a href="#" class="item-link" data-bs-toggle="collapse"
                                                       data-bs-target="#collapse-body-nested-n-1" aria-expanded="true">
                                                        <i class="la la-angle-down"></i>
                                                        <h6>This is panel header 1</h6>
                                                    </a>
                                                </div>
                                                <div id="collapse-body-nested-n-1"
                                                     class="collapse dm-collapse-item__body  show">
                                                    <div class="collapse-body-text">
                                                        <p>
                                                            A dog is a type of domesticated animal. Known for its
                                                            loyalty and faithfulness, it can
                                                            be found as a
                                                            welcome guest in many households across the world.
                                                        </p>
                                                    </div>
                                ...
                                <div class="dm-collapse-item">
                                    <div class="dm-collapse-item__header">
                                        <a href="#" class="item-link" data-bs-toggle="collapse"
                                           data-bs-target="#collapse-body-n-2" aria-expanded="false">
                                            <i class="la la-angle-down"></i>
                                            <h6>This is panel header 1</h6>
                                        </a>
                                    </div>
                                    <div id="collapse-body-n-2" class="collapse dm-collapse-item__body ">
                                        <div class="callapse-nested-block">
                                            <div class="dm-collapse-item">
                                                <div class="dm-collapse-item__header">
                                                    <a href="#" class="item-link" data-bs-toggle="collapse"
                                                       data-bs-target="#collapse-body-nested-n-2" aria-expanded="false">
                                                        <i class="la la-angle-down"></i>
                                                        <h6>This is panel header 1</h6>
                                                    </a>
                                                </div>
                                                <div id="collapse-body-nested-n-2"
                                ...
                                <div class="dm-collapse-item">
                                    <div class="dm-collapse-item__header">
                                        <a href="#" class="item-link" data-bs-toggle="collapse"
                                           data-bs-target="#collapse-body-n-3" aria-expanded="false">
                                            <i class="la la-angle-down"></i>
                                            <h6>This is panel header 1</h6>
                                        </a>
                                    </div>
                                    <div id="collapse-body-n-3" class="collapse dm-collapse-item__body ">
                                        <div class="callapse-nested-block">
                                            <div class="dm-collapse-item">
                                                <div class="dm-collapse-item__header">
                                                    <a href="#" class="item-link" data-bs-toggle="collapse"
                                                       data-bs-target="#collapse-body-nested-n-3" aria-expanded="false">
                                                        <i class="la la-angle-down"></i>
                                                        <h6>This is panel header 1</h6>
                                                    </a>
                                                </div>
                                                <div id="collapse-body-nested-n-3"
                                                     class="collapse dm-collapse-item__body ">
                                                    <div class="collapse-body-text">
                                                        <p>
                                                            A dog is a type of domesticated animal. Known for its
                        ...
                        <div class="card-body">
                            ...
                            <div class="dm-collapse">
                                ...
                                <div class="dm-collapse-item">
                                    <div class="dm-collapse-item__header active">
                                        <a href="#" class="item-link" data-bs-toggle="collapse"
                                           data-bs-target="#collapse-body-h-1" aria-expanded="true">
                                            <h6>This is panel header 1</h6>
                                        </a>
                                    </div>
                                ...
                                <div class="dm-collapse-item">
                                    <div class="dm-collapse-item__header">
                                        <a href="#" class="item-link" data-bs-toggle="collapse"
                                           data-bs-target="#collapse-body-h-2" aria-expanded="true">
                                ...
                                <div class="dm-collapse-item">
                                    <div class="dm-collapse-item__header">
                                        <a href="#" class="item-link" data-bs-toggle="collapse"
                                           data-bs-target="#collapse-body-h-3" aria-expanded="true">
                        ...
                        <div class="card-body">
                            ...
                            <div class="dm-collapse dm-accordion">
                                ...
                                <div class="dm-collapse-item">
                                    <div class="dm-collapse-item__header">
                                        <a href="#" class="item-link" data-bs-toggle="collapse"
                                           data-bs-target="#collapse-body-a-1" aria-expanded="false">
                        ...
                        <div class="card-body">
                            ...
                            <div class="dm-collapse dm-collapse-borderless">
                                ...
                                <div class="dm-collapse-item">
                                    <div class="dm-collapse-item__header active">
                                        <a href="#" class="item-link" data-bs-toggle="collapse"
                                           data-bs-target="#collapse-body-b-1" aria-expanded="true">
                                ...
                                <div class="dm-collapse-item">
                                    <div class="dm-collapse-item__header">
                                        <a href="#" class="item-link" data-bs-toggle="collapse"
                                           data-bs-target="#collapse-body-b-2" aria-expanded="false">
                                ...
                                <div class="dm-collapse-item">
                                    <div class="dm-collapse-item__header">
                                        <a href="#" class="item-link" data-bs-toggle="collapse"
                                           data-bs-target="#collapse-body-b-3" aria-expanded="false">
