                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active"
                                        aria-current="page">{{ trans('menu.ui-comment') }}</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                            ...
                            <div class="dm-comment-box media">
                                ...
                                <div class="dm-comment-box__content media-body">
                                    <div class="comment-content-inner cci">
                                        ...
                                        <p class="cci__comment-text">We supply a series of design principles, practical
                                            patterns and high quality
                                            design resources (Sketch and Axure), to help people create their product
                                            prototypes beautifully and
                                            efficiently.</p>
                                        <div class="cci__comment-actions">
                                            <a href="#" class="btn-like">
                                                <img src="{{ asset('assets/img/svg/thumbs-up.svg') }}" alt="thumbs-up"
                                                     class="svg">
                                                <span class="line-count">0</span>
                                            </a>
                                            <a href="#" class="btn-dislike">
                                                <img src="{{ asset('assets/img/svg/thumbs-down.svg') }}"
                                                     alt="thumbs-down" class="svg">
                                                <span class="line-count">0</span>
                                            </a>
                                    ...
                                    <li class="mb-20">
                                        <div class="dm-comment-box media">
                                            ...
                                            <div class="dm-comment-box__content media-body">
                                                <div class="comment-content-inner cci">
                                                    <span class="cci__author-info">David</span>
                                                    <p class="cci__comment-text">We supply a series of design
                                                        principles, practical patterns and high quality
                                                        design resources (Sketch and Axure), to help people create their
                                                        product prototypes beautifully and
                                                        efficiently.</p>
                                                    <div class="cci__comment-actions">
                                                        <a href="#" class="btn-like">
                                                ...
                                                <div class="dm-comment-box media">
                                                    ...
                                                    <div class="dm-comment-box__content media-body">
                                                        <div class="comment-content-inner cci">
                                                            ...
                                                            <p class="cci__comment-text">We supply a series of design
                                                                principles, practical patterns and high quality
                                                                design resources (Sketch and Axure), to help people
                                                    ...
                                                    <li class="mb-20 mt-4">
                                                        <div class="dm-comment-box media">
                                                            ...
                                                            <div class="dm-comment-box__content media-body">
                                                                <div class="comment-content-inner cci">
                                                                    <span class="cci__author-info">David</span>
                                                                    <p class="cci__comment-text">We supply a series of
                                                                        design principles, practical patterns and high
                                                                        quality
                                                                        design resources (Sketch and Axure), to help
                        ...
                        <div class="card-body pb-10">
                            <div class="reply-editor media">
                                <div class="reply-editor__author">
                                    <img src="{{ asset('assets/img/author/1.jpg') }}" class="bg-opacity-primary d-flex"
