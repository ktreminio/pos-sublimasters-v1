                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active"
                                        aria-current="page">{{ trans('menu.ui-upload') }}</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                            ...
                            <div class="dm-tag-wrap">
                                <div class="dm-upload">
                                    <div class="dm-upload-avatar">
                                        <img class="avatrSrc" src="{{ asset('assets/img/upload.png') }}"
                                             alt="Avatar Upload">
                                    </div>
                                    <div class="avatar-up">
                                ...
                                <div class="dm-upload">
                                    ...
                                    <div class="dm-upload__file">
                                        <ul>
                                            ...
                                            <li>
                                                <a href="#" class="file-name"><i class="las la-paperclip"></i> <span
                                                            class="name-text">yyy.jpg<span></span></span></a>
                                                <a href="#" class="btn-delete"><i class="la la-trash"></i></a>
                                            </li>
                                        </ul>
                                    </div>
                                ...
                                <div class="dm-upload">
                                    ...
                                    <div class="dm-upload__file">
                                        <ul>
                                            ...
                                            <li class="danger">
                                                <a href="#" class="file-name"><i class="las la-paperclip"></i> <span
                                                            class="name-text">zzz.jpg<span></span></span></a>
                                                <a href="#" class="btn-delete"><i class="la la-trash"></i></a>
                                            </li>
                                        </ul>
                                    </div>
