                        ...
                        <div class="col-md-9 offset-xl-1">
                                ...
                                <div class="card-body pt-0 px-30 pb-35">
                                    <div class="dm-button-list d-flex flex-wrap ">
                                        <div class="text-center">
                                            <button
                                                    class="btn btn-primary btn-default btn-squared radius-xs fs-15 fw-400">
                                                Primary
                                            </button>
                                        ...
                                        <div class="text-center">
                                            <button
                                                    class="btn btn-secondary btn-default btn-squared radius-xs fs-15 fw-400">
                                                Secondary
                                            </button>
                                        ...
                                        <div class="text-center">
                                            <button
                                                    class="btn btn-success btn-default btn-squared radius-xs fs-15 fw-400">
                                                Success
                                            </button>
                                        ...
                                        <div class="text-center">
                                            <button
                                                    class="btn btn-info btn-default btn-squared radius-xs fs-15 fw-400 px-30">
                                                Info
                                            </button>
                                        ...
                                        <div class="text-center">
                                            <button
                                                    class="btn btn-warning btn-default btn-squared radius-xs fs-15 fw-400">
                                                Wraning
                                            </button>
                                        ...
                                        <div class="text-center">
                                            <button
                                                    class="btn btn-danger btn-default btn-squared radius-xs fs-15 fw-400">
                                                Danger
                                            </button>
                                        ...
                                        <div class="text-center">
                                            <button
                                                    class="btn btn-dark btn-default btn-squared radius-xs fs-15 fw-400 px-30">
                                                Dark
                                            </button>
                                        ...
                                        <div class="text-center">
                                            <button
                                                    class="btn btn-gray btn-default btn-squared radius-xs fs-15 fw-400 bg-gray color-white text-capitalize px-30">
                                                gray
                                            </button>
                                        ...
                                        <div class="text-center">
                                            <button
                                                    class="btn btn-light btn-default btn-squared radius-xs fs-15 fw-400 bg-light text-white text-capitalize px-30">
                                                Light
                                            </button>
                                            <span class="fs-14 fw-400 color-dark">#272B41</span>
                                        </div>
                                        <div class="text-center">
                                            <button
                                                    class="btn btn-lighten btn-default btn-squared radius-xs fs-15 fw-400 text-white text-capitalize">
                                                extra
                                                light
                                            </button>
                            ...
                            <div class="card card-md mb-30 shadow1">
                                ...
                                <div class="card-body pt-0 px-30 pb-30">
                                    <div class="dm-button-list d-flex flex-wrap align-items-end mb-45">
                                        <button class="btn btn-primary btn-xs btn-squared btn-shadow-primary">Extra
                                            small
                                        </button>
                                        ...
                                        <button class="btn btn-primary btn-lg btn-squared btn-shadow-primary">Large
                                            Button
                                        </button>
                                    </div>
                                    <div class="dm-button-list d-flex flex-wrap align-items-end mb-45">
                                    ...
                                    <div class="dm-button-list d-flex flex-wrap align-items-end">
                                        <button class="btn btn-primary btn-xs btn-squared btn-transparent-primary ">
                                            Extra
                                            small
                                        </button>
                                        ...
                                        <button class="btn btn-primary btn-lg btn-squared btn-transparent-primary ">
                                            Large
                                            Button
                                        </button>
                                    </div>
                            ...
                            <div class="card card-md mb-30 shadow1">
                                <div class="card-header  border-bottom-0  p-sm-30">
                                    <h5 class="fw-500 ">Typography <small
                                                class="color-secondary fs-16 fw-500">Inter</small>
                                    </h5>
                                </div>
                            ...
                            <div class="card card-md mb-30 shadow1">
                                ...
                                <div class="card-body pt-0 px-30">
                                    ...
                                    <p class="text-normal">Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed
                                        diam
                                ...
                                <div class="card-body pt-0 px-30">
                                    ...
                                    <p class="text-small mb-0">Lorem ipsum dolor sit amet, consetetur sadipscing elitr,
                                        sed
                                        diam
                                        nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam
                                        voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet clita
