                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active"
                                        aria-current="page">{{ trans('menu.ui-badge') }}</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <span class="avatar avatar-light avatar-md avatar-square  ">
                                        ...
                                        <span class="avatar-badge-wrap avatar-badge-icon">
                                            <img src="{{ asset('assets/img/svg/clock.svg') }}" alt="clock"
                                                 class="svg badge-icon badge-icon-danger">
                                        </span>
                                ...
                                <div class="card-body">
                                    ...
                                    <span class="avatar avatar-light avatar-md avatar-square  ">
                                        ...
                                        <div class="btn-group dm-button-group btn-group-normal ms-3">
                                            <button class="btn btn-icon btn-light btn-square btn-outlined btn-inc">
                                                <img class="svg" src="{{ asset('assets/img/svg/plus.svg') }}"
                                                     alt="plus">
                                            </button>
                                            <button class="btn btn-icon btn-light btn-square btn-outlined btn-dec">
                                                <img class="svg" src="{{ asset('assets/img/svg/minus.svg') }}"
                                                     alt="minus">
                                            </button>
                                        </div>
                                    </div>
                                    ...
                                    <span class="avatar avatar-light avatar-md avatar-square  ">
                                        ...
                                        <div class="form-check form-switch form-switch-info form-switch-md">
                                            <input type="checkbox" class="form-check-input" id="switch-dynamic-badge"
                                                   checked>
