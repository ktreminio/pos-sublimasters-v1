                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active"
                                    aria-current="page">{{ trans('menu.ui-timeline2') }}</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                                ...
                                <li class="timeline-inverted">
                                    <div class="timeline-single__buble">
                                        <div class="timeline-single__buble--svg  bg-opacity-secondary">
                                            <img src="{{ asset('assets/img/svg/paper-plane.svg') }} " alt=""
                                                 class="svg">
                                        </div>
                                    </div>
                                ...
                                <li class="timeline-inverted">
                                    <div class="timeline-single__buble">
                                        <div class="timeline-single__buble--svg  bg-opacity-primary">
                                            <img src="{{ asset('assets/img/svg/notification-basic.svg') }} " alt=""
                                                 class="svg">
                                        </div>
                                    </div>
                                    <div class="timeline-single">
                                ...
                                <li class="timeline-inverted">
                                    <div class="timeline-single__buble">
                                        <div class="timeline-single__buble--svg  bg-opacity-danger">
                                            <img src="{{ asset('assets/img/svg/layers-basic.svg') }} " alt=""
                                                 class="svg">
                                        </div>
                                    </div>
                                    <div class="timeline-single">
