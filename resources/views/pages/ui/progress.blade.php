                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active"
                                        aria-current="page">{{ trans('menu.ui-progress') }}</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                    ...
                    <div class="card card-default card-md mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <div class="progress-wrap d-flex align-items-center mb-15">
                                ...
                                <span class="progress-icon"><img src="{{ asset('assets/img/svg/x-circle.svg') }}"
                                                                 alt="x-circle" class="svg color-danger"></span>
                            </div>
                            <div class="progress-wrap d-flex align-items-center mb-15">
                                <div class="progress">
                                ...
                                <img src="{{ asset('assets/img/svg/check-circle.svg') }}" alt="check-circle"
