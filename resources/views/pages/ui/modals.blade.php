...
@section('content')
                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active"
                                        aria-current="page">{{ trans('menu.ui-modal') }}</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                        ...
                        <div class="card-body">
                            <div class="d-flex flex-wrap justify-content-sm-start justify-content-center">
                                <button type="button" class="btn btn-primary btn-sm" data-bs-toggle="modal"
                                        data-bs-target="#modal-basic">Open Modal
                                </button>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card card-default card-md mb-4">
                        ...
                        <div class="card-body">
                            <div class="modal-btn-group d-flex align-items-center justify-content-sm-start justify-content-center">
                                <button type="button" class="btn btn-outline-lighten btn-outline-lighten__height"
                                        data-bs-toggle="modal" data-bs-target="#modal-info-confirmed">Confirm
                                </button>
                                <button type="button" class="btn btn-outline-lighten btn-outline-lighten__height"
                                        data-bs-toggle="modal" data-bs-target="#modal-info-delete">Delete
                                </button>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-6">
                    <div class="card card-default card-md mb-4">
                        ...
                        <div class="card-body">
                            <div class="modal-btn-group d-flex align-items-center flex-wrap justify-content-sm-start justify-content-center">
                                <button type="button" class="btn btn-primary btn-sm" data-bs-toggle="modal"
                                        data-bs-target="#modal-colored-primary">Primary
                                </button>
                                <button type="button" class="btn btn-success btn-sm" data-bs-toggle="modal"
                                        data-bs-target="#modal-colored-success">Success
                                </button>
                                <button type="button" class="btn btn-danger btn-sm" data-bs-toggle="modal"
                                        data-bs-target="#modal-colored-danger">Danger
                                </button>
                                <button type="button" class="btn btn-warning btn-sm" data-bs-toggle="modal"
                                        data-bs-target="#modal-colored-warning">Warning
                                </button>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card card-default card-md mb-4">
                        ...
                        <div class="card-body">
                            <div class="modal-btn-group d-flex align-items-center flex-wrap justify-content-sm-start justify-content-center">
                                <button type="button" class="btn btn-outline-lighten btn-outline-lighten__height"
                                        data-bs-toggle="modal" data-bs-target="#modal-info">Info
                                </button>
                                <button type="button" class="btn btn-outline-lighten btn-outline-lighten__height"
                                        data-bs-toggle="modal" data-bs-target="#modal-info-success">Success
                                </button>
                                <button type="button" class="btn btn-outline-lighten btn-outline-lighten__height"
                                        data-bs-toggle="modal" data-bs-target="#modal-info-error">Error
                                </button>
                                <button type="button" class="btn btn-outline-lighten btn-outline-lighten__height"
                                        data-bs-toggle="modal" data-bs-target="#modal-info-warning">Warning
                                </button>
                            </div>
                        </div>
                    </div>
    ...
    <div class="modal-colored-primary modal fade show" id="modal-colored-primary" tabindex="-1" role="dialog"
         aria-hidden="true">
    ...
    <div class="modal-colored-success modal fade show" id="modal-colored-success" tabindex="-1" role="dialog"
         aria-hidden="true">
    ...
    <div class="modal-colored-danger modal fade show" id="modal-colored-danger" tabindex="-1" role="dialog"
         aria-hidden="true">
    ...
    <div class="modal-colored-warning modal fade show" id="modal-colored-warning" tabindex="-1" role="dialog"
         aria-hidden="true">
    ...
    <div class="modal-info-warning modal fade show" id="modal-info-warning" tabindex="-1" role="dialog"
         aria-hidden="true">
        ...
        <div class="modal-dialog modal-sm modal-info" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-light btn-outlined btn-sm" data-bs-dismiss="modal">Cancel
                    </button>
        ...
        <div class="modal-dialog modal-sm modal-info" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-success btn-outlined btn-sm" data-bs-dismiss="modal">Yes
                    </button>
