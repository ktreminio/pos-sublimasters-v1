                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active"
                                        aria-current="page">{{ trans('menu.ui-menu') }}</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                                ...
                                <ul class="dm-menu menu-top menu-horizontal ">
                                    <li class="dm-menu__item has-submenu">
                                        <a class="dm-menu__link active" href="#">
                                            <span class="dm-menu__icon"><img
                                                        src="{{ asset('assets/img/svg/mail.svg') }}" alt="mail"
                                                        class="svg"></span>
                                    ...
                                    <li class="dm-menu__item has-submenu">
                                        <a class="dm-menu__link" href="#">
                                            <span class="dm-menu__icon"><img
                                                        src="{{ asset('assets/img/svg/settings.svg') }}" alt="settings"
                                                        class="svg"></span>
