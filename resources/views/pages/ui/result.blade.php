                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active"
                                        aria-current="page">{{ trans('menu.ui-result') }}</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                                ...
                                <div class="dm-notice__content">
                                    <div class="dm-notice__top text-center">
                                        ...
                                        <div class="dm-notice__text">
                                            ...
                                            <p>Order number: 2017182818828182881 Cloud server configuration takes 1-5
                                                minutes, please wait.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="dm-notice__content">
                                    <div class="dm-notice__top text-center">
                                        ...
                                        <div class="dm-notice__text">
                                            ...
                                            <p>Please check and modify the following information before
                                                resubmitting.</p>
                                        </div>
                                    </div>
                                    <div class="notice-listBlock bg-normal mt-30">
                                        ...
                                        <ul class="notice-list">
                                            <li>
                                                <img src="{{ asset('assets/img/svg/x-circle.svg') }}" alt="x-circle"
                                                     class="svg color-danger">
                                                <span class="notice-list__text">Your account has been frozen <a
                                                            href="#">Thaw immediately ></a></span>
                                            </li>
                                            <li>
                                                <img src="{{ asset('assets/img/svg/x-circle.svg') }}" alt="x-circle"
                                                     class="svg color-danger">
                                                <span class="notice-list__text">Your account is not yet eligible to apply<a
                                                            href="#">Apply Unlock ></a></span>
                                            </li>
                                        </ul>
                                    </div>
                                    <div class="dm-notice__action d-flex justify-content-center">
