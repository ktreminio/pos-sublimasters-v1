                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active"
                                        aria-current="page">{{ trans('menu.ui-drawer') }}</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                    ...
                    <div class="card card-default card-md mb-4">
                        ...
                        <div class="card-body">
                            <div class="drawer-btn">
                                <button class="btn btn-primary btn-default btn-squared drawer-trigger"
                                        data-drawer="basic">Open
                                </button>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-6">
                            ...
                            <div class="drawer-placement-wrap d-flex align-items-center">
                                <div class="radio-horizontal-list radio-horizontal-list2 d-flex">
                                    <div class="radio-theme-default custom-radio ">
                                        <input class="radio" type="radio" name="radio-placement" value=top
                                               id="radio-pd1">
                                        <label for="radio-pd1">
                                    ...
                                    <div class="radio-theme-default custom-radio ">
                                        <input class="radio" type="radio" name="radio-placement" value=right
                                               id="radio-pd2">
                                        <label for="radio-pd2">
                                    ...
                                    <div class="radio-theme-default custom-radio ">
                                        <input class="radio" type="radio" name="radio-placement" value=bottom
                                               id="radio-pd3">
                                        <label for="radio-pd3">
                                    ...
                                    <div class="radio-theme-default custom-radio ">
                                        <input class="radio" type="radio" name="radio-placement" value=left
                                               id="radio-pd4">
                                        <label for="radio-pd4">
                    ...
                    <div class="card card-default card-md mb-4">
                        ...
                        <div class="card-body">
                            <div class="drawer-btn d-flex justify-content-center">
                                <button class="btn btn-primary btn-default btn-squared drawer-trigger"
                                        data-drawer="account">+ New account
                                </button>
                            </div>
                        </div>
                    </div>
                    <div class="card card-default card-md mb-4">
                        ...
                        <div class="card-body">
                            <div class="drawer-btn d-flex justify-content-center">
                                <button class="btn btn-primary btn-default btn-squared drawer-multiTrigger"
                                        data-drawer="level-one">Open Drawer
                                </button>
                            </div>
                        </div>
                    </div>
                        ...
                        <form action="#">
                            <div class="form-row">
                                <div class="form-group col-lg-6">
                                    ...
                                    <input type="text" name="name" id="username" class="form-control form-control-sm"
                                           placeholder="Please Enter Your Name">
                                </div>
                                <div class="form-group col-lg-6">
                                    <label for="url">Url</label>
                                    <input type="url" name="name" id="url" class="form-control form-control-sm"
                                ...
                                <div class="form-group col-lg-6">
                                    ...
                                    <input type="text" name="name" id="datepicker" class="form-control form-control-sm"
                                           placeholder="Please Enter URL">
                                </div>
                                <div class="form-group col-12">
                                    <label for="description">Discription</label>
                                    <textarea name="description" id="description" class="form-control form-control-sm"
                                              placeholder="PLease Enter Url Description"></textarea>
                                </div>
                            </div>
                        </form>
                    </div>
    ...
    <div class="drawer-multiLevel">
        <div class="dm-drawer drawer-level-one">
            ...
            <div class="dm-drawer__body">
                <div class="drawer-content">
                    <p>Some Content</p>
                    <button class="btn btn-primary btn-default btn-squared drawer-multiTrigger" data-drawer="level-two">
                        Two Lavel Drawer
                    </button>
                </div>
            </div>
