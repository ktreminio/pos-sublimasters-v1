                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active"
                                    aria-current="page">{{ trans('menu.search-menu-title') }}</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                    ...
                    <form action="/" class="d-flex align-items-center justify-content-between">
                        <div class="border-right d-flex align-items-center w-100  ps-25 pe-sm-25 pe-0 py-1">
                            ...
                            <input class="form-control border-0 box-shadow-none" type="search"
                                   placeholder="Type and search" aria-label="Search">
                        </div>
                    ...
                    <ul class="nav m-n1" id="pills-tab" role="tablist">
                        ...
                        <li class="nav-item" role="presentation">
                            <a class="nav-link" id="pills-profile-tab" data-bs-toggle="pill" href="#pills-profile"
                               role="tab" aria-selected="false">Ui design</a>
                        </li>
                        <li class="nav-item" role="presentation">
                            <a class="nav-link" id="pills-contact-tab" data-bs-toggle="pill" href="#pills-contact"
                               role="tab" aria-selected="false">Wireframe Kits</a>
                        </li>
                        <li class="nav-item" role="presentation">
                            <a class="nav-link" id="pills-presentation-tab" data-bs-toggle="pill"
                               href="#pills-presentation" role="tab" aria-selected="false">Presentation</a>
                        </li>
                        <li class="nav-item" role="presentation">
                            <a class="nav-link" id="pills-web-tab" data-bs-toggle="pill" href="#pills-web" role="tab"
                            ...
                            <div class="card  border-0 px-sm-30 px-20">
                                ...
                                <div class="card-body border-bottom border-top px-0 pb-0 pt-25">
                                    <div class="search-content__keyResult">
                                        ...
                                        <div class="mb-30">
                                            <a href="#">
                                                <h6 class="fw-500">How to stop getting emails from lorem <span
                                                            class="color-primary"> Keyword </span></h6>
                                            </a>
                                            <p class="mb-0">Lorem ipsum dolor amet consetetur get up and running with a
                                                world-class
                                                sadipscing elitr, sed diam nonumy eirmod...</p>
                                        ...
                                        <div class="mb-30">
                                            <a href="#">
                                                <h6 class="fw-500">How to installing lorem multi vendor <span
                                                            class="color-primary">
                                ...
                                <div class="card-body border-bottom border-top px-0 pb-0 pt-25">
                                    <div class="search-content__keyResult">
                                        ...
                                        <div class="mb-30">
                                            <a href="#">
                                                <h6 class="fw-500">How to stop getting emails from lorem <span
                                                            class="color-primary"> Ui design </span></h6>
                                            </a>
                                            <p class="mb-0">Lorem ipsum dolor amet consetetur get up and running with a
                                                world-class
                                                sadipscing elitr, sed diam nonumy eirmod...</p>
                                ...
                                <div class="card-body border-bottom border-top px-0 pb-0 pt-25">
                                    <div class="search-content__keyResult">
                                        ...
                                        <div class="mb-30">
                                            ...
                                            <p class="mb-0">Lorem ipsum dolor amet consetetur get up and running with a
                                                world-class sadipscing nonumy eirmod...</p>
                                        </div>
                                        <div class="mb-30">
                                            <a href="#">
                                                <h6 class="fw-500">How to stop getting emails from lorem <span
                                                            class="color-primary"> wireframe Kits </span></h6>
                                            </a>
                                            <p class="mb-0">Lorem ipsum dolor amet consetetur get up and running with a
                                                world-class sadipscing...</p>
                                        </div>
                                        <div class="mb-30">
                                            <a href="#">
                                                <h6 class="fw-500">How to installing lorem multi vendor <span
                                        ...
                                        <div class="mb-30">
                                            ...
                                            <p class="mb-0">Lorem ipsum dolor amet consetetur get up and running with a
                                                world-class sadipscing elitr, sed diam nonumy eirmod...</p>
                                        </div>
                                        <div class="mb-30">
                                            <a href="#">
                                                <h6 class="fw-500">
