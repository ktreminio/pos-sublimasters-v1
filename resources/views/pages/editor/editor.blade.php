                        ...
                        <div class="breadcrumb-main">
                            ...
                            <div class="breadcrumb-action justify-content-center flex-wrap">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="#"><i class="las la-home"></i>Dashboard</a>
                                        </li>
                                        <li class="breadcrumb-item active"
                                            aria-current="page">{{ trans('menu.editor-menu-title') }}</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                                ...
                                <form action="#">
                                    <div class="mailCompose-form-content">
                                        <div class="form-group">
                                            <textarea name="message" id="mail-reply-message2" class="form-control-lg"
                                ...
                                <form action="#">
                                    <div class="mailCompose-form-content">
                                        <div class="form-group positon-relative">
                                            ...
                                            <select name="reply-to" id="reply-to" class="form-control-lg"
                                                    multiple="multiple">
                                        ...
                                        <div class="form-group">
                                            <textarea name="message" id="mail-reply-message" class="form-control-lg"
                                                      placeholder="Type your message..."></textarea>
                                        </div>
                                    </div>
                                ...
                                <form action="#">
                                    <div class="dm-mailCompose__header d-flex justify-content-between align-items-center">
                                        ...
                                        <div class="dm-mailCompose__action">
                                            <a href="#">
                                                <img src="{{ asset('assets/img/svg/maximize-2.svg') }}" alt="maximize-2"
                                                     class="svg">
                                            </a>
                                    ...
                                    <div class="dm-mailCompose__body">
                                        <div class="mailCompose-form-content">
                                            ...
                                            <div class="form-group">
                                                <textarea name="message" id="mail-message" class="form-control-lg"
                                                          placeholder="Type your message..."></textarea>
                                            </div>
                                        </div>
                                    </div>
