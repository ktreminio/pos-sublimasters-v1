                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="#"><i
                                                    class="las la-home"></i>{{ trans('menu.dashboard-menu-title') }}</a>
                                    </li>
                                    <li class="breadcrumb-item"><a href="#">Page</a></li>
                                    <li class="breadcrumb-item active"
                                        aria-current="page">{{ trans('menu.course-detail') }}</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6">
                        <div class="course-details-about">
                            <div class="course-details-about__content">
                                ...
                                <p class="main-title-sub mb-30">User interface design or user interface engineering is
                                    the
                                ...
                                <p class="main-title-sub mb-40">User interface design or user interface engineering is
                                    the
                                    design of user interfaces for
                                    machines and software, such as computers, home appliances, mobile devices, and other
                                    ...
                                    <div class="course-collapse course-accordion accordion" id="accordionExample">
                                        ...
                                        <div class="border-0 dm-collapse dm-accordion">
                                            ...
                                            <div class="dm-collapse-item">
                                                <div class="border-bottom-0 mb-0 dm-collapse-item__header">
                                                    <a href="#" class="item-link" data-bs-toggle="collapse"
                                                       data-bs-target="#collapse-body-a-6" aria-expanded="false">
                                                        <div class="dm-collapse-title">
                                            ...
                                            <div class="dm-collapse-item">
                                                <div class="border-bottom-0 mb-0 dm-collapse-item__header">
                                                    <a href="#" class="item-link" data-bs-toggle="collapse"
                                                       data-bs-target="#collapse-body-a-7" aria-expanded="false">
                                                        <div class="dm-collapse-title">
                                            ...
                                            <div class="dm-collapse-item">
                                                <div class="border-bottom-0 mb-0 dm-collapse-item__header">
                                                    <a href="#" class="item-link" data-bs-toggle="collapse"
                                                       data-bs-target="#collapse-body-a-8" aria-expanded="false">
                                                        <div class="dm-collapse-title">
                                            ...
                                            <div class="dm-collapse-item">
                                                <div class="border-bottom-0 mb-0 dm-collapse-item__header">
                                                    <a href="#" class="item-link" data-bs-toggle="collapse"
                                                       data-bs-target="#collapse-body-a-9" aria-expanded="false">
                                                        <div class="dm-collapse-title">
                                ...
                                <div class="course-details-collapse">
                                    <div class="course-collapse course-collapse__icon-right-fixed course-accordion accordion"
                                        ...
                                        <div class="border-0 dm-collapse dm-accordion">
                                            ...
                                            <div class="dm-collapse-item">
                                                <div class="border-bottom-0 mb-0 dm-collapse-item__header active">
                                                    <a href="#" class="item-link" data-bs-toggle="collapse"
                                                       data-bs-target="#collapse-body-f-1" aria-expanded="true">
                                                        <div class="dm-collapse-title">
                                            ...
                                            <div class="dm-collapse-item">
                                                <div class="border-bottom-0 mb-0 dm-collapse-item__header">
                                                    <a href="#" class="item-link" data-bs-toggle="collapse"
                                                       data-bs-target="#collapse-body-f-2" aria-expanded="false">
                                                        <div class="dm-collapse-title">
                                            ...
                                            <div class="dm-collapse-item">
                                                <div class="border-bottom-0 mb-0 dm-collapse-item__header">
                                                    <a href="#" class="item-link" data-bs-toggle="collapse"
                                                       data-bs-target="#collapse-body-f-3" aria-expanded="false">
                                                        <div class="dm-collapse-title">
                                            ...
                                            <div class="dm-collapse-item">
                                                <div class="border-bottom-0 mb-0 dm-collapse-item__header">
                                                    <a href="#" class="item-link" data-bs-toggle="collapse"
                                                       data-bs-target="#collapse-body-f-4" aria-expanded="false">
                                                        <div class="dm-collapse-title">
                                            ...
                                            <div class="dm-collapse-item">
                                                <div class="border-bottom-0 mb-0 dm-collapse-item__header">
                                                    <a href="#" class="item-link" data-bs-toggle="collapse"
                                                       data-bs-target="#collapse-body-f-5" aria-expanded="false">
                                                        <div class="dm-collapse-title">
                                            ...
                                            <div class="dm-collapse-item">
                                                <div class="border-bottom-0 mb-0 dm-collapse-item__header">
                                                    <a href="#" class="item-link" data-bs-toggle="collapse"
                                                       data-bs-target="#collapse-body-f-6" aria-expanded="false">
                                                        <div class="dm-collapse-title">
                                                            <h6>How long does it take to download updates?</h6>
                                                        </div>
                                                        <div class="course-collapse-right">
                                            ...
                                            <div class="dm-collapse-item">
                                                <div class="border-bottom-0 mb-0 dm-collapse-item__header">
                                                    <a href="#" class="item-link" data-bs-toggle="collapse"
                                                       data-bs-target="#collapse-body-f-7" aria-expanded="false">
                                                        <div class="dm-collapse-title">
                                            ...
                                            <div class="dm-collapse-item">
                                                <div class="border-bottom-0 mb-0 dm-collapse-item__header">
                                                    <a href="#" class="item-link" data-bs-toggle="collapse"
                                                       data-bs-target="#collapse-body-f-8" aria-expanded="false">
                                                        <div class="dm-collapse-title">
                                                            <h6>How long does it take to download updates?</h6>
                                                        </div>
                                                        <div class="course-collapse-right">
                        ...
                        <div class="cvg">
                            <div class="cvg__item cvg-overlay">
                                ...
                                <div class="cvg__item-content">
                                    <a class="cvg__iconWrapper popup-youtube"
                                       href="https://www.youtube.com/watch?v=i9E_Blai8vk">
