                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active"
                                    aria-current="page">{{ trans('menu.pricing-menu-title') }}</li>
                            </ol>
                        </nav>
                    </div>
                </div>
            ...
            <div class="col-xxl-3 col-lg-4 col-sm-6 mb-30">
                <div class="card h-100">
                    ...
                    <div class="price_action d-flex pb-30 ps-30">
                        <button class="btn btn-default btn-squared btn-outline-light text-capitalize px-30 color-gray fw-500">
                            Current Plan
                        </button>
                    </div>
                </div>
                        ...
                        <div class="row justify-content-center">
                            ...
                            <div class="col-xxl-3 col-lg-4 col-sm-6 mb-30">
                                <div class="card h-100">
                                    ...
                                    <div class="price_action d-flex pb-30 ps-30">
                                        <button class="btn btn-secondary btn-default btn-squared text-capitalize px-30">
                                            Get Started
                                        </button>
                                    </div>
                                </div>
