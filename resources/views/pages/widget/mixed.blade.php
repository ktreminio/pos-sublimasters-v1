                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active"
                                    aria-current="page">{{ trans('menu.widget-mixed') }}</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                    ...
                    <div class="card order-summery  bg-normal p-sm-25 p-15">
                        ...
                        <div class="card-body bg-white">
                            ...
                            <div class="select-cupon position-relative">
                                <span class="percent"><img src="{{ asset('assets/img/svg/coupon.svg') }}" alt="svg"
                                                           class="svg"></span>
                    ...
                    <div class="card-header">
                        ...
                        <div class="card-extra">
                            <ul class="card-tab-links nav-tabs nav">
                                <li>
                                    <a href="#sb_location-today" class="active" data-bs-toggle="tab"
                                       id="sb_location-today-tab" role="tab" area-controls="sb_location-table"
                                       aria-selected="true">Today</a>
                                </li>
                                <li>
                                    <a href="#sb_location-week" data-bs-toggle="tab" id="sb_location-week-tab"
                                       role="tab" area-controls="sb_location-table" aria-selected="false">Week</a>
                                </li>
                                <li>
                                    <a href="#sb_location-month" data-bs-toggle="tab" id="sb_location-month-tab"
                                       role="tab" area-controls="sb_location-table" aria-selected="false">Month</a>
                                </li>
                                <li>
                                    <a href="#sb_location-year" data-bs-toggle="tab" id="sb_location-year-tab"
                                       role="tab" area-controls="sb_location-table" aria-selected="false">Year</a>
                                </li>
                            </ul>
                            <div class="dropdown dropleft">
                                <a href="#" role="button" id="somethings" data-bs-toggle="dropdown" aria-haspopup="true"
                                   aria-expanded="false">
                    ...
                    <div class="card-body">
                        <div class="card-progress">
                            ...
                            <div class="card-progress__bar">
                                ...
                                <div class="progress-excerpt">
                                    <p class="progress-upword"><strong><span class="la la-arrow-up"></span> 25%</strong>
                                        Since Yesterday</p>
                        ...
                        <div class="card-progress">
                            ...
                            <div class="card-progress__bar">
                                ...
                                <div class="progress-excerpt">
                                    <p class="progress-downword"><strong><span class="la la-arrow-down"></span>
                                            25%</strong> Since Yesterday</p>
