                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active"
                                    aria-current="page">{{ trans('menu.widget-chart') }}</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                    ...
                    <div class="card-header">
                        ...
                        <div class="card-extra">
                            <ul class="card-tab-links nav-tabs nav" role="tablist">
                                ...
                                <li>
                                    <a class="active" href="#t_revenue-year" data-bs-toggle="tab"
                    ...
                    <div class="card-header">
                        ...
                        <div class="card-extra">
                            <ul class="card-tab-links nav-tabs nav" role="tablist">
                                ...
                                <li>
                                    <a class="active" href="#tl_revenue-year" data-bs-toggle="tab"
