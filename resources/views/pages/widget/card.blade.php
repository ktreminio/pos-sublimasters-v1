                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active"
                                    aria-current="page">{{ trans('menu.widget-card') }}</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                        ...
                        <div class="feature-cards">
                            <figure class="feature-cards__figure">
                                ...
                                <figcaption>
                                    ...
                                    <p>Lorem Ipsum is simply dummy text of the printer took a galley of type and
                                        scrambled
                                    </p>
                                        ...
                                        <div class="feedbackSection">
                                            <div class="author">
                                                <img class="rounded-circle"
                                                     src="{{ asset('assets/img/blog-author.jpg') }}" alt="">
                                                <span>Burns Marks</span>
                                            </div>
                                            <div class="feedback">
                                            <span class="like"><img src="{{ asset('assets/img/svg/heart.svg') }}"
                                                                    alt="heart" class="svg">
                                                70</span>
                                                <span class="view"><img src="{{ asset('assets/img/svg/eye.svg') }}"
                                                                        alt="eye" class="svg">
                                                120</span>
                                            </div>
                                        </div>
                    ...
                    <div class="col-xxl-3 col-lg-4 col-md-6 mb-25">
                        <figure class="feature-cards2">
                            ...
                            <figcaption>
                                ...
                                <div class="feedbackSection">
                                    <div class="author">
                                        <img class="rounded-circle" src="{{ asset('assets/img/blog-author.jpg') }}"
                                             alt="">
                                        <span>Burns
                                        Marks</span>
                                    </div>
                                ...
                                <div class="account-profile">
                                    <div class="ap-img d-flex justify-content-center">
                                        ...
                                        <img class="ap-img__main rounded-circle mb-20 bg-opacity-primary wh-150"
                                             src="{{ asset('assets/img/tm1.png') }}" alt="profile">
                                    </div>
                                    ...
                                    <ul class="db-social-parent mb-0 justify-content-center">
                                        <li class="db-social-parent__item"><a
                                                    class="color-facebook hover-facebook wh-38 fs-16 rounded-circle"
                                                    href="#"><i class="lab la-facebook-f"></i></a></li>
                                        <li class="db-social-parent__item"><a
                                                    class="color-twitter hover-twitter wh-38 fs-16 rounded-circle"
                                                    href="#"><i class="lab la-twitter"></i></a></li>
                                        <li class="db-social-parent__item"><a
                                                    class="color-ruby hover-ruby  wh-38 fs-16 rounded-circle"
                                                    href="#"><i class="las la-basketball-ball"></i></a></li>
                                        <li class="db-social-parent__item"><a
                                                    class="color-instagram hover-instagram wh-38 fs-16 rounded-circle"
                                                    href="#"><i class="lab la-instagram"></i></a></li>
                                    </ul>
                                </div>
                            ...
                            <div class="card-body text-center p-30">
                                <div class="account-profile">
                                    <div class="ap-img d-flex justify-content-center">
                                        <!-- Profile picture image-->
                                        <img class="ap-img__main rounded-circle mb-20 bg-opacity-primary wh-150"
                                             src="{{ asset('assets/img/tm2.png') }}" alt="profile">
                                    </div>
                                    <div class="ap-nameAddress pb-3">
                            ...
                            <div class="card-body text-center p-30">
                                <div class="account-profile">
                                    <div class="ap-img d-flex justify-content-center">
                                        <!-- Profile picture image-->
                                        <img class="ap-img__main rounded-circle mb-20 bg-opacity-primary wh-150"
                                             src="{{ asset('assets/img/tm3.png') }}" alt="profile">
                                    </div>
                                    <div class="ap-nameAddress pb-3">
                            ...
                            <div class="card-body text-center p-30">
                                <div class="account-profile">
                                    <div class="ap-img d-flex justify-content-center">
                                        <!-- Profile picture image-->
                                        <img class="ap-img__main rounded-circle mb-20 bg-opacity-primary wh-150"
                                             src="{{ asset('assets/img/tm4.png') }}" alt="profile">
                                    </div>
                                    <div class="ap-nameAddress pb-3">
                                        ...
                                        <div class="content-not-installed content-action d-none">
                                            ...
                                            <div class="more">
                                                <button class="btn-link border-0 bg-transparent p-0"
                                                        data-bs-toggle="dropdown" aria-haspopup="true"
                                                        aria-expanded="true">
                                                    <img src="{{ asset('assets/img/svg/more-horizontal.svg') }}" alt=""
                                                         class="svg">
                                                </button>
                                                <div class="dropdown-default dropdown-bottomLeft dropdown-menu-right dropdown-menu">
                                                    <a class="dropdown-item" href="#">view</a>
                        ...
                        <div class="user-group radius-xl media-ui media-ui--early pt-30 pb-25">
                            <div class="border-bottom px-30">
                                <div class="media user-group-media d-flex justify-content-between">
                                    <div class="media-body d-flex align-items-center flex-wrap text-capitalize my-sm-0 my-n2">
                                        <a href="application-ui.html">
                                            <h6 class="mt-0  fw-500 user-group media-ui__title bg-transparent">Dashboard
                                                UI Project</h6>
                                        </a>
                                ...
                                <div class="user-group-people mt-15 text-capitalize">
                                    <p>Lorem ipsum dolor amet, consetetur sadipscing elitr sed diam nonumy eirmod dolor
                                        ame.</p>
                        ...
                        <div class="user-group radius-xl media-ui media-ui--late pt-30 pb-25">
                            <div class="border-bottom px-30">
                                <div class="media user-group-media d-flex justify-content-between">
                                    <div class="media-body d-flex align-items-center flex-wrap text-capitalize my-sm-0 my-n2">
                                        <a href="application-ui.html">
                                            <h6 class="mt-0  fw-500 user-group media-ui__title bg-transparent">Custom
                            ...
                            <div class=" banner-card bg-primary">
                                <div class="banner-card__top align-center-v justify-content-between">
                                    <h4 class="banner-card__title">
                                        <img src="{{ asset('assets/img/svg/feature-lock.svg') }}" class="svg"
                                             alt="ninjadash Banner">
                                ...
                                <div class="banner-card__bottom  align-center-v justify-content-between">
                                    <div class="card-author"><img src="{{ asset('assets/img/author-more.png') }}"
                                                                  alt=""><span class="author-name">Barbara
                                        Marion</span></div>
                                    <div class="card-meta">
                                        <ul>
                                            <li>
                    ...
                    <div class="col-lg-4 col-md-6 mb-25">
                        <figure class="feature-cards7 feature-cards7--2">
                            <div class=" banner-card banner-card-image"
                                 style="background-image:url({{ asset('assets/img/feature-card-image7.png') }});">
                                <div class="banner-card__top align-center-v justify-content-between">
                                    <h4 class="banner-card__title">
                                        <img src="{{ asset('assets/img/svg/feature-lock.svg') }}" class="svg"
                                             alt="ninjadash Banner">
                        ...
                        <div class="col-lg-4 col-md-6">
                            <figure class="feature-cards7 feature-cards7--1">
                                <div class=" banner-card banner-card-border">
                                    <div class="banner-card__top align-center-v justify-content-between">
                                        <h4 class="banner-card__title">
                                            <img src="{{ asset('assets/img/svg/layers.svg') }}" class="svg"
                                                 alt="ninjadash Banner">
                                            <span>Dark Color</span>
                                        </h4>
                                        <div class="banner-card__action">
                                    ...
                                    <div class="banner-card__body">
                                        <p>Lorem Ipsum is simply dummy text of the printing printer took a galley of
                                            type
                                            and
                                            scrambled
                                            and typesetting industry.</p>
                                    ...
                                    <div class="banner-card__bottom  align-center-v justify-content-between">
                                        <div class="card-author"><img src="{{ asset('assets/img/author-more.png') }}"
                                                                      alt=""><span
                                                    class="author-name">Barbara Marion</span></div>
                                        <div class="card-meta">
                                            <ul>
                                                <li>
                                                    <img src="{{ asset('assets/img/svg/heart.svg') }}" alt="heart"
                                                ...
                                                <li>
                                                    <img src="{{ asset('assets/img/svg/eye.svg') }}" alt="eye"
                                                         class="svg">
                                                    <span class="view-count">70</span>
                                                </li>
                                            </ul>
                        ...
                        <div class="col-lg-4 col-md-6">
                            <figure class="feature-cards7 feature-cards7--1">
                                <div class=" banner-card banner-card-border">
                                    <div class="banner-card__top align-center-v justify-content-between">
                                        <h4 class="banner-card__title">
                                            <img src="{{ asset('assets/img/svg/feature-upload.svg') }}" class="svg"
                                                 alt="ninjadash Banner">
                                            <span>Dark Color</span>
                                        </h4>
                                        <div class="banner-card__action">
                        ...
                        <div class="col-lg-4 col-md-6">
                            <figure class="feature-cards7 feature-cards7--1">
                                <div class=" banner-card banner-card-border">
                                    <div class="banner-card__top align-center-v justify-content-between">
                                        <h4 class="banner-card__title">
                                            <img src="{{ asset('assets/img/svg/feature-img.svg') }}" class="svg"
                                                 alt="ninjadash Banner">
                                            <span>Image</span>
                                        </h4>
                                        <div class="banner-card__action">
                                    ...
                                    <div class="banner-card__bottom  align-center-v justify-content-between">
                                        <div class="card-author"><img src="{{ asset('assets/img/author-more.png') }}"
                                                                      alt=""><span
                                                    class="author-name">Garry Sobars</span></div>
                                        <div class="card-meta">
                                            <ul>
