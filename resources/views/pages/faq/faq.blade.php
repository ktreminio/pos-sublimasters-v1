                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active"
                                    aria-current="page">{{ trans('menu.faq-menu-title') }}
                                </li>
                            </ol>
                        </nav>
                    </div>
                ...
                <div class="card shadow-lg mt-25 mb-md-50 mb-25">
                    <div class="card-body py-40 px-50">
                        <div class="faq-support text-center">
                            <img src="{{ asset('assets/img/svg/faq-support.svg') }}" alt="support"
                                 class="svg img-fluid">
                                                ...
                                                <div id="collapseOne" class="panel-collapse collapse in show"
                                                    ...
                                                    <div class="panel-body">
                                                        ...
                                                        <div class="button-group d-flex mt-2">
                                                            <button
                                                                    class="btn btn-default btn-squared color-success px-15 btn-outline-success px-15 ">
                                                                <img
                                                            ...
                                                            <button
                                                                    class="btn btn-default btn-squared color-warning px-15 btn-outline-warning px-15 ">
                                                                <img
