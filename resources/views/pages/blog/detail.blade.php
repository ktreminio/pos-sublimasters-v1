                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active"
                                        aria-current="page">{{ trans('menu.blog-detail') }}</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                        ...
                        <div class="blog-details-content">
                            ...
                            <div class="blog-body">
                                <p class="mb-20">
                                    ...
                                    harder – so that you get more done in less time, even when time is tight and
                                    pressures
                                ...
                                <div class="blog-block-image mb-30 pb-10">
                                    <figure>
                                        <img class="img-fluid" src="{{ asset('assets/img/blog-details.png') }} "
                                             alt="blog_details">
                                    </figure>
                                </div>
                                ...
                                <blockquote class="blog-block-quote">
                                    <div class="blog-block-quote__wrapper">
                                        <div class="top-icon">
                                            <img class="svg" src="{{ asset('assets/img/svg/topSemicolon.svg') }} "
                                                 alt="">
                                        </div>
                                        <p>
                                ...
                                <ul class="mb-50">
                                    <li>
                                        <strong>Trim transparent pixels on exports:</strong> Usability design is to
                                        improve
                                        the usability of a product, which is an important.
                                    </li>
                                    <li>
                                        <strong>Crash and bug fixes:</strong> Usability design is to improve the
                                        usability
                            ...
                            <div class="blog-author-box media">
                                ...
                                <div class="auth-details media-body">
                                    ...
                                    <p>Rabbi Islam Rony is a British writer and social media manager specializing in
                                        dynamic
