                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active"
                                    aria-current="page">{{ trans('menu.table-basic') }}</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                    ...
                    <div class="card-header">
                        ...
                        <div class="card-extra">
                            <ul class="card-tab-links nav-tabs nav" role="tablist">
                                ...
                                <li>
                                    <a href="#t_channel-week" data-bs-toggle="tab" id="t_channel-week-tab" role="tab"
                                       aria-selected="false">Week</a>
                                </li>
                                <li>
                                    <a href="#t_channel-month" data-bs-toggle="tab" id="t_channel-month-tab" role="tab"
                                       aria-selected="false">Month</a>
                                </li>
                                <li>
                                    <a href="#t_channel-year" data-bs-toggle="tab" id="t_channel-year-tab" role="tab"
                                       aria-selected="false">Year</a>
                                </li>
                            </ul>
                            <div class="dropdown dropleft">
                                <a href="#" role="button" id="traffic" data-bs-toggle="dropdown" aria-haspopup="true"
                                   aria-expanded="false">
                                    <img src="{{ asset('assets/img/svg/more-horizontal.svg') }}" alt="more-horizontal"
                                         class="svg">
                                </a>
                    ...
                    <div class="card-header">
                        ...
                        <div class="card-extra">
                            <ul class="card-tab-links nav-tabs nav" role="tablist">
                                ...
                                <li>
                                    <a href="#t_landing-week" data-bs-toggle="tab" id="t_landing-week-tab" role="tab"
                                       aria-selected="false">Week</a>
                                </li>
                                <li>
                                    <a href="#t_landing-month" data-bs-toggle="tab" id="t_landing-month-tab" role="tab"
                                       aria-selected="false">Month</a>
                                </li>
                                <li>
                                    <a href="#t_landing-year" data-bs-toggle="tab" id="t_landing-year-tab" role="tab"
                                       aria-selected="false">Year</a>
                                </li>
                            </ul>
                            <div class="dropdown dropleft">
                                <a href="#" role="button" id="topPage" data-bs-toggle="dropdown" aria-haspopup="true"
                                   aria-expanded="false">
                                    <img src="{{ asset('assets/img/svg/more-horizontal.svg') }}" alt="more-horizontal"
                                         class="svg">
                                </a>
                    ...
                    <div class="card-header">
                        ...
                        <div class="card-extra">
                            <ul class="card-tab-links nav-tabs nav" role="tablist">
                                ...
                                <li>
                                    <a href="#t_selling-year" data-bs-toggle="tab" id="t_selling-year-tab" role="tab"
            ...
            <div class="col-xxl-6 mt-30">
                ...
                <div class="card border-0">
                    <div class="card-header">
                        ...
                        <div class="dropdown dropleft">
                            <a href="#" role="button" id="action" data-bs-toggle="dropdown" aria-haspopup="true"
                               aria-expanded="false">
                                <img src="{{ asset('assets/img/svg/more-horizontal.svg') }}" alt="more-horizontal"
                                     class="svg">
                            </a>
                                    ...
                                    <tr class="draggable" draggable="true">
                                        <td>
                                            <div class="item d-flex align-items-center">
                                                ...
                                                <div class="item-info d-flex align-items-center">
                                                    <a href="#" class="profile-image rounded-circle d-block m-0 wh-32"
                                        ...
                                        <td>
                                            <div class="table-actions">
                                                ...
                                                <a href="#">
                                                    <img class="svg" src="{{ asset('assets/img/svg/trash-2.svg') }}"
                                                         alt="">
                                                </a>
                                            </div>
                                        </td>
