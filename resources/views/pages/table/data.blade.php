                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="#"><i
                                                class="las la-home"></i>{{ trans('menu.table-menu-title') }}</a></li>
                                <li class="breadcrumb-item"><a href="#">Apps</a></li>
                                <li class="breadcrumb-item active"
                                    aria-current="page">{{ trans('menu.table-data') }}</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                                            ...
                                            <ul class="d-flex user-group-people__parent align-content-center">
                                                ...
                                                <li class="d-flex align-items-center ms-1"><span
                                                            class="fs-12 color-light fw-500"><i
                                                                class="las la-plus fs-10"></i>5 more</span></li>
                                            </ul>
                                        </td>
                                        <td>
                                            <div class="d-inline-block">
                                                ...
                                                <div class="media-ui--completed ">
                                                    <div class="user-group-progress-bar">
                                                        <div class="progress-wrap d-flex align-items-center mb-0">
                                                            ...
                                                            <span class="progress-icon"><img
                                                                        src="{{ asset('assets/img/svg/check.svg') }}"
                                                                        alt="check" class="svg color-success"></span>
                                                        </div>
                                                        <p class="color-light fs-12 mt-1 mb-0">15 / 15 tasks
                                                            completed</p>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="d-flex">
                                                <div class="userDatatable__imgWrapper d-flex align-items-center">
                                                    ...
                                                    <a href="#" class="profile-image rounded-circle d-block m-0 wh-38"
                                                       style="background-image:url({{ asset('assets/img/tm6.png') }}); background-size: cover;"></a>
                                                </div>
                                                <div class="userDatatable-inline-title">
                                                    <a href="#" class="text-dark fw-500">
                                                        <h6>Kellie Marquot</h6>
                                        ...
                                        <td>
                                            <div class="d-flex">
                                                <div class="userDatatable__imgWrapper d-flex align-items-center">
                                                    ...
                                                    <a href="#" class="profile-image rounded-circle d-block m-0 wh-38"
                                                       style="background-image:url({{ asset('assets/img/tm1.png') }}); background-size: cover;"></a>
                                                </div>
                                                <div class="userDatatable-inline-title">
                                                    <a href="#" class="text-dark fw-500">
                                                        <h6>Kellie Marquot</h6>
                                        ...
                                        <td>
                                            <div class="d-flex">
                                                <div class="userDatatable__imgWrapper d-flex align-items-center">
                                                    ...
                                                    <a href="#" class="profile-image rounded-circle d-block m-0 wh-38"
                                                       style="background-image:url({{ asset('assets/img/tm2.png') }}); background-size: cover;"></a>
                                                </div>
                                                <div class="userDatatable-inline-title">
                                                    <a href="#" class="text-dark fw-500">
                                                        <h6>Kellie Marquot</h6>
                                        ...
                                        <td>
                                            <div class="d-flex">
                                                <div class="userDatatable__imgWrapper d-flex align-items-center">
                                                    ...
                                                    <a href="#" class="profile-image rounded-circle d-block m-0 wh-38"
                                                       style="background-image:url({{ asset('assets/img/tm3.png') }}); background-size: cover;"></a>
                                                </div>
                                                <div class="userDatatable-inline-title">
                                                    <a href="#" class="text-dark fw-500">
                                                        <h6>Kellie Marquot</h6>
                                        ...
                                        <td>
                                            <div class="d-flex">
                                                <div class="userDatatable__imgWrapper d-flex align-items-center">
                                                    ...
                                                    <a href="#" class="profile-image rounded-circle d-block m-0 wh-38"
                                                       style="background-image:url({{ asset('assets/img/tm4.png') }}); background-size: cover;"></a>
                                                </div>
                                                <div class="userDatatable-inline-title">
                                                    <a href="#" class="text-dark fw-500">
                                                        <h6>Kellie Marquot</h6>
                                        ...
                                        <td>
                                            <div class="d-flex">
                                                <div class="userDatatable__imgWrapper d-flex align-items-center">
                                                    ...
                                                    <a href="#" class="profile-image rounded-circle d-block m-0 wh-38"
                                                       style="background-image:url({{ asset('assets/img/tm5.png') }}); background-size: cover;"></a>
                                                </div>
                                                <div class="userDatatable-inline-title">
                                                    <a href="#" class="text-dark fw-500">
                                                        <h6>Kellie Marquot</h6>
