                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active"
                                        aria-current="page">{{ trans('menu.wizard-four') }}</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
            ...
            <div class="row justify-content-center">
                <div class="col-xl-8">
                    <div class="row justify-content-center">
                        ...
                        <div class="col-lg-7">
                            <div class="card checkout-shipping-form shadow-none px-30 pt-15 pb-20 border-color mt-0">
                                        ...
                                        <form>
                                            <div class="form-group mb-1  d-flex justify-content-center">
                                                <label for="staticEmail"
                                                       class=" col-form-label space-nowrap  pt-1mb-0">First Name
                                                    :</label>
