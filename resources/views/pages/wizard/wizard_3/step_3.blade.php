                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active"
                                        aria-current="page">{{ trans('menu.wizard-three') }}</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                                                    ...
                                                    <div class="form-cc">
                                                        <div class="form-group mb-30">
                                                            ...
                                                            <div class=" d-flex justify-content-between align-items-center form-control">
                                                                ...
                                                                <img src="{{ asset('assets/img/ms.png') }}" alt="visa"
                                                                     class="form-cc-img d-md-block d-none">
                                                            </div>
                                                        </div>
                                                        <div class="form-group mb-30">
                                                            <label for="payment2">name on card</label>
                                                            <input type="text" class="form-control" id="payment2"
                                                        ...
                                                        <div class="form-group mb-0 payment-method-csv">
                                                            ...
                                                            <div class="d-flex align-items-center flex-wrap">
                                                                <input type="text" class="form-control me-10"
                                ...
                                <div class="payment-method-paypal">
                                    <div class="d-flex align-items-center mb-20">
                                        ...
                                        <button type="button"
                                            ...
                                            Pay with
                                            PayPal<img src="{{ asset('assets/img/paypal.png') }}" alt="paypal"
                                                       class="d-lg-block d-none"></button>
                                    </div>
                                    <div class="d-flex align-items-center">
                                        ...
                                        <button type="button" class=" form-control d-flex align-items-center"
                                                id="payment3">Cash
                                            on
                                            delivery
                                        </button>
