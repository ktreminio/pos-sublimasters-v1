                    ...
                    <div class="checkout-progress-indicator px-15 content-center">
                        <div class="checkout-progress w-100">
                            ...
                            <div class="step completed" id="2">
                                <span><img class="svg" src="{{ asset('assets/img/svg/address-success.svg') }}"
                                           alt=""></span>
                            ...
                            <div class="step completed" id="3">
                                <span><img class="svg" src="{{ asset('assets/img/svg/155-credit-card-success.svg') }}"
                                           alt=""></span>
                            ...
                            <div class="step current" id="4">
                                <span><img class="svg" src="{{ asset('assets/img/svg/024-like-active.svg') }}"
                                           alt=""></span>
