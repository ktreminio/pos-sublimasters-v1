                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active"
                                        aria-current="page">{{ trans('menu.wizard-one') }}
                                    </li>
                                </ol>
                            </nav>
                        </div>
                    ...
                    <div class="checkout-progress-indicator content-center px-15">
                        <div class="checkout-progress">
                            <div class="step completed" id="1">
                                <span> <img class="svg" src="{{ asset('assets/img/svg/user-success.svg') }}"
                                            alt=""> </span>
                                <span>Create Account</span>
                            </div>
                            <div class="current"><img src="{{ asset('assets/img/svg/green.svg') }}" alt="img"
                                                      class="svg"></div>
                            <div class="step completed" id="2">
                                <span> <img class="svg" src="{{ asset('assets/img/svg/address-success.svg') }}" alt=""> </span>
                                <span>Shipping Address</span>
                            </div>
                            <div class="current"><img src="{{ asset('assets/img/svg/checkoutin.svg') }}" alt="img"
                                                      class="svg"></div>
                            <div class="step current" id="3">
                                <span><img class="svg" src="{{ asset('assets/img/svg/155-credit-card-active.svg') }}"
                                           alt=""></span>
                        ...
                        <div class="col-xl-7 col-lg-8 col-sm-10">
                            <div class="payment-method-area payment-method-area--top w-100 mb-20">
                                ...
                                <div class="d-flex mt-sm-20 mt-30">
                                    <div class="radio-theme-default custom-radio  mt-40 w-100">
                                        <input class="radio box-shadow-none" type="radio" name="radio-vertical"
                                            ...
                                            <div class="card payment-method-card w-100  px-sm-25 px-15 pt-20 pb-20">
                                                <div class="card-header border-bottom-0 p-0 pb-25">
                                                    ...
                                                    <div class="payment-way mt-xl-0 mt-20 d-flex align-items-center">
                                                        ...
                                                        <img src="{{ asset('assets/img/american-express.png') }}"
                                                             alt="payment">
                                                    </div>
                                                </div>
                                                        ...
                                                        <div class="form-cc">
                                                            <div class="form-group mb-30">
                                                                ...
                                                                <div class=" d-flex justify-content-between align-items-center form-control">
                                                                    <input type="text"
                                                                           class="w-100 border-0 box-shadow-none"
                                                                           id="payment1" placeholder="number">
                                                                    <img src="{{ asset('assets/img/ms.png') }}"
                                                                         alt="visa"
                                                            ...
                                                            <div class="form-group mb-30">
                                                                ...
                                                                <input type="text" class="form-control d-block"
                                                                       id="payment2" placeholder="full name">
                                                            </div>
                                                            ...
                                                            <div class="form-group mb-0 payment-method-csv">
                                                                ...
                                                                <div class="d-flex align-items-center flex-wrap">
                                                                    <input type="text"
                                                                           class="form-control me-10 d-block"
                                                                           id="payment5" placeholder="XXX">
                            ...
                            <div class="payment-method-paypal payment-method-area--top mt-0">
                                <div class="d-flex align-items-center mb-20">
                                    <div class="radio-theme-default custom-radio d-flex me-2 w-100"><input class="radio"
                                                                                                           type="radio"
                                                                                                           name="radio-vertical"
                                                                                                           value="1"
                                                                                                           id="radio-vl6">
                                        <label for="radio-vl6" class="w-100"><span class="radio-text"></span>
                                            <div class="form-control d-flex align-items-center justify-content-between w-100">
                                                Pay with PayPal<img src="{{ asset('assets/img/paypal.png') }}"
                                                                    alt="paypal" class="d-lg-block d-none"></div>
                                        </label>
                                    </div>
                                </div>
                                <div class="d-flex align-items-center">
                                    <div class="radio-theme-default custom-radio d-flex me-2 w-100"><input class="radio"
                                                                                                           ...
                                                                                                           value="0"
                                                                                                           id="radio-vl7">
                                        <label for="radio-vl7" class="w-100"><span class="radio-text"></span>
                                            <div color="transparent"
                                                 class="form-control d-flex align-items-center w-100" id="payment3">Cash
                                                on delivery
                                            </div>
                                        </label></div>
                                </div>
