                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active"
                                        aria-current="page">{{ trans('menu.testimonial-menu-title') }}</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                                        ...
                                        <div class="card-body">
                                            <div class="author-thumb mb-sm-6 mb-xs-3">
                                                <div class="d-flex justify-content-center">
                                                    <img class="wh-80 rounded-circle"
                                                         src="{{ asset('assets/img/team-center.png') }}" alt="">
                                                </div>
                                                <p class="mb-0">Duran Clayton</p>
                                                <span class="d-flex justify-content-center">UI/UX Designer</span>
                                            </div>
                                            <p class="author-comment">It is a long established fact that a reader will
                                                page
                                                when
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            <div class="author-thumb mb-sm-6 mb-xs-3">
                                                <div class="d-flex justify-content-center">
                                                    <img class="wh-80 rounded-circle"
                                                         src="{{ asset('assets/img/team-3.png') }}" alt="">
                                                </div>
                                                <p class="mb-0">Duran Clayton</p>
                                                <span class="d-flex justify-content-center">UI/UX Designer</span>
                                            </div>
                                        ...
                                        <div class="card-body">
                                            <div class="author-thumb mb-sm-6 mb-xs-3 d-flex justify-content-between">
                                                <div class="d-flex flex-wrap">
                                                    <div class="me-20">
                                                        <img class="wh-70 rounded-circle"
                                                             src="{{ asset('assets/img/team-center.png') }}" alt="">
                                                    </div>
                                                    <div>
                                                        <p class="mb-0">Duran Clayton</p>
                                ...
                                <div class="row justify-content-center">
                                    <div class="col-xl-6">
                                        <div class="testimonial-slider3-nav testimonial-slider-global">
                                            ...
                                            <div class="d-flex m-0 justify-content-center">
                                                <img class=" rounded-circle" src="{{ asset('assets/img/team-2.png') }}"
                                                     alt="">
                                            </div>
                                            <div class="d-flex m-0 justify-content-center">
                                                <img class="rounded-circle" src="{{ asset('assets/img/team-3.png') }}"
                                                     alt="">
                                            </div>
                                            <div class="d-flex m-0 justify-content-center">
                                                <img class=" rounded-circle"
                            ...
                            <div class="col-sm-7">
                                <div class="testimonial-slider4 testimonial-slider-global">
                                    <div class="card">
                                        <div class="card-body text-center">
                                            <div class="d-flex justify-content-center">
                                                <img class="wh-100 rounded-circle"
                                                     src="{{ asset('assets/img/team-center.png') }}" alt="">
                                            </div>
                                            <p class="author-comment">Lorem ipsum dolor sit amet, consetetur sadipscing
                                                elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna
