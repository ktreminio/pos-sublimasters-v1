                ...
                <div class="col-sm-5 col-10">
                    <div class="mt-40 mb-50">
                        @foreach ($find_customer as $customer)
                            ...
                            <form action="{{ route('customer.update',[app()->getLocale(),$customer->id]) }}"
                                ...
                                <div class="account-profile d-flex align-items-center mb-4 ">
                                    <div class="ap-img pro_img_wrapper">
                                        ...
                                        <label for="profile-picture">
                                            <img src="{{ $has_profile_picture ? Helper::get_public_storage_asset_url( $customer->profile_picture ) : asset( 'assets/img/svg/user.svg' ) }}"
                                                 alt="user"
                                            ...
                                            >
                                            <input type="hidden" class="profile-picture-removal-status"
                                                   name="remove_profile_picture" value="">
                                            <img src="{{ ( $has_profile_picture ) ? asset( 'assets/img/svg/close-white.svg' ) : asset( 'assets/img/svg/camera-white.svg' ) }}"
                                                 alt="camera">
                                        </span>
                                        </label>
                                    </div>
                                ...
                                <div class="edit-profile__body">
                                    <div class="form-group mb-25">
                                        ...
                                        <input type="text"
                                               ...
                                               name="name" value="{{ $customer->name }}" id="name" placeholder="Name">
                                        @if($errors->has('name'))
                                            <p class="text-danger">{{ $errors->first('name') }}</p>
                                        @endif
                                    </div>
                                    <div class="form-group mb-25">
                                        <label for="email" class="color-dark fs-14 fw-500 align-center">Email Address
                                    ...
                                    <div class="form-group mb-25">
                                        <label for="profession" class="color-dark fs-14 fw-500 align-center">Profession
                                            <span class="text-danger">*</span></label>
                                        <input type="text"
                                               class="form-control ih-medium ip-gray radius-xs b-light px-15"
                                               name="profession" id="profession" value="{{ $customer->profession }}"
                                    ...
                                    <div class="form-group mb-25">
                                        ...
                                        <textarea class="form-control ih-medium ip-gray radius-xs b-light px-15"
                                                  name="address" style="height: 175px;" id="address"
                                    ...
                                    <div class="button-group d-flex pt-25 justify-content-md-end justify-content-start">
                                        <a href="{{ route('customer.list',app()->getLocale()) }}"
                                           class="btn btn-light btn-default btn-squared fw-400 text-capitalize m-sm-0 m-1">Cancel</a>
                                        <button type="submit"
