                    ...
                    <div class="breadcrumb-main add-contact justify-content-sm-between ">
                        <div class=" d-flex flex-wrap justify-content-center breadcrumb-main__wrapper">
                            ...
                            <div class="action-btn mt-sm-0 mt-15">
                                <a href="{{ route('customer.create', app()->getLocale()) }}"
                                                    ...
                                                    <div class="d-flex">
                                                        <div
                                                            ...
                                                            <a href="#"
                                                               ...
                                                               style="background-image:url('{{ $has_profile_picture ? Helper::get_public_storage_asset_url( $customer->profile_picture ) : asset( 'assets/img/svg/user.svg' ) }}'); background-size: cover;"></a>
                                                        </div>
                                ...
                                <li class="dm-pagination__item">
                                    <div class="paging-option">
                                        <select name="page-number" class="page-selection"
                                            ...
                                            <option value="20" {{ 20 == $customers->perPage() ? 'selected' : '' }}>
                                                20/page
                                            </option>
                                            <option value="40" {{ 40 == $customers->perPage() ? 'selected' : '' }}>
                                                40/page
                                            </option>
                                            <option value="60" {{ 60 == $customers->perPage() ? 'selected' : '' }}>
                                                60/page
                                            </option>
                                        </select>
